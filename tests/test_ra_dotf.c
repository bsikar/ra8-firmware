...
static void test_init_happy(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg0->REG00);
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg0->CONVAREAST);
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg0->CONVAREAD);
...
static void test_deinit_clears_regs(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_init());
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_enable((uint8_t)k_dotf_test_ch0));

  volatile ra_dotf_regs_t* reg0 = ra_dotf_regs((uint8_t)k_dotf_test_ch0);
  TEST_ASSERT((reg0->REG00 & (uint32_t)k_ra_dotf_reg00_aes_enable) != 0U);

  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_deinit());
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg0->REG00);
...
static void test_set_region_happy(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch0, &r));

  /* Hardware not touched until select_region. */
  volatile ra_dotf_regs_t* reg = ra_dotf_regs((uint8_t)k_dotf_test_ch0);
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg->CONVAREAST);
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg->CONVAREAD);
...
static void test_set_region_null(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch0, nullptr));
...
static void test_set_region_bad_channel(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_bad, &r));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_way, &r));
...
static void test_set_region_bad_slot(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch0, &r));
...
static void test_set_region_outside_window(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch1, &r1));
...
static void test_set_region_overlap_other_channel(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch1, &r1));
  TEST_ASSERT_EQ(
    (int32_t)k_ra_ok,
    (int32_t)ra_dotf_select_region((uint8_t)k_dotf_test_ch1, (uint8_t)k_dotf_test_slot0));
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch0, &r0));
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch1, &r1b));
...
static void test_select_region_writes_hardware(void)
{
  ...
  TEST_ASSERT_EQ(
    (int32_t)k_ra_ok,
    (int32_t)ra_dotf_select_region((uint8_t)k_dotf_test_ch0, (uint8_t)k_dotf_test_slot0));
  volatile ra_dotf_regs_t* reg = ra_dotf_regs((uint8_t)k_dotf_test_ch0);
  TEST_ASSERT_EQ((int64_t)((uint32_t)k_dotf_test_start_ok & (uint32_t)k_ra_dotf_addr_mask),
                 (int64_t)reg->CONVAREAST);
  TEST_ASSERT_EQ((int64_t)((uint32_t)k_dotf_test_end_ok & (uint32_t)k_ra_dotf_addr_mask),
                 (int64_t)reg->CONVAREAD);
...
static void test_select_region_unstaged(void)
{
  ...
  TEST_ASSERT_EQ(
    ...
    (int32_t)ra_dotf_select_region((uint8_t)k_dotf_test_ch0, (uint8_t)k_dotf_test_slot2));
  TEST_ASSERT_EQ(
    (int32_t)k_ra_err_invalid_arg,
    (int32_t)ra_dotf_select_region((uint8_t)k_dotf_test_bad, (uint8_t)k_dotf_test_slot0));
  TEST_ASSERT_EQ(
    (int32_t)k_ra_err_invalid_arg,
    (int32_t)ra_dotf_select_region((uint8_t)k_dotf_test_ch0, (uint8_t)k_dotf_test_slot_bad));
...
static void test_get_active_region(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state,
                 (int32_t)ra_dotf_get_active_region((uint8_t)k_dotf_test_ch0, &out));

  const ra_dotf_region_t r = make_region((uint8_t)k_dotf_test_ch0, (uint8_t)k_dotf_test_slot1);
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch0, &r));
  TEST_ASSERT_EQ(
    (int32_t)k_ra_ok,
    (int32_t)ra_dotf_select_region((uint8_t)k_dotf_test_ch0, (uint8_t)k_dotf_test_slot1));
  TEST_ASSERT_EQ((int32_t)k_ra_ok,
                 (int32_t)ra_dotf_get_active_region((uint8_t)k_dotf_test_ch0, &out));
  TEST_ASSERT_EQ((int64_t)r.start_addr, (int64_t)out.start_addr);
  TEST_ASSERT_EQ((int64_t)r.end_addr, (int64_t)out.end_addr);
  TEST_ASSERT_EQ((int32_t)r.region_id, (int32_t)out.region_id);
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_dotf_get_active_region((uint8_t)k_dotf_test_ch0, nullptr));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_get_active_region((uint8_t)k_dotf_test_bad, &out));
...
static void test_multi_region_staging(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok,
                 (int32_t)ra_dotf_get_active_region((uint8_t)k_dotf_test_ch0, &out));
  TEST_ASSERT_EQ((int32_t)k_dotf_test_slot2, (int32_t)out.region_id);
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok,
                 (int32_t)ra_dotf_get_active_region((uint8_t)k_dotf_test_ch0, &out));
  TEST_ASSERT_EQ((int32_t)k_dotf_test_slot0, (int32_t)out.region_id);
...
static void test_install_key_happy(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_install_key((uint8_t)k_dotf_test_ch0, &h128));

  const ra_dotf_key_handle_t h192 =
    make_key_handle(k_ra_dotf_key_size_192, (uint8_t)k_dotf_test_key_idx_a);
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_install_key((uint8_t)k_dotf_test_ch0, &h192));

  const ra_dotf_key_handle_t h256 =
    make_key_handle(k_ra_dotf_key_size_256, (uint8_t)k_dotf_test_key_idx_a);
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_install_key((uint8_t)k_dotf_test_ch1, &h256));
...
static void test_install_key_invalid(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_dotf_install_key((uint8_t)k_dotf_test_ch0, nullptr));

  ra_dotf_key_handle_t h = make_key_handle(k_ra_dotf_key_size_128, (uint8_t)k_dotf_test_key_idx_a);
  h.valid                = 0U;
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_install_key((uint8_t)k_dotf_test_ch0, &h));
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_install_key((uint8_t)k_dotf_test_bad, &h));
...
static void test_set_iv(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_set_iv((uint8_t)k_dotf_test_ch0, iv));
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_dotf_set_iv((uint8_t)k_dotf_test_ch0, nullptr));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_iv((uint8_t)k_dotf_test_bad, iv));
...
static void test_rotate_key_live(void)
{
  ...
  const ra_dotf_key_handle_t hA =
    make_key_handle(k_ra_dotf_key_size_128, (uint8_t)k_dotf_test_key_idx_a);
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_install_key((uint8_t)k_dotf_test_ch0, &hA));
  ...
  const uint32_t iv2[k_ra_dotf_iv_word_count] = {0x11111111UL,
                                                 ...
                                                 0x33333333UL,
                                                 0x44444444UL};
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_ch0, &hB, iv2));

  /* Channel should remain enabled and key-size bits should reflect 256. */
  TEST_ASSERT((reg->REG00 & (uint32_t)k_ra_dotf_reg00_aes_enable) != 0U);
  TEST_ASSERT_EQ((int64_t)(uint32_t)k_ra_dotf_reg00_key_size_256,
                 (int64_t)(reg->REG00 & (uint32_t)k_ra_dotf_reg00_key_size_mask));

  /* Rotate again with NULL iv to cover the IV-reuse branch. */
  TEST_ASSERT_EQ((int32_t)k_ra_ok,
                 (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_ch0, &hA, nullptr));
...
static void test_rotate_key_invalid(void)
{
  ...
  const ra_dotf_key_handle_t h =
    make_key_handle(k_ra_dotf_key_size_128, (uint8_t)k_dotf_test_key_idx_a);
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_ch0, nullptr, nullptr));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_bad, &h, nullptr));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state,
                 (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_ch0, &h, nullptr));

  /* Invalid handle.size */
  ra_dotf_key_handle_t bad = h;
  bad.size                 = (ra_dotf_key_size_t)0xCAFEBABEUL;
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_ch0, &bad, nullptr));

  /* Invalid handle.valid */
  ra_dotf_key_handle_t bad2 = h;
  bad2.valid                = 0U;
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_ch0, &bad2, nullptr));
...
static void test_rotate_key_disabled_stays_disabled(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok,
                 (int32_t)ra_dotf_rotate_key((uint8_t)k_dotf_test_ch0, &h, nullptr));
  volatile ra_dotf_regs_t* reg = ra_dotf_regs((uint8_t)k_dotf_test_ch0);
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg->REG00);
...
static void test_enable_writes_default_pattern(void)
{
  ...
  prep();
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_init());
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_enable((uint8_t)k_dotf_test_ch1));
  ...
  TEST_ASSERT_EQ((int64_t)expected, (int64_t)reg->REG00);
...
static void test_enable_bad_channel(void)
{
  ...
  prep();
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg, (int32_t)ra_dotf_enable((uint8_t)k_dotf_test_bad));
...
static void test_disable_clears_reg00(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_init());
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_enable((uint8_t)k_dotf_test_ch0));
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_disable((uint8_t)k_dotf_test_ch0));

  volatile ra_dotf_regs_t* reg = ra_dotf_regs((uint8_t)k_dotf_test_ch0);
  TEST_ASSERT_EQ((int32_t)0, (int32_t)reg->REG00);
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg, (int32_t)ra_dotf_disable((uint8_t)k_dotf_test_bad));
...
static void test_status_round_trip(void)
{
  ...
  uint32_t mask = 0U;
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_get_status((uint8_t)k_dotf_test_ch0, &mask));
  TEST_ASSERT((mask & (uint32_t)k_ra_dotf_reg00_aes_enable) != 0U);

  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_clear_status((uint8_t)k_dotf_test_ch0));
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_get_status((uint8_t)k_dotf_test_ch0, &mask));
  TEST_ASSERT_EQ((int32_t)0, (int32_t)mask);

  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_dotf_get_status((uint8_t)k_dotf_test_ch0, nullptr));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_get_status((uint8_t)k_dotf_test_bad, &mask));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_clear_status((uint8_t)k_dotf_test_bad));
...
static void test_set_sca_level(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)0,
                 (int32_t)(reg->REG00 & ((uint32_t)k_ra_dotf_reg00_sca_en |
                                         (uint32_t)k_ra_dotf_reg00_sca_mode)));
  ...
  /* Bad inputs. */
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_sca_level((uint8_t)k_dotf_test_bad, k_ra_dotf_sca_off));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
...
static void test_set_key_size(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_enable((uint8_t)k_dotf_test_ch0));
  volatile ra_dotf_regs_t* reg = ra_dotf_regs((uint8_t)k_dotf_test_ch0);
  TEST_ASSERT_EQ((int64_t)(uint32_t)k_ra_dotf_reg00_key_size_192,
                 (int64_t)(reg->REG00 & (uint32_t)k_ra_dotf_reg00_key_size_mask));
  ...
  /* Bad inputs. */
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_set_key_size((uint8_t)k_dotf_test_bad, k_ra_dotf_key_size_128));
  TEST_ASSERT_EQ(
    (int32_t)k_ra_err_invalid_arg,
    (int32_t)ra_dotf_set_key_size((uint8_t)k_dotf_test_ch0, (ra_dotf_key_size_t)0xDEADBEEFUL));
...
static void test_run_self_test(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_init());
  uint32_t snap = 0U;
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_run_self_test((uint8_t)k_dotf_test_ch0, &snap));
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_dotf_run_self_test((uint8_t)k_dotf_test_ch0, nullptr));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_dotf_run_self_test((uint8_t)k_dotf_test_bad, &snap));
...
static void test_attach_dispatch(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_init());
  TEST_ASSERT_EQ((int32_t)k_ra_ok,
                 (int32_t)ra_dotf_attach_handler(stub_dotf_cb, (void*)(uintptr_t)0xCAFEU));

  ra_dotf_dispatch((uint8_t)k_dotf_test_ch1);
  TEST_ASSERT_EQ((int32_t)1, (int32_t)s_cb_count);
  TEST_ASSERT_EQ((int32_t)k_dotf_test_ch1, (int32_t)s_cb_last_ch);
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_attach_handler(nullptr, nullptr));
...
static void test_power_transition(void)
{
  ...
  prep();
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_init());
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_enter_stop());
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_exit_stop());
...
static void test_both_channels_active(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_dotf_set_region((uint8_t)k_dotf_test_ch0, &r0));
  TEST_ASSERT_EQ(
    (int32_t)k_ra_ok,
    (int32_t)ra_dotf_select_region((uint8_t)k_dotf_test_ch0, (uint8_t)k_dotf_test_slot0));
