 ...
 * @since 0.1.0
 */
static ra8_err_t mut_read(void* ctx, uint32_t lba, uint32_t count, uint8_t* buf)
{
 ...
 * @since 0.1.0
 */
static ra8_err_t mut_write(void* ctx, uint32_t lba, uint32_t count, const uint8_t* buf)
{
 ...
 * @since 0.1.0
 */
static ra8_err_t mut_capacity(void* ctx, uint32_t* block_count, uint32_t* block_size)
{
  const mut_disk_t* d = (const mut_disk_t*)ctx;
 ...
 * @since 0.1.0
 */
static uint32_t root_byte(const ra8_fs_mount_t* h, uint32_t idx)
{
 ...
 * @since 0.1.0
 */
static uint32_t fat_byte(const ra8_fs_mount_t* h, uint32_t clus)
{
