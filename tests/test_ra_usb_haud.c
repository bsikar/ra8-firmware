...
static ra_usb_haud_device_t s_attach_last_device;
...
static void prep(void)
{
  ra_sim_mmap_reset();
  (void)ra_mstp_init();
  (void)ra_usb_haud_close();
  s_attach_count       = 0U;
  s_attach_last_device = (ra_usb_haud_device_t){};
  s_attach_last_ctx    = nullptr;
}

static void stub_on_attach(void* ctx, const ra_usb_haud_device_t* device)
{
  ++s_attach_count;
...
static void walk_to_attach(void)
{
  TEST_ASSERT_EQ(
    (int32_t)k_ra_ok,
    (int32_t)ra_usb_haud_attach_callback(stub_on_attach, (void*)k_test_haud_ctx_token));
  for (uint8_t i = 0U; i < k_test_haud_max_steps; ++i) {
    ...
    ra_usb_fs()->DCPCTR = 0U;
    TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_usb_haud_step());
  }
...
static void test_close_without_init(void)
{
  ...
  prep();
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_close());
  TEST_END("ra_usb_haud_close before init returns invalid_state");
}
...
static void test_attach_callback_fires_once(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_test_haud_ctx_token, (int32_t)(uintptr_t)s_attach_last_ctx);
  ...
  TEST_ASSERT_EQ((int32_t)0U, (int32_t)s_attach_last_device.ac_interface);
  TEST_ASSERT_EQ((int32_t)1U, (int32_t)s_attach_last_device.as_interface);
  TEST_ASSERT_EQ((int32_t)2U, (int32_t)s_attach_last_device.feature_unit_id);
  TEST_ASSERT_EQ((int32_t)1U, (int32_t)s_attach_last_device.iso_out_ep);
  TEST_ASSERT_EQ((int32_t)0U, (int32_t)s_attach_last_device.iso_in_ep);
  TEST_ASSERT_EQ((int32_t)2U, (int32_t)s_attach_last_device.channel_count);
  TEST_ASSERT_EQ((int32_t)16U, (int32_t)s_attach_last_device.bits_per_sample);
  TEST_ASSERT_EQ((int32_t)48000U, (int32_t)s_attach_last_device.sample_rate_min_hz);
  TEST_ASSERT_EQ((int32_t)48000U, (int32_t)s_attach_last_device.sample_rate_max_hz);
...
static void test_pre_init_guards(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state,
                 (int32_t)ra_usb_haud_attach_callback(stub_on_attach, nullptr));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_step());

  uint8_t  buf[8] = {};
  uint16_t got    = 0U;
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_set_format(2U, 16U, 48000U));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_set_volume(0U, 0));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_set_mute(0U, true));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state,
                 (int32_t)ra_usb_haud_send_samples(buf, (uint16_t)sizeof(buf)));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state,
                 (int32_t)ra_usb_haud_recv_samples(buf, (uint16_t)sizeof(buf), &got));
...
static void test_pre_attach_guards(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_set_format(2U, 16U, 48000U));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_set_volume(0U, 0));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state, (int32_t)ra_usb_haud_set_mute(0U, false));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state,
                 (int32_t)ra_usb_haud_send_samples(buf, (uint16_t)sizeof(buf)));
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_state,
                 (int32_t)ra_usb_haud_recv_samples(buf, (uint16_t)sizeof(buf), &got));
...
static void test_null_arg_rejection(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_usb_haud_send_samples(nullptr, (uint16_t)sizeof(buf)));
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_usb_haud_recv_samples(nullptr, (uint16_t)sizeof(buf), &got));
  TEST_ASSERT_EQ((int32_t)k_ra_err_null_ptr,
                 (int32_t)ra_usb_haud_recv_samples(buf, (uint16_t)sizeof(buf), nullptr));
...
static void test_set_format_invalid_args(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_usb_haud_set_format(0U, 16U, 48000U)); /* 0 channels.    */
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_usb_haud_set_format(9U, 16U, 48000U)); /* 9 channels.    */
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_usb_haud_set_format(2U, 4U, 48000U)); /* 4-bit too low. */
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_usb_haud_set_format(2U, 64U, 48000U)); /* 64-bit too high. */
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_usb_haud_set_format(2U, 16U, 4000U)); /* 4 kHz too low.  */
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg,
                 (int32_t)ra_usb_haud_set_format(2U, 16U, 384000U)); /* 384 kHz too high. */
...
static void test_set_format_setup_envelope(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_usb_haud_set_format(2U, 24U, 96000U));
  /* USBREQ low byte = bmRequestType, high byte = bRequest.
   * For SET_CUR endpoint: 0x01 << 8 | 0x22 = 0x0122. */
  TEST_ASSERT_EQ((int32_t)0x0122U, (int32_t)ra_usb_fs()->USBREQ);
  ...
  TEST_ASSERT_EQ((int32_t)3U, (int32_t)ra_usb_fs()->USBLENG);
  TEST_END("ra_usb_haud_set_format stages bmRequestType=0x22 + bRequest=0x01");
}
...
static void test_set_volume_setup_envelope(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)0x0200U, (int32_t)ra_usb_fs()->USBINDX);
  /* USBLENG = 2 (signed 16-bit dB payload). */
  TEST_ASSERT_EQ((int32_t)2U, (int32_t)ra_usb_fs()->USBLENG);
  TEST_END("ra_usb_haud_set_volume stages bmRequestType=0x21 + bRequest=0x01");
}
...
static void test_set_mute_setup_envelope(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_ok, (int32_t)ra_usb_haud_set_mute(0U, true));
  /* USBREQ = (0x01 << 8) | 0x21 = 0x0121. */
  TEST_ASSERT_EQ((int32_t)0x0121U, (int32_t)ra_usb_fs()->USBREQ);
  ...
  TEST_END("ra_usb_haud_set_mute stages bmRequestType=0x21 + bRequest=0x01");
}
...
static void test_iso_invalid_args(void)
{
  ...
  TEST_ASSERT_EQ((int32_t)k_ra_err_invalid_arg, (int32_t)ra_usb_haud_recv_samples(buf, 0U, &got));
