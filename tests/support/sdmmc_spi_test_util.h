...
/**
 * @enum sdmmc_spi_test_util_uint8_const_t
...
typedef enum : uint8_t {
  ...
  /** Top-byte shift of the little-endian tail word. */
  ...
  k_sdmmc_spi_test_util_csd_off_csize_lo = 9,
  /** All-ones byte: C_SIZE fill and low-byte mask. */
  k_sdmmc_spi_test_util_byte_mask = 0xFFU,
...
static inline void queue_full_init_sdhc_32gib(void)
{
  ...
  mock_queue_idle(k_sdmmc_spi_test_util_mock_queue_idle_10);
  /* CMD0 -> R1 idle (0x01). */
