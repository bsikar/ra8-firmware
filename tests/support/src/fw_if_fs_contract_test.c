 ...
 * vector, moved here from tests/misc/src/test_fw_if_fs.c to keep both files under the
 ...
 */
RA8_INTERNAL static ra8_err_t
/* NOLINTNEXTLINE(readability-non-const-parameter) -- fw_fs_stream_iface_t.read requires mutable backend/file state. */
