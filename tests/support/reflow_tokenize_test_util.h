 ...
 * test_ra8_reflow_tokenize_scan_mcdc.c, test_ra8_reflow_tokenize_tag_mcdc.c,
 * and test_ra8_reflow_tokenize_link_mcdc.c. Everything here has internal
...
static inline uint32_t count_kind(ra8_reflow_token_kind_t kind)
{
  uint32_t n = 0U;
  for (uint32_t i = 0U; i < s_engine.token_count; ++i) {
