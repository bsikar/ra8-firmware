 ...
 */
typedef struct {
  ra8_book_chapter_t    chapters[k_ra8_test_rabook_chapter_cap]; /**< Chapter arena.        */
  ra8_book_node_t       nodes[k_ra8_test_rabook_node_cap];       /**< DOM-node arena.       */
  ra8_book_attr_t       attrs[k_ra8_test_rabook_attr_cap];       /**< Attribute arena.      */
  ra8_book_stylesheet_t styles[k_ra8_test_rabook_style_cap];     /**< Stylesheet arena.     */
  ra8_book_image_t      images[k_ra8_test_rabook_image_cap];     /**< Image descriptors.    */
