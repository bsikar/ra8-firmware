 ...
 */
static inline void priv_dirname_inplace(char* path)
{
 ...
 */
static inline void priv_bind_gfx(void)
{
 ...
 */
static inline uint32_t priv_count_lit_pixels(int32_t x0, int32_t y0, int32_t x1, int32_t y1)
{
  uint32_t lit = 0U;
