 ...
 * (`tests/test_ra8_fs_utf.c` for the codec, `tests/test_ra8_fs_lfn_write*.c`
 * for the chain layout). What it adds is that they are wired together.
 *
 ...
 * `libs/ra8_fs/src/ra8_fs_fat_name.c@priv_alias_map_unit` (1 condition).
