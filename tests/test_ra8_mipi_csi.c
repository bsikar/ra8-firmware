/**
 * @file test_ra8_mipi_csi.c
 * @brief Unit tests for the MIPI CSI-2 receiver HAL driver
 *
 * @details
 * Exercises ra8_mipi_csi.c against the host-side simulated MMIO
 * (``ra8_sim_mmap``). Covers every public entry point with happy +
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK  ] test_ra8_mipi_csi.c\n");
  return 0;
}
