/**
 * @file test_ra_wdt_supervisor.c
 * @brief Unit tests + MC/DC vectors for libs/ra_wdt_supervisor/src/ra_wdt_supervisor.c
 *
 ...
 * (2 conditions, libs/ra_wdt_supervisor/src/ra_wdt_supervisor.c line 396)
 *
...
{
  TEST_BEGIN("ra_wdt_supervisor_tick MC/DC: any_present && all_alive");
 ...
 * (2 conditions, libs/ra_wdt_supervisor/src/ra_wdt_supervisor.c line 397)
 *
 * Vectors (Chilenski masking-MC/DC, N+1 = 3 for N=2):
...
{
  TEST_BEGIN("ra_wdt_supervisor_tick MC/DC: will_refresh && refresh != NULL");
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK ] test_ra_wdt_supervisor.c\n");
  return 0;
}
