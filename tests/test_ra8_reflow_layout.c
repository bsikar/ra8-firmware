...
internal_init_with(uint16_t w, uint16_t h, const uint8_t* font, uint16_t font_px, ra8_reflow_t* out)
{
...
RA8_INTERNAL static void internal_test_mcdc_reflow_internal_is_indent_tag(void)
{
  ...
  TEST_ASSERT(priv_ra8_reflow_internal_is_indent_tag((uint8_t)k_ra8_reflow_tag_li));
  TEST_ASSERT(priv_ra8_reflow_internal_is_indent_tag((uint8_t)k_ra8_reflow_tag_blockquote));
  TEST_ASSERT(!priv_ra8_reflow_internal_is_indent_tag((uint8_t)k_ra8_reflow_tag_h1));
  TEST_ASSERT(!priv_ra8_reflow_internal_is_indent_tag((uint8_t)k_ra8_reflow_tag_p));
...
RA8_INTERNAL static void internal_test_mcdc_reflow_internal_right_overflow_break(void)
{
  ...
  TEST_ASSERT(!priv_ra8_reflow_internal_right_overflow_break(0, 10, 100, 1U));
  TEST_ASSERT(priv_ra8_reflow_internal_right_overflow_break(95, 10, 100, 1U));
  TEST_ASSERT(!priv_ra8_reflow_internal_right_overflow_break(95, 10, 100, 0U));
...
RA8_INTERNAL static void internal_test_mcdc_reflow_internal_xhtml_invalid(void)
{
  ...
  TEST_ASSERT(!priv_ra8_reflow_internal_xhtml_invalid(buf, 1U));
  TEST_ASSERT(priv_ra8_reflow_internal_xhtml_invalid(nullptr, 1U));
  TEST_ASSERT(priv_ra8_reflow_internal_xhtml_invalid(buf, 0U));
...
RA8_INTERNAL static void internal_test_mcdc_reflow_internal_final_page_needed(void)
{
  ...
  TEST_ASSERT(!priv_ra8_reflow_internal_final_page_needed(1U, 5U));
  TEST_ASSERT(priv_ra8_reflow_internal_final_page_needed(0U, 5U));
  TEST_ASSERT(!priv_ra8_reflow_internal_final_page_needed(0U, 0U));
