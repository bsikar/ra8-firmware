 ...
 * @brief MC/DC vectors for the compound guard in apps/shared_libs/reflow/src/ra8_img_arena.c.
 *
 * @details
 ...
 * apps/shared_libs/reflow/src/ra8_img_arena.c@ra8_img_arena_free). `a` is the bound arena
