 ...
 * (2 conditions,
 * apps/shared_libs/webp/src/ra8_webp.c@ra8_webp_get_info).
 ...
 * (2 conditions,
 * apps/shared_libs/webp/src/ra8_webp.c@internal_webp_check_output;
 * min_stride = w*4 = 32).
...
static void internal_test_arena_malloc_and_bind(void)
{
  ...
  static uint8_t   s_buffer[32U];
  ra8_webp_arena_t a = {.base = s_buffer, .cap = sizeof s_buffer, .offset = 0U, .live = 0U};
...
static void internal_test_arena_calloc_overflow_mcdc(void)
{
  ...
  static uint8_t   s_buffer[k_t_tiny_cap];
  ra8_webp_arena_t a = {.base = s_buffer, .cap = sizeof s_buffer, .offset = 0U, .live = 0U};
  ra8_webp_arena_bind(&a);
 ...
 * (2 conditions,
 * apps/shared_libs/webp/src/ra8_webp_arena.c@ra8_webp_arena_free).
