 ...
 * @brief Coverage supplement for apps/shared_libs/reflow/src/ra8_img_arena.c
 *
 * @details
 ...
 * test_reflow_image.c or by earlier tests within this file.
 *
 ...
 *    Covered by test_reflow_image.c.
 *
 * @pre None.
