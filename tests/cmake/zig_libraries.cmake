...
# Partially migrated: the rasteriser core, the glyph/text stack and the
# blue-noise dither are Zig now -- the single shared framebuffer binding
# g_gfx_text_state, the two promoted helpers priv_gfx_text_pack_565 /
# priv_gfx_text_plot, and the fifteen public entry points of inc/ra8_gfx.h and
# inc/ra8_gfx_dither.h. The generated blue-noise table moved with it, emitted
# by scripts/gen/gen_bluenoise_mask.py as src/internal/dither_mask.zig. The one
# remaining C translation unit of the library (the generated
# ra8_gfx_font_8x16.c) stays C and reaches into this archive through the
