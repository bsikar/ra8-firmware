...
if(TARGET test_fw_if_fs)
  target_sources(
    ...
    PRIVATE ${FW_ROOT}/tests/support/fw_if_fs_contract_test.c
            ...
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_pathfs.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_sanitize.c
...
if(TARGET test_ra8_mdl_state)
  target_sources(
    ...
    PRIVATE ${FW_ROOT}/port/posix/src/fw_if_fs_posix.c
            ...
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_common.c
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_stream.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_state.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_state_codec.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_state_decimal.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_state_store.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_storage.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_hash.c
...
if(TARGET test_ra8_mdl_library)
  target_sources(
    ...
    PRIVATE ${FW_ROOT}/port/posix/src/fw_if_fs_posix.c
            ...
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_common.c
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_stream.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_library.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_sanitize.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_state.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_state_codec.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_state_decimal.c
...
if(TARGET test_ra8_mdl_readers)
  target_sources(
    ...
    PRIVATE ${FW_ROOT}/port/posix/src/fw_if_fs_posix.c
            ...
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_common.c
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_stream.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_config.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_urlname.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_workspace.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_verify.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_verify_tarball.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_verify_rabook.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_sanitize.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_storage.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_hash.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_politeness.c
            ${CMAKE_CURRENT_SOURCE_DIR}/support/mdl_state_fs_fault.c
  )
  target_include_directories(
    test_ra8_mdl_readers
...
if(TARGET test_ra8_mdl_export)
  target_sources(
    ...
    PRIVATE ${FW_ROOT}/port/posix/src/fw_if_fs_posix.c
            ...
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_common.c
            ${FW_ROOT}/port/posix/src/fw_if_fs_posix_stream.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_workspace.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_io.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_meta.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_zip.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_tar.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_epub.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_epub_meta.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_jof.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_rabook.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_export_rabook_io.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_verify.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_verify_tarball.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_verify_rabook.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_urlname.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_url_guard.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_sanitize.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_storage.c
            ${FW_ROOT}/apps/shared/media_dl/src/mdl_hash.c
  )
  target_include_directories(
    ...
    PRIVATE ${FW_ROOT}/libs/if/inc
            ...
            ${FW_ROOT}/apps/shared/media_dl/inc
            ${FW_ROOT}/apps/shared/media_dl/src
            ${FW_ROOT}/apps/shared/media_dl/tests
  )
