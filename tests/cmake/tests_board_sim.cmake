...
# (tools/board_sim/src/board_periph_mstp_model.c) takes NO Unicorn dependency by
...
add_executable(
  test_board_sim_mstp_gate ${CMAKE_CURRENT_SOURCE_DIR}/test_board_sim_mstp_gate.c
                           ${FW_ROOT}/tools/board_sim/src/board_periph_mstp_model.c
)
...
target_include_directories(
  test_board_sim_mstp_gate PRIVATE ${CMAKE_CURRENT_SOURCE_DIR} ${FW_ROOT}/libs/ra8_core/inc
                                   ${FW_ROOT}/libs/ra8_hal/inc ${FW_ROOT}/tools/board_sim/src
)
