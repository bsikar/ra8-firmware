...
static const uint8_t k_test_key[k_ra_key_vault_key_bytes] = {
...
static const uint8_t k_test_chal[k_ra_key_vault_chal_bytes] = {
...
static void test_different_challenge_different_digest(void)
{
  ...
  uint8_t digest_a[k_ra_key_vault_digest_bytes] = {0U};
  uint8_t digest_b[k_ra_key_vault_digest_bytes] = {0U};
  uint8_t chal_b[k_ra_key_vault_chal_bytes];
  for (uint32_t i = 0U; i < (uint32_t)k_ra_key_vault_chal_bytes; ++i) {
