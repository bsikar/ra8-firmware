...
typedef enum : uint16_t {
  ...
  k_thc_sack_bit    = (1U << k_ra8_int1_bit_sack),    /**< INTSTS1 SETUP-ACK latch.     */
  k_thc_sign_bit    = (1U << k_ra8_int1_bit_sign),    /**< INTSTS1 SETUP-fail latch.    */
  k_thc_sureq_bit   = (1U << k_ra8_dcpctr_bit_sureq), /**< DCPCTR SUREQ (pending req).  */
  k_thc_dcp_bit     = k_ra8_usb_dcp_pipe0_bit,        /**< BRDY/BEMP/NRDY DCP (pipe0).  */
  k_thc_dir_in      = k_ra8_usb_setup_dir_in,         /**< bmRequestType device-to-host */
