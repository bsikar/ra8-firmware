 ...
 * libs/ra8_hal/src/ra8_usb_cdc.c.
 *
 ...
 *   returns `k_ra8_ok`, but `internal_pull_data_stage` is currently a
 *   stub that always returns `k_ra8_err_not_supported` (see source line
