/**
 * @file test_ra_ble_att.c
 * @brief MC/DC vector documentation for libs/ra_ble_host/src/ra_ble_att.c
 *
 * @details
 * Most decisions in ra_ble_att.c live inside ``static`` per-opcode
...
/* Forward decl from libs/ra_ble_host/inc/ra_ble_host.h. */
extern void ra_ble_host_att_handle_pdu(uint16_t conn_handle, const uint8_t* pdu, uint16_t pdu_len);
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_att.c line 286)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_att.c line 530)
...
{
  TEST_BEGIN("ra_ble_att writable char-value MC/DC: kind==char && value!=NULL");
  uint8_t buf[1] = {0U};
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_att.c line 665, public symbol)
...
{
  TEST_BEGIN("ra_ble_host_att_handle_pdu MC/DC: pdu NULL || len==0");
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK ] test_ra_ble_att.c\n");
  return 0;
}
