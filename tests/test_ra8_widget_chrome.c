 ...
 * chip) and the navigation strip. Each renders through a recording mock
...
typedef enum : int16_t {
  ...
  k_t_wide_w       = 200, /**< Width of the header rect.                       */
...
typedef enum : uint32_t {
  k_t_argb_bg        = 0x00FFFFFFU, /**< Background shared by header, menu and nav. */
  k_t_argb_fg        = 0x00101010U, /**< Primary text; also the active nav label.   */
  k_t_argb_fg_right  = 0x00808080U, /**< Right-aligned secondary text.              */
