 ...
 * `tests/storage/src/test_ra8_fs_unicode_names.c`, which has a volume to read it from.
 *
 ...
 * `libs/ra8_fs/src/ra8_fs_utf.c@internal_utf8_lead` (4 conditions, one per arm).
