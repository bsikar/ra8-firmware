 ...
 *
 * @details
 * Sibling of ``tests/storage/src/test_ra8_fs_fat.c``. Where that file exercises the mount /
 ...
 * `tests/host/src/exfat_fs_test.c` and the `fs_format_mount` HIL. The produced exFAT
