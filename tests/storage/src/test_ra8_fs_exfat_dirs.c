 ...
 * (libs/ra8_fs/src/ra8_fs_fat_dirmk.c@internal_mkdir_locked) -> true, and
 ...
 * (libs/ra8_fs/src/ra8_fs_fat_exfat_dir.c@internal_exfat_dir_is_empty) -> true on
 ...
 * (libs/ra8_fs/src/ra8_fs_fat_exfat_dir.c@internal_exfat_dir_is_empty) -> false,
 ...
 * No compound decision lies on this path. The vectors it contributes are
 * `fe == k_ra8_ok`
 * (libs/ra8_fs/src/ra8_fs_fat_exfat_dir.c@internal_exfat_mkdir_check) -> true for
 ...
 * `(file_e[k_exfat_off_file_attr] & k_exfat_attr_directory) == 0`
 * (libs/ra8_fs/src/ra8_fs_fat_exfat_dir.c@internal_exfat_rmdir_locate), plus
 * `(attr & k_exfat_attr_directory) != 0`
 ...
 * No compound decision lies on this path. The vector it contributes is
 * `pos < nlen`
 * (libs/ra8_fs/src/ra8_fs_fat_exfat_write.c@internal_exfat_build_set) taken both
 ...
 *       read-fault vectors in tests/storage/src/test_ra8_fs_fat_exfat_write_dir_cov.c.
 ...
 * (libs/ra8_fs/src/ra8_fs_fat_exfat_mutate.c@internal_exfat_rename_prepare) taken
