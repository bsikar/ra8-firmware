 ...
 *
 * @details
 * Third sibling of ``tests/storage/src/test_ra8_fs_fat.c`` and
 * ``tests/storage/src/test_ra8_fs_fat_variants.c``. Those files (plus
 * ``tests/storage/src/test_ra8_fs_format.c``) cover the bulk of the FAT/exFAT adapter; this
 ...
 * ``tests/storage/src/test_ra8_fs_fat.c`` exactly. LFN directory images are planted by
 ...
 * @par MC/DC:
 * Two decisions in `libs/ra8_fs/src/ra8_fs_fat_lfn.c@internal_dir_find_long_sector`,
