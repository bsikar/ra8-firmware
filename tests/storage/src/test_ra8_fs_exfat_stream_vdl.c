 ...
 * `libs/ra8_fs/src/ra8_fs_fat_fileio.c@internal_read_span` (1 condition).
 ...
 * `libs/ra8_fs/src/ra8_fs_fat_exfat_stream.c@internal_exfat_close_gap`
 * (1 condition).
 ...
 * `libs/ra8_fs/src/ra8_fs_fat_exfat_openw.c@internal_exfat_writable_set`
