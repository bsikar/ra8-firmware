 ...
 * ``tests/storage/src/test_ra8_fs_format.c`` for the 1000-line file-size cap. It formats a
 ...
 * ``tests/storage/inc/test_ra8_fs_format_fixture.h``.
 *
 * exFAT file creation / rename / unlink is covered separately by
 * ``tests/host/src/exfat_fs_test.c`` and the ``fs_format_mount`` HIL. The produced
 ...
 *          separately by `tests/host/src/exfat_fs_test.c` and the `fs_format_mount`
