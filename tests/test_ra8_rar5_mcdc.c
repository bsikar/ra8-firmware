...
static void test_mcdc_filter_delta(void)
{
  ...
  ra8_rar5_filter_delta(&s_state, s_d, k_t_delta_len, 2U);
...
static void test_mcdc_fill_zeros(void)
{
  ...
  static uint8_t s_buf[k_t_small_cap];
