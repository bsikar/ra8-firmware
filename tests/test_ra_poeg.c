/**
 * @file test_ra_poeg.c
 * @brief Unit tests for ra_poeg.c (Port Output Enable for GPT)
 *
...
typedef enum : uint8_t {
  k_ra_poeg_test_group_valid = 0U,
  k_ra_poeg_test_group_last  = 3U,
  k_ra_poeg_test_group_bad   = 4U,
} ra_poeg_test_group_t;
...
static ra_poeg_cfg_t make_cfg(void)
{
  const ra_poeg_cfg_t cfg = {
    .enable_pin      = true,
    .enable_ioc      = true,
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK  ] test_ra_poeg.c\n");
  return 0;
}
