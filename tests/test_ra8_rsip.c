/**
 * @file test_ra8_rsip.c
 * @brief Unit tests for ra8_rsip.c (Renesas Secure IP HAL)
 *
 * @details
...
typedef enum : uint32_t {
  ...
  k_ra8_rsip_test_pattern_w   = 0xCAFEBABEUL, /**< Sentinel TRNG word.          */
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK ] test_ra8_rsip.c\n");
  return 0;
}
