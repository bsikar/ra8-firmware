 ...
 * @font-face resources parsed by ra_epub and rasterised through stb_truetype
 * (see priv_font_init / priv_render_into in libs/ra_epub/src/ra_epub_chapter.c
 * and the ra_reflow layout driver). The font bytes are fully attacker-
 ...
 * ra_stbtt bump arena the firmware links, so no host heap is involved.
 *
