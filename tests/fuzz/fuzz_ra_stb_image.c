 ...
 * BMP) through stb_image, driven from ra_img_decode_blit() in
 * libs/ra_reflow/src/ra_reflow_image.c. Those bytes are fully
 ...
 * heap-free ra_img_arena bump allocator the firmware binds, so an ASan / UBSan
...
#include "ra_img_arena.h" /* ra_img_arena_t, ra_img_arena_bind/_unbind    */
