 ...
 *  - the bad-font guard in ra8_reflow_run_layout (internal_init_font error returns);
 ...
 * @details Exercises the png loader path and preserves each documented result and bound.
 ...
 *
 * @details Targets ra8_reflow_layout.c lines 231-235 (internal_init_font's offset<0 /
 ...
 *
 * @details Targets ra8_reflow_layout.c lines 445-461 (internal_justify_glyphs: the
 ...
 *
 * @details Targets ra8_reflow_layout.c line 500-501 (internal_finish_line's
 ...
 *
 * @details Targets ra8_reflow_layout.c lines 698-700 (internal_open_block's
 ...
 *
 * @details Targets ra8_reflow_layout.c lines 822-829 (internal_apply_image_placeholder
 ...
 *
 * @details Targets ra8_reflow_layout.c lines 916-917 (internal_image_resolve_size
...
RA8_INTERNAL static void internal_test_cov_image_loader_failure_fallback(void)
{
  ...
  ra8_img_arena_t arena = {.base   = s_arena_buf,
                           ...
                           .live   = 0U};
  TEST_ASSERT_EQ(k_ra8_ok,
                 ra8_reflow_set_image_loader(&s_eng, internal_fail_loader, nullptr, &arena));
 ...
 *
 * @details Targets ra8_reflow_layout.c internal_place_image / internal_image_resolve_size
...
RA8_INTERNAL static void internal_test_cov_image_real_block(void)
{
  ...
  ra8_img_arena_t arena = {.base   = s_arena_buf,
                           ...
                           .live   = 0U};
  TEST_ASSERT_EQ(k_ra8_ok,
                 ra8_reflow_set_image_loader(&s_eng, internal_png_loader, nullptr, &arena));
 ...
 *
 * @details Targets ra8_reflow_layout.c's table family: internal_table_columns
 ...
 *
 * @details Targets ra8_reflow_layout.c line 1213 (internal_match_block_end's
...
RA8_INTERNAL static void internal_test_cov_lifecycle_guards(void)
{
  ...
  TEST_ASSERT_EQ(k_ra8_err_null_ptr,
                 ra8_reflow_set_image_loader(nullptr, internal_png_loader, nullptr, nullptr));
  TEST_ASSERT_EQ(k_ra8_err_not_initialized,
                 ra8_reflow_set_image_loader(&closed, internal_png_loader, nullptr, nullptr));
