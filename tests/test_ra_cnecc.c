...
static void test_init_null_cfg(void)
{
  ...
  prep();
  TEST_ASSERT_EQ(k_ra_err_null_ptr, ra_cnecc_init(nullptr));
...
static void test_init_happy(void)
{
  ...
  for (uint8_t i = (uint8_t)k_ra_cnecc_test_inst_first; i <= (uint8_t)k_ra_cnecc_test_inst_last;
    ...
    TEST_ASSERT_EQ(k_ra_cnecc_mask_emca_unlock, (reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_emca));
    /* Test mode left disabled. */
    TEST_ASSERT_EQ(k_ra_cnecc_mask_test_disable, reg->EC710TMC);
  }
...
static void test_init_no_correction_no_irqs(void)
{
  ...
  TEST_ASSERT_EQ(0, (reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec1edic));
  TEST_ASSERT_EQ(0, (reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec2edic));
...
static void test_init_judgment_disabled(void)
{
  ...
  for (uint8_t i = (uint8_t)k_ra_cnecc_test_inst_first; i <= (uint8_t)k_ra_cnecc_test_inst_last;
       ++i) {
    volatile r_cnecc_regs_t* reg = ra_cnecc(i);
    TEST_ASSERT_EQ(0, (reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ecervf));
  }
...
static void test_enable_disable_instance_bounds(void)
{
  ...
  prep();
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_enable_instance((uint8_t)k_ra_cnecc_test_inst_bad));
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_disable_instance((uint8_t)k_ra_cnecc_test_inst_huge));
...
static void test_enable_disable_instance_toggle(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_enable_instance((uint8_t)k_ra_cnecc_test_inst_first));
  ...
  TEST_ASSERT_EQ(0, (r1->EC710CTL & (uint32_t)k_ra_cnecc_mask_ecervf));
  /* RMW preserved the EMCA unlock pattern. */
  TEST_ASSERT_EQ(k_ra_cnecc_mask_emca_unlock, (r0->EC710CTL & (uint32_t)k_ra_cnecc_mask_emca));

  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_disable_instance((uint8_t)k_ra_cnecc_test_inst_first));
  TEST_ASSERT_EQ(0, (r0->EC710CTL & (uint32_t)k_ra_cnecc_mask_ecervf));
...
static void test_set_irq_enables(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_set_irq_enables((uint8_t)k_ra_cnecc_test_inst_bad, true, true));

  TEST_ASSERT_EQ(k_ra_ok,
                 ra_cnecc_set_irq_enables((uint8_t)k_ra_cnecc_test_inst_first, false, true));
  volatile r_cnecc_regs_t* reg = ra_cnecc((uint8_t)k_ra_cnecc_test_inst_first);
  TEST_ASSERT_EQ(0, (reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec1edic));
  TEST_ASSERT((reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec2edic) != 0U);

  TEST_ASSERT_EQ(k_ra_ok,
                 ra_cnecc_set_irq_enables((uint8_t)k_ra_cnecc_test_inst_first, true, false));
  TEST_ASSERT((reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec1edic) != 0U);
  TEST_ASSERT_EQ(0, (reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec2edic));
...
static void test_set_correction_permission(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_set_correction_permission((uint8_t)k_ra_cnecc_test_inst_bad, true));

  TEST_ASSERT_EQ(k_ra_ok,
                 ra_cnecc_set_correction_permission((uint8_t)k_ra_cnecc_test_inst_last, false));
  volatile r_cnecc_regs_t* reg = ra_cnecc((uint8_t)k_ra_cnecc_test_inst_last);
  TEST_ASSERT((reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec1ecp) != 0U);

  TEST_ASSERT_EQ(k_ra_ok,
                 ra_cnecc_set_correction_permission((uint8_t)k_ra_cnecc_test_inst_last, true));
  TEST_ASSERT_EQ(0, (reg->EC710CTL & (uint32_t)k_ra_cnecc_mask_ec1ecp));
...
static void test_get_status_null_out(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_null_ptr,
                 ra_cnecc_get_status((uint8_t)k_ra_cnecc_test_inst_first, nullptr));
...
static void test_get_status_bad_instance(void)
{
  ...
  prep();
  ra_cnecc_status_t s = {};
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_get_status((uint8_t)k_ra_cnecc_test_inst_bad, &s));
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_get_status((uint8_t)k_ra_cnecc_test_inst_huge, &s));
...
static void test_get_status_decodes_flags(void)
{
  ...
  ra_cnecc_status_t s = {};
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_status((uint8_t)k_ra_cnecc_test_inst_first, &s));
  ...
  TEST_ASSERT_EQ(k_ra_cnecc_test_addr_a, s.last_addr);
  ...
  TEST_ASSERT(s.irq2_enabled);
  TEST_ASSERT_EQ(k_ra_cnecc_test_addr_b, s.last_addr);
...
static void test_get_status_masks_ead(void)
{
  ...
  ra_cnecc_status_t s          = {};
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_status((uint8_t)k_ra_cnecc_test_inst_first, &s));
  TEST_ASSERT_EQ(((uint32_t)k_ra_cnecc_test_addr_over & (uint32_t)k_ra_cnecc_mask_ecead),
                 s.last_addr);
...
static void test_get_counters(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_null_ptr,
                 ra_cnecc_get_counters((uint8_t)k_ra_cnecc_test_inst_first, nullptr));
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_get_counters((uint8_t)k_ra_cnecc_test_inst_bad, &c));

  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_counters((uint8_t)k_ra_cnecc_test_inst_first, &c));
...
static void test_reset_counters(void)
{
  ...
  const ra_cnecc_config_t cfg = make_default_cfg();
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_init(&cfg));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_attach_handler(stub_cnecc_cb, nullptr));
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_counters((uint8_t)k_ra_cnecc_test_inst_first, &before));
  TEST_ASSERT_EQ(1, before.one_bit_count);
  TEST_ASSERT_EQ(1, before.two_bit_count);
  TEST_ASSERT_EQ(1, before.overflow_count);

  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_reset_counters((uint8_t)k_ra_cnecc_test_inst_huge));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_reset_counters((uint8_t)k_ra_cnecc_test_inst_first));

  ra_cnecc_counters_t after = {};
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_counters((uint8_t)k_ra_cnecc_test_inst_first, &after));
...
static void test_bbr_mirror(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_set_counter_mirror((uint8_t)k_ra_cnecc_test_inst_huge, &bbr0));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_set_counter_mirror((uint8_t)k_ra_cnecc_test_inst_first, &bbr0));
  ...
  TEST_ASSERT_EQ(k_ra_ok,
                 ra_cnecc_set_counter_mirror((uint8_t)k_ra_cnecc_test_inst_first, nullptr));
  ra_cnecc_dispatch((uint8_t)k_ra_cnecc_test_inst_first, false, (uint16_t)k_ra_cnecc_test_addr_a);
  TEST_ASSERT_EQ(0, bbr0.one_bit_count);
...
static void test_clear_status_writes_clear_mask(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_clear_status((uint8_t)k_ra_cnecc_test_inst_first));

  /* Sim mmap is dumb storage -- our clear writes the bundled
   * clear-all mask straight into EC710CTL. */
  TEST_ASSERT_EQ(k_ra_cnecc_mask_clear_all, reg->EC710CTL);
...
static void test_clear_status_bad_instance(void)
{
  ...
  prep();
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_clear_status((uint8_t)k_ra_cnecc_test_inst_bad));
...
static void test_attach_handler_null(void)
{
  ...
  prep();
  TEST_ASSERT_EQ(k_ra_err_null_ptr, ra_cnecc_attach_handler(nullptr, nullptr));
...
static void test_dispatch_invokes_callback_and_counts(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_attach_handler(stub_cnecc_cb, expected_ctx));
  ...
  TEST_ASSERT_EQ(k_ra_cnecc_test_inst_last, s_cb_last_instance);
  TEST_ASSERT(s_cb_last_is_2bit);
  TEST_ASSERT_EQ(k_ra_cnecc_test_addr_b, s_cb_last_addr);
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_status((uint8_t)k_ra_cnecc_test_inst_first, &s0));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_status((uint8_t)k_ra_cnecc_test_inst_last, &s1));
...
static void test_inject_fault_writes_sequence(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_null_ptr,
                 ra_cnecc_inject_fault((uint8_t)k_ra_cnecc_test_inst_first, nullptr));
  const ra_cnecc_inject_t req = {
    .substitute   = (uint32_t)k_ra_cnecc_test_subst_a,
    .one_bit_flip = true,
  };
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_inject_fault((uint8_t)k_ra_cnecc_test_inst_huge, &req));

  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_inject_fault((uint8_t)k_ra_cnecc_test_inst_first, &req));
  volatile r_cnecc_regs_t* reg = ra_cnecc((uint8_t)k_ra_cnecc_test_inst_first);
  /* Final TMC value is 0x8082 (substitute select). */
  TEST_ASSERT_EQ(k_ra_cnecc_mask_test_subst, reg->EC710TMC);
  TEST_ASSERT_EQ(k_ra_cnecc_test_subst_a, reg->EC710TED);
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_inject_fault((uint8_t)k_ra_cnecc_test_inst_last, &req2));
  TEST_ASSERT_EQ(k_ra_cnecc_mask_test_subst, other->EC710TMC);
  TEST_ASSERT_EQ(k_ra_cnecc_test_subst_b, other->EC710TED);
...
static void test_test_mode_disable_and_query(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_test_mode_disable((uint8_t)k_ra_cnecc_test_inst_huge));
  bool active = false;
  TEST_ASSERT_EQ(k_ra_err_null_ptr,
                 ra_cnecc_test_mode_active((uint8_t)k_ra_cnecc_test_inst_first, nullptr));
  TEST_ASSERT_EQ(k_ra_err_invalid_arg,
                 ra_cnecc_test_mode_active((uint8_t)k_ra_cnecc_test_inst_huge, &active));
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_inject_fault((uint8_t)k_ra_cnecc_test_inst_first, &req));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_test_mode_active((uint8_t)k_ra_cnecc_test_inst_first, &active));
  TEST_ASSERT(active);

  /* Disable test mode and re-query -> false. */
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_test_mode_disable((uint8_t)k_ra_cnecc_test_inst_first));
  volatile r_cnecc_regs_t* reg = ra_cnecc((uint8_t)k_ra_cnecc_test_inst_first);
  TEST_ASSERT_EQ(k_ra_cnecc_mask_test_disable, reg->EC710TMC);
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_test_mode_active((uint8_t)k_ra_cnecc_test_inst_first, &active));
  TEST_ASSERT(!active);
...
static void test_attach_isr_bad_priority(void)
{
  ...
  prep();
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_attach_isr((uint8_t)k_ra_cnecc_test_prio_bad));
...
static void test_attach_isr_routes_both_vectors(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_init(&cfg));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_attach_handler(stub_cnecc_cb, nullptr));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_attach_isr((uint8_t)k_ra_cnecc_test_prio));
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_isr_lookup_slot(k_ra_elc_event_can0_mram_eri, &s0));
  TEST_ASSERT_EQ(k_ra_ok, ra_isr_lookup_slot(k_ra_elc_event_can1_mram_eri, &s1));
  TEST_ASSERT(s0 != (uint16_t)k_ra_isr_slot_none);
  TEST_ASSERT(s1 != (uint16_t)k_ra_isr_slot_none);

  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_detach_isr());
  uint16_t s0_after = (uint16_t)k_ra_isr_slot_none;
  TEST_ASSERT_EQ(k_ra_ok, ra_isr_lookup_slot(k_ra_elc_event_can0_mram_eri, &s0_after));
  TEST_ASSERT_EQ(k_ra_isr_slot_none, s0_after);
...
static void test_isr_handler_dispatches_and_clears(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_sim_irq_fire(k_ra_elc_event_can1_mram_eri));
  ...
  TEST_ASSERT_EQ(k_ra_ok, ra_sim_irq_fire(k_ra_elc_event_can0_mram_eri));
  TEST_ASSERT_EQ(2, s_cb_count);
  TEST_ASSERT_EQ(k_ra_cnecc_test_inst_first, s_cb_last_instance);
  TEST_ASSERT(!s_cb_last_is_2bit);

  /* Counters reflect both events (and the overflow bump). */
  ra_cnecc_counters_t c0 = {};
  ra_cnecc_counters_t c1 = {};
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_counters((uint8_t)k_ra_cnecc_test_inst_first, &c0));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_get_counters((uint8_t)k_ra_cnecc_test_inst_last, &c1));
...
static void test_enter_exit_standby(void)
{
  ...
  TEST_ASSERT_EQ(0, (reg0->EC710CTL & (uint32_t)k_ra_cnecc_mask_ecervf));
...
static void test_compute_happy(void)
{
  ...
  uint32_t              ecc_a    = 0U;
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_compute((uint32_t)(uintptr_t)buf_a, sizeof(buf_a), &ecc_a));
  /* Re-running over the same data must yield the same result. */
  uint32_t ecc_b = 0U;
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_compute((uint32_t)(uintptr_t)buf_a, sizeof(buf_a), &ecc_b));
...
static void test_compute_null_out(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_null_ptr,
                 ra_cnecc_compute((uint32_t)(uintptr_t)buf, sizeof(buf), nullptr));
...
static void test_compute_misaligned_addr(void)
{
  ...
  prep();
  uint32_t ecc = 0U;
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_compute(0x1001U, 16U, &ecc));
...
static void test_compute_short_len(void)
{
  ...
  uint32_t              ecc = 0U;
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, ra_cnecc_compute((uint32_t)(uintptr_t)&buf, 2U, &ecc));
...
static void test_compute_zero_addr(void)
{
  ...
  prep();
  uint32_t ecc = 0U;
  TEST_ASSERT_EQ(k_ra_err_null_ptr, ra_cnecc_compute(0U, 16U, &ecc));
...
static void test_verify_match(void)
{
  ...
  uint32_t              ecc    = 0U;
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_compute((uint32_t)(uintptr_t)buf, sizeof(buf), &ecc));
  TEST_ASSERT_EQ(k_ra_ok, ra_cnecc_verify((uint32_t)(uintptr_t)buf, sizeof(buf), ecc));
...
static void test_verify_mismatch(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_crc_mismatch,
                 ra_cnecc_verify((uint32_t)(uintptr_t)buf, sizeof(buf), 0xBADBADU));
