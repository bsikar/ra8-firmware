/**
 * @file test_ra8_reflow_layout_mcdc.c
 * @brief Additional MC/DC unit tests for libs/ra8_reflow/src/ra8_reflow_layout.c.
 *
 * @details
 * Companion to tests/test_ra8_reflow_layout.c (which exercises the promoted
 * pure-helper decisions) and tests/test_ra8_reflow_align.c (alignment offsets).
 ...
 *  - ra8_reflow_register_face(): the `offset < 0 || InitFont == 0` blob-validate
 ...
 */
static ra8_err_t test_image_loader(void*           ctx,
                                   const char*     href,
                                   uint32_t        href_len,
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK ] test_ra8_reflow_layout_mcdc.c\n");
  return 0;
}
