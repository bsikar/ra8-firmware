/**
 * @file test_ra8_reflow_svg_mcdc.c
 * @brief MC/DC + branch-coverage tests for libs/ra8_reflow/src/ra8_reflow_svg.c.
 *
 * @details
 * Complements tests/test_ra8_svg.c by driving the REAL public SVG API
 * (::ra8_svg_is_svg, ::ra8_svg_image_href, ::ra8_svg_size, ::ra8_svg_render)
 ...
 * width/height viewBox fallback in both ::ra8_svg_size and ::ra8_svg_render.
 *
 ...
 * (libs/ra8_reflow/src/ra8_reflow_svg.c@priv_draw_circle).
 ...
 * (libs/ra8_reflow/src/ra8_reflow_svg.c@priv_draw_polygon / @priv_draw_polyline).
 *
 * Vectors:
 ...
 * endpoint-to-centre arc solver (libs/ra8_reflow/src/ra8_reflow_svg_shape.c, 2
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK ] test_ra8_reflow_svg_mcdc.c\n");
  return 0;
}
