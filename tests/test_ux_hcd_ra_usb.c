/**
 * @file test_ux_hcd_ra_usb.c
 * @brief MC/DC vector tests for port/usbx/ux_hcd_ra_usb.c
 *
 * @details
 * The USBX host-controller-driver bridge ``port/usbx/ux_hcd_ra_usb.c``
 * is not part of the host-compiled ``ra_core_hal`` aggregate library
 ...
 * ``port/usbx/ux_hcd_ra_usb.c`` as a ``static inline`` helper using
...
{
  TEST_BEGIN("ux_hcd_ra_usb MC/DC: ep_create pipe range (line 76)");
  ...
  TEST_END("ux_hcd_ra_usb MC/DC: ep_create pipe range (line 76)");
}
...
{
  TEST_BEGIN("ux_hcd_ra_usb MC/DC: tr || ep null-guard (line 110)");
  ...
  TEST_END("ux_hcd_ra_usb MC/DC: tr || ep null-guard (line 110)");
}
...
{
  TEST_BEGIN("ux_hcd_ra_usb MC/DC: req_len && data ptr guard (line 130)");
  uint8_t     payload[8] = {};
  ...
  TEST_END("ux_hcd_ra_usb MC/DC: req_len && data ptr guard (line 130)");
}
...
{
  TEST_BEGIN("ux_hcd_ra_usb MC/DC: system_host || hcd_array (line 260)");
  ...
  TEST_END("ux_hcd_ra_usb MC/DC: system_host || hcd_array (line 260)");
}
