/**
 * @file test_board_sim_mstp_gate.c
 * @brief Unit tests for the board_sim module-stop gate table (#405)
 *
 * @details
 ...
 * peripheral the firmware never ungated is inert in the simulator exactly as it
 * is on silicon:
 *
 ...
 *    covers at once.
 *  - An address with no module-stop control (GPIO, ICU) or one board_sim does
...
/**
 * @brief Run every board_sim MSTP-gate test.
 *
