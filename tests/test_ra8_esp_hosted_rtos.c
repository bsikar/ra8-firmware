 ...
 * ::priv_ra8_esp_hosted_rtos_us_spin_iters clamps one, the select above the loop
 ...
 * what ::internal_test_us_spin_iters_guards_and_clamps covers, with an above-the-bound
 * duration.
 * @pre The port is initialised.
