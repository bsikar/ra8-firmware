 ...
 * libs/ra8_reflow/src/ra8_reflow_layout.c@internal_finish_line -- the
...
RA8_INTERNAL static void internal_test_justify_gate_mcdc(void)
{
  ...
  TEST_ASSERT_EQ(1, internal_mirror_justify_applies((uint8_t)k_ra8_reflow_align_justify, 1U));
  TEST_ASSERT_EQ(0, internal_mirror_justify_applies((uint8_t)k_ra8_reflow_align_justify, 0U));
  TEST_ASSERT_EQ(0, internal_mirror_justify_applies((uint8_t)k_ra8_reflow_align_center, 1U));
...
RA8_INTERNAL static void internal_test_align_offset_mcdc(void)
{
  ...
  TEST_ASSERT_EQ(50, internal_mirror_align_offset((uint8_t)k_ra8_reflow_align_center, 100));
  TEST_ASSERT_EQ(100, internal_mirror_align_offset((uint8_t)k_ra8_reflow_align_right, 100));
