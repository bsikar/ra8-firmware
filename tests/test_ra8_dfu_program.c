...
/**
 * @enum dfu_program_fixture_t
 * @brief Poison values written into out-parameters before a call, so one that fails without assigning is detectable, plus the payload generators and their seeds, and buffer capacities and payload sizes.
 */
