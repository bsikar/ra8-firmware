 ...
 *
 * - ::ra8_io_vfs_write_compressed / ::ra8_io_vfs_read_compressed over a FAT16
 ...
 *   (`ra8_io_vfs_compress_store_blob` / `ra8_io_vfs_compress_load_blob`) on both
...
static void test_vfs_compress_round_trip(void)
{
  ...
  TEST_ASSERT_EQ(k_ra8_ok,
                 ra8_io_vfs_write_compressed("ram:/STORY.RBK",
                                             s_payload,
                                             k_t_payload,
                                             s_scratch,
  ...
  uint32_t out_len = 0;
  TEST_ASSERT_EQ(k_ra8_ok,
                 ra8_io_vfs_read_compressed("ram:/STORY.RBK",
                                            s_blob,
                                            (uint32_t)sizeof(s_blob),
                                            s_restored,
...
static void test_vfs_compress_write_errors(void)
{
  ...
  TEST_ASSERT_EQ(k_ra8_err_invalid_arg,
                 ra8_io_vfs_write_compressed("noprefix",
                                             s_payload,
                                             k_t_payload,
                                             s_scratch,
                                             (uint32_t)sizeof(s_scratch),
  ...
  TEST_ASSERT_EQ(k_ra8_err_not_found,
                 ra8_io_vfs_write_compressed("nope:/X.RBK",
                                             s_payload,
                                             k_t_payload,
                                             s_scratch,
                                             (uint32_t)sizeof(s_scratch),
...
static void test_vfs_compress_read_validation(void)
{
  ...
  TEST_ASSERT_EQ(k_ra8_err_null_ptr,
                 ra8_io_vfs_read_compressed(nullptr,
                                            s_blob,
                                            (uint32_t)sizeof(s_blob),
                                            s_restored,
                                            (uint32_t)sizeof(s_restored),
                                            &out_len));
  TEST_ASSERT_EQ(k_ra8_err_null_ptr,
                 ra8_io_vfs_read_compressed("ram:/X.RBK",
                                            nullptr,
                                            (uint32_t)sizeof(s_blob),
                                            s_restored,
                                            (uint32_t)sizeof(s_restored),
...
static void test_vfs_compress_read_errors(void)
{
  ...
  TEST_ASSERT_EQ(k_ra8_err_not_found,
                 ra8_io_vfs_read_compressed("ram:/MISSING.RBK",
                                            s_blob,
                                            (uint32_t)sizeof(s_blob),
                                            s_restored,
                                            (uint32_t)sizeof(s_restored),
