 ...
 * `tests/graphics/src/test_ra8_jpeg_sw.c`: a small RGB gradient is encoded once
 ...
 */
// NOLINTNEXTLINE(readability-function-size) -- benchmark body remains lexical to avoid measurement distortion.
int main(void)
{
