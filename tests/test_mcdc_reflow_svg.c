...
/**
 * @test test_svgp_xform_list_mcdc
 *
 * @par MC/DC:
...
/**
 * @test test_svgp_draw_line_points_mcdc
 *
 * @par MC/DC:
 ...
 */
static void test_svg_render_shape_paths_mcdc(void)
{
 ...
 */
static void test_svgp_match_grad_mcdc(void)
{
...
/**
 * @test test_svg_render_polygon_arc_mcdc
 *
 * @par MC/DC:
...
int32_t main(void)
{
  test_svgp_numf_scanner_mcdc();
  test_svgp_xform_list_mcdc();
  test_svgp_draw_line_points_mcdc();
  test_svgp_attr_at_start_mcdc();
  test_svg_render_shape_paths_mcdc();
  test_svgp_match_grad_mcdc();
  test_svg_render_polygon_arc_mcdc();
  (void)fprintf(stderr, "[OK ] test_mcdc_reflow_svg.c\n");
  return 0;
}
