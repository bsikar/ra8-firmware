/**
 * @file test_ra_i3c_i2c_edge_cases.c
 * @brief Edge-case + stress unit tests for the IIC_B (I3C in I2C-mode) controller.
 *
 * @details
 * Complements ``test_ra_i3c_i2c.c`` with focused stress / edge-case
...
static const ra_i3c_i2c_cfg_t k_iic_b_edge_cfg = {
...
static void test_bus_busy_during_start_repeated(void)
{
  ...
  TEST_ASSERT_EQ(0U, (i3c_i2c_regs(0U)->CNDCTL & (uint32_t)k_ra_i3c_i2c_msk_cndctl_stcnd));
...
static void test_set_clock_extremes(void)
{
  ...
  TEST_ASSERT_EQ(k_ra_err_invalid_arg, internal_i3c_i2c_set_clock(99U, 100000U, 60000000U));
  /* Standard + Fast modes both succeed. */
  TEST_ASSERT_EQ(k_ra_ok,
                 internal_i3c_i2c_set_clock(0U, (uint32_t)k_ra_i3c_i2c_speed_standard, 60000000U));
  TEST_ASSERT_EQ(k_ra_ok,
                 internal_i3c_i2c_set_clock(0U, (uint32_t)k_ra_i3c_i2c_speed_fast, 60000000U));
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK  ] test_ra_i3c_i2c_edge_cases.c\n");
  return 0;
}
