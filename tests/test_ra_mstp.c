...
static void test_init_zeroes_refcounts_and_sets_all_stopped(void)
{
  ...
  TEST_ASSERT_EQ((long long)0xFFFFFFFFU, (long long)ra_mstp()->MSTPCRA);
  TEST_ASSERT_EQ((long long)0xFFFFFFFFU, (long long)ra_mstp()->MSTPCRB);
  TEST_ASSERT_EQ((long long)0xFFFFFFFFU, (long long)ra_mstp()->MSTPCRC);
  TEST_ASSERT_EQ((long long)0xFFFFFFFFU, (long long)ra_mstp()->MSTPCRD);
  TEST_ASSERT_EQ((long long)0xFFFFFFFFU, (long long)ra_mstp()->MSTPCRE);

  /* Spot-check a few refcounts. */
  uint8_t ref = 0xFFU;
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_get_refcount(k_ra_mstp_sci0, &ref));
  TEST_ASSERT_EQ((long long)0, (long long)ref);
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_get_refcount(k_ra_mstp_dmac0_dtc0, &ref));
  TEST_ASSERT_EQ((long long)0, (long long)ref);
...
static void test_enable_clears_bit_first_request(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_sci0));
  TEST_ASSERT(!peek_bit(k_ra_mstp_sci0)); /* running */

  uint8_t ref = 0U;
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_get_refcount(k_ra_mstp_sci0, &ref));
  TEST_ASSERT_EQ((long long)1, (long long)ref);
...
static void test_enable_idempotent_increments_refcount(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_init());
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_dmac0_dtc0));
  ...
  uint8_t ref = 0U;
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_get_refcount(k_ra_mstp_dmac0_dtc0, &ref));
  TEST_ASSERT_EQ((long long)2, (long long)ref);
...
static void test_disable_keeps_bit_clear_until_last_release(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_disable(k_ra_mstp_dmac0_dtc0));
  TEST_ASSERT(!peek_bit(k_ra_mstp_dmac0_dtc0));
...
static void test_disable_underflow_returns_invalid_state(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_init());
  TEST_ASSERT_EQ((int)k_ra_err_invalid_state, (int)ra_mstp_disable(k_ra_mstp_sci0));
...
static void test_invalid_id_rejected(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_err_invalid_arg, (int)ra_mstp_enable(bogus));
  TEST_ASSERT_EQ((int)k_ra_err_invalid_arg, (int)ra_mstp_disable(bogus));

  uint8_t ref = 0U;
  TEST_ASSERT_EQ((int)k_ra_err_invalid_arg, (int)ra_mstp_get_refcount(bogus, &ref));

  /* reg=0, bit=33 -> out of range. */
  const ra_mstp_t bogus2 = (ra_mstp_t)((0U << 8) | 33U);
  TEST_ASSERT_EQ((int)k_ra_err_invalid_arg, (int)ra_mstp_enable(bogus2));
...
static void test_get_refcount_null_out(void)
{
  ...
  ra_sim_mmap_reset();
  TEST_ASSERT_EQ((int)k_ra_err_null_ptr, (int)ra_mstp_get_refcount(k_ra_mstp_sci0, nullptr));
...
static void test_is_stopped_reads_bit(void)
{
  ...
  bool stopped = false;
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_is_stopped(k_ra_mstp_iic0, &stopped));
  TEST_ASSERT(stopped);

  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_iic0));
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_is_stopped(k_ra_mstp_iic0, &stopped));
  TEST_ASSERT(!stopped);

  TEST_ASSERT_EQ((int)k_ra_err_null_ptr, (int)ra_mstp_is_stopped(k_ra_mstp_iic0, nullptr));
...
static void test_neighbor_bits_undisturbed(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_sci3));
  ...
  TEST_ASSERT_EQ((long long)expected, (long long)after);
...
static void test_all_five_registers_addressable(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_sram0));  /* A */
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_sci0));   /* B */
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_crc));    /* C */
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_adc16h)); /* D */
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_enable(k_ra_mstp_gpt0));   /* E */
...
static void test_refcount_saturation(void)
{
  ...
  uint8_t ref = 0U;
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_get_refcount(k_ra_mstp_dmac0_dtc0, &ref));
  TEST_ASSERT_EQ((long long)255, (long long)ref);

  /* The 256th request must be rejected without changing state. */
  TEST_ASSERT_EQ((int)k_ra_err_invalid_state, (int)ra_mstp_enable(k_ra_mstp_dmac0_dtc0));
  TEST_ASSERT_EQ((int)k_ra_ok, (int)ra_mstp_get_refcount(k_ra_mstp_dmac0_dtc0, &ref));
  TEST_ASSERT_EQ((long long)255, (long long)ref);
...
static void test_is_stopped_invalid_id(void)
{
  ...
  TEST_ASSERT_EQ((int)k_ra_err_invalid_arg, (int)ra_mstp_is_stopped(bogus, &stopped));
