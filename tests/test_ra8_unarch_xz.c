 ...
 * scripts/utils/gen_unarch_xz_fixture.py) and hostile variants derived from
 * them in-place:
 *
...
static void test_xz_pool_edges(void)
{
  ...
  void* b = ra8_unarch_xz_pool_alloc(56U); /* exactly exhausts the arena */
...
static void test_xz_unwrap_rejects_hostile_streams(void)
{
  ...
  s_mut[sizeof(k_fx_xz_crc64_4k) / 2U] ^= 0xFFU;
