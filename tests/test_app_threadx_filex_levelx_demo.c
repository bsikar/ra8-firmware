...
/**
 * @enum threadx_filex_levelx_demo_uint8_const_t
...
typedef enum : uint8_t {
  k_threadx_filex_levelx_demo_val_ff = 0xFFU,
} threadx_filex_levelx_demo_uint8_const_t;
...
static void reset_world(void)
{
  ...
  *ra8_sys_oscsf() = (uint8_t)k_threadx_filex_levelx_demo_val_ff;
}
