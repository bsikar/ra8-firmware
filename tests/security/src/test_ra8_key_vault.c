...
static void test_store_then_challenge(void)
{
  ...
  uint8_t digest_a[k_ra8_key_vault_digest_bytes] = {};
  uint8_t digest_b[k_ra8_key_vault_digest_bytes] = {};
...
static void test_nsc_veneer_forwards(void)
{
  ...
  uint8_t digest_direct[k_ra8_key_vault_digest_bytes] = {};
  uint8_t digest_veneer[k_ra8_key_vault_digest_bytes] = {};
...
static void test_mac_key_provisioning(void)
{
  ...
  uint8_t  out[k_ra8_key_vault_mac_key_bytes] = {};
  uint16_t out_len                            = 0U;
