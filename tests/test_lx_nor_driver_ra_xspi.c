/**
 * @file test_lx_nor_driver_ra_xspi.c
 * @brief MC/DC vector tests for port/levelx/lx_nor_driver_ra_xspi.c
 *
 * @details
 * The LevelX NOR-flash driver glue ``port/levelx/lx_nor_driver_ra_xspi.c``
 ...
 * ``port/levelx/lx_nor_driver_ra_xspi.c`` as a ``static inline``
...
{
  TEST_BEGIN("lx_nor_driver_ra_xspi MC/DC: nor_read 3-cond guard (line 187)");
  ...
  TEST_END("lx_nor_driver_ra_xspi MC/DC: nor_read 3-cond guard (line 187)");
}
...
{
  TEST_BEGIN("lx_nor_driver_ra_xspi MC/DC: nor_write 3-cond guard (line 232)");
  uint32_t    flash_marker = 0U;
  ...
  TEST_END("lx_nor_driver_ra_xspi MC/DC: nor_write 3-cond guard (line 232)");
}
