/**
 * @file test_ra_wdt_supervisor_extended.c
 * @brief Extended unit tests for libs/ra_wdt_supervisor/src/ra_wdt_supervisor.c
 *
 ...
 *
 * @par MC/DC:
 * Decision: ``stack_size_bytes < k_ra_wdt_sup_min_stack``
...
static void test_sup_init_stack_too_small(void)
{
  ...
  const ra_wdt_sup_cfg_t cfg = {
    .stack             = s_stack,
    .stack_size_bytes  = 511U, /* k_ra_wdt_sup_min_stack = 512 */
    .priority          = 4U,
    .refresh_period_ms = 50U,
  };
 ...
 *
 * @par MC/DC:
 * Decision: ``priority > k_ra_wdt_sup_max_priority``
 ...
 *
 * @pre init done.
 * @post Returns k_ra_err_invalid_arg for handle >= max_threads.
 *
 * @par MC/DC:
 * Decision: ``handle >= k_ra_wdt_sup_max_threads``
 ...
 * - V2: state=free -> false -> k_ra_err_not_found.
 *
 * @since 0.1.0
 */
 ...
 * @post Second start returns k_ra_err_busy.
 *
 * @par MC/DC:
 * Decision: ``s_state.started``
 * - V1: not started -> false -> proceed.
 * - V2: started     -> true  -> k_ra_err_busy.
 *
 * @since 0.1.0
 */
 ...
 * @post Returns k_ra_ok even with null out pointer.
 *
 * @par MC/DC:
 ...
 *
 * @pre init done.
 * @post Returns k_ra_ok; does not crash.
 *
 * @par MC/DC:
...
int32_t main(void)
{
  ...
  (void)fprintf(stderr, "[OK  ] test_ra_wdt_supervisor_extended.c\n");
  return 0;
}
