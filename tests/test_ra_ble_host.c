...
/* Internal L2CAP TX entry point declared in ra_ble_host_internal.h; we
 * re-declare it here so the MC/DC tests do not have to drag in that
 * private header. The signature MUST mirror ra_ble_l2cap.c verbatim. */
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 291)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 349)
 * Routes via ra_ble_host_test_inject_acl which calls ra_ble_host_acl_in.
 ...
 * (4 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 522)
 *
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 591)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 595)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 601)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 604)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 598)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_l2cap.c line 545)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_att.c line 567)
 ...
 * @par DO-178C 6.4.4.3 rationale: Full minimal MC/DC achieved.
 *
 * @par Internal note (ra_ble_l2cap.c lines 464/468/485 evt_trampoline):
 ...
 * NimBLE controller event path (port/nimble/ble_hci_ra_ble.c) where
 * internal_evt_trampoline is registered as the live HCI event sink.
 *
 * @par Internal note (ra_ble_att.c lines 286/305/385/530):
 ...
 * exercised end-to-end through ra_ble_host_test_inject_acl in the
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 208)
 ...
 * @par MC/DC:
 * Decision: `(uuid_128 == NULL) || (out_handle == NULL)`
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 246)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 249)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 265)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 337)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 345)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 351)
 ...
 * @par MC/DC:
 * Decision: `(a == NULL) || (a->kind != char_value)`
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 375)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 381)
 ...
 * created via ra_ble_host_gatt_register_char is preceded by a char_decl
 * row at handle=value-1 (see ra_ble_gatt.c lines 286-298). The harness
 ...
 * (3 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 393)
 ...
 * (2 conditions, libs/ra_ble_host/src/ra_ble_gatt.c line 412)
