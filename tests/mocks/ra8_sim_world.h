 ...
 * has no such partition. ``ra8_sim_world`` lets a test pretend
 ...
 *
 * Tests use ``ra8_sim_world_mark_ns(ptr, len)`` to declare a
 * region as "Non-Secure" and ``ra8_sim_world_mark_s(ptr, len)``
 * to declare a region as "Secure". A subsequent
 * ``ra8_sim_world_check_ns_range(ptr, len)`` returns whether the
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra8_err_t ra8_sim_world_mark_ns(const void* ptr, uint32_t len);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra8_err_t ra8_sim_world_mark_s(const void* ptr, uint32_t len);
 ...
 * @since 0.1.0
 */
[[nodiscard]] bool ra8_sim_world_check_ns_range(const void* ptr, uint32_t len);
