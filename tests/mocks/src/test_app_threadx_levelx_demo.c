 ...
 * examples/ek_ra8d2/hw_validated/hil/threadx_levelx_demo/src/main.c stands up CGC + SysTick +
...
/**
 * @enum app_threadx_levelx_demo_fixture_t
...
} app_threadx_levelx_demo_fixture_t;
