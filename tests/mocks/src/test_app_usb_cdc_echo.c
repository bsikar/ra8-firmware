 ...
 * production app at examples/ek_ra8d2/hw_validated/manual/usb_cdc_echo/src/main.c brings up
...
/** @brief Pin map mirrors examples/ek_ra8d2/hw_validated/manual/usb_cdc_echo/src/main.c. */
