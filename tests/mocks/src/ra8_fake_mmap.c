...
// NOLINTNEXTLINE(bugprone-reserved-identifier,cert-dcl37-c,cert-dcl51-cpp) -- toolchain ABI fixes this reserved symbol spelling.
 ...
 * all regions unconditionally, so `just quality::local::test` is unaffected.
 *
