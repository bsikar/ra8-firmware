 ...
 * @brief Integration test for examples/ek_ra8d2/hw_pending/i3c_i2c_peripheral_demo/src/main.c
 *
 * @details
 * Replays the IIC_B peripheral open + status / receive / send sequence
 * from the demo. All MMIO is via the host tests/mocks/src/ra8_fake_mmap.c
 * shim.
 *
