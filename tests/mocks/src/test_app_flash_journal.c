 ...
 * @brief Integration test for examples/ek_ra8d2/hw_validated/hil/flash_journal/src/main.c
 *
 * @details
 * Replays the pack/unpack helpers and the round-trip wrapper around
 * ``ra8_xspi_flash_*``. The register-level NOR model in
 * ``tests/mocks/src/ra8_fake_xspi_flash.c`` services the driver's real
