 ...
 *
 * @details
 * Mirrors examples/ek_ra8d2/hw_validated/hil/i2c_i3c_combined/src/main.c, which brings up RIIC
 ...
 * reject paths through the host tests/mocks/src/ra8_fake_mmap.c shim.
 *
