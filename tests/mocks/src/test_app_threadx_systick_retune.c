 ...
 * examples/ek_ra8d2/hw_validated/hil/threadx_systick_retune/src/main.c raises
...
/**
 * @enum app_threadx_systick_retune_fixture_t
...
} app_threadx_systick_retune_fixture_t;
