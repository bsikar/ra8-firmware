 ...
 * production app at examples/ek_ra8d2/hil_needs_revalidation/tz_nsc_cgc_usb/src/main.c reaches
...
/** @brief Pin map mirrors examples/ek_ra8d2/hil_needs_revalidation/tz_nsc_cgc_usb/src/main.c. */
