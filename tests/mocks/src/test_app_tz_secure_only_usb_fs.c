 ...
 * examples/ek_ra8d2/hw_validated/manual/tz_secure_only_usb_fs/src/main.c is a copy of usb_cdc_echo
...
/** @brief Pin map mirrors examples/ek_ra8d2/hw_validated/manual/tz_secure_only_usb_fs/src/main.c. */
