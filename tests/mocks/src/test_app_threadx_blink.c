 ...
 * examples/ek_ra8d2/hw_validated/hil/threadx_blink/src/main.c wires two ThreadX threads to two LED
 ...
 *
 * @details Replays the call order of examples/ek_ra8d2/hw_validated/hil/threadx_blink/src/main.c:
