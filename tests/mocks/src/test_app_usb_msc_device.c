 ...
 * production app at examples/ek_ra8d2/hw_validated/manual/usb_msc_device/src/main.c brings up
...
/** @brief Pin map mirrors examples/ek_ra8d2/hw_validated/manual/usb_msc_device/src/main.c. */
