 ...
 * binder source, then proves ::ra8_epub_tile_binder_prefetch_pan warms the tile
 ...
 * @details Layout mirrors the writer in test_ra8_jof.c: magic, geometry,
...
RA8_INTERNAL static void internal_tp_init_binder(ra8_epub_tile_binder_t* binder)
{
  ...
  TEST_ASSERT_EQ(k_ra8_ok,
                 ra8_epub_tile_binder_add_ext(binder,
                                              ra8_jof_memstore_pread,
                                              &s_store,
                                              s_store.len,
...
RA8_INTERNAL static void internal_test_binder_prefetch_pan(void)
{
  ...
  uint16_t              warmed = 0U;
  TEST_ASSERT_EQ(k_ra8_ok,
                 ra8_epub_tile_binder_prefetch_pan(&binder,
                                                   (uint32_t)k_tp_image_id,
                                                   &view,
  ...
  TEST_ASSERT_EQ(
    k_ra8_err_not_found,
    ra8_epub_tile_binder_prefetch_pan(&binder, 999U, &view, k_ra8_tile_pan_right, 4U, &warmed));
  TEST_ASSERT_EQ(k_ra8_err_null_ptr,
                 ra8_epub_tile_binder_prefetch_pan(nullptr,
                                                   (uint32_t)k_tp_image_id,
                                                   &view,
                                                   k_ra8_tile_pan_right,
                                                   4U,
