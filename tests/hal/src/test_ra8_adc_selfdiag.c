 ...
 * libs/ra8_hal/src/adc_selfdiag.c@internal_selfdiag_in_band,
 * libs/ra8_hal/src/adc_selfdiag.c@ra8_adc_self_diagnose,
 * libs/ra8_hal/src/adc_selfdiag.c@internal_is_supported_ext_chan.
 *
