 ...
 * @note ``DEMO_DISABLE_CERT_PIN`` is an explicit bring-up-only override.
 * @since 0.1.0
 */
 ...
 * completes the handshake, enforces the certificate pin, and issues the GET.
 * @return ``0`` on success.
 * @retval 0 TLS, pin verification, and HTTP processing succeeded.
 ...
 * @post No HTTP request is sent if handshake or pin verification fails.
