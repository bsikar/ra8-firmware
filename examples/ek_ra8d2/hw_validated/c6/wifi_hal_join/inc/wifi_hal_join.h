/**
 * @file examples/ek_ra8d2/hw_validated/c6/wifi_hal_join/inc/wifi_hal_join.h
 ...
 * runtime credentials are non-empty, connects, settles the association, reads the MAC
 ...
 * @details Measures the string within the application maximum and forwards
 ...
 * @details Extracts each requested nibble from most to least significant
 ...
 * @details Emits application identity, measured clock values, and immutable
