/**
 * @file examples/ek_ra8d2/hw_validated/c6/c6_fw_version/src/main.c
 ...
 *       module-stop.
 * @post On any failing step ::c6_fwver_panic_halt parks the CPU, so this call never
 ...
 *       path both end in ::c6_fwver_heartbeat, which loops forever.
