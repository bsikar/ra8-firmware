/**
 * @file examples/ek_ra8d2/hw_validated/hil/ereader_ui/src/main.c
...
/**
 * @brief Reading-view chapter as XHTML, reflowed by reflow when an SD
...
/** @brief reflow engine for the Reading body (page / glyph / token pools). */
...
/** @brief True once an SD font is loaded; gates the reflow body render. */
bool s_have_font;
...
/* ===========================================================================
 * Optional SD-loaded font for the reflow Reading body
 * =========================================================================== */
 ...
 * the composited chrome is byte-identical (``just apps::emulator::golden`` stays green)
