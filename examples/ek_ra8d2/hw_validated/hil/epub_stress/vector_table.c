/**
 * @file examples/ek_ra8d2/hw_validated/hil/epub_stress/vector_table.c
 ...
 * in epub_stress/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in epub_stress/system_init.c */
