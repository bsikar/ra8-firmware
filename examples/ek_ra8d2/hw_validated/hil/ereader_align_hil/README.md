...
```
make ereader_align_hil
scripts/hil_run_local.sh ereader_align_hil      # flash + scrape the banner
```
...
`scripts/board_sim_smoke.sh ereader_align_hil` PASS; the identical host layout
