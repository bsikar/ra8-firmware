/**
 * @file examples/ek_ra8d2/hw_validated/hil/cpu1_pingpong/src/main.c
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static bool internal_wait_for_pong(const volatile cpu1_pingpong_shared_t* shared,
                                                uint32_t                               target)
{
