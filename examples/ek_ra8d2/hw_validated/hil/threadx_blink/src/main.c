/**
 * @file examples/ek_ra8d2/hw_validated/hil/threadx_blink/src/main.c
 ...
 *     paths `examples/ek_ra8d2/hw_validated/hil/blink_hal/src/main.c` uses, but driven by RTOS
...
{
  static CHAR s_thread_a_name[] = "blink_a";
  static CHAR s_thread_b_name[] = "blink_b";
