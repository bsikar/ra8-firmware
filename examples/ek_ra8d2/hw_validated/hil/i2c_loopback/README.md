...
RIIC (`ra_i2c`) controller self-test for the EK-RA8D2. Brings up RIIC
...
(`ra_board_io_expander_apply_project_sw4_defaults`): bus-recover,
P109/P311 pull-ups, P512/P511 route + NCODR, `ra_i2c_init(ch1)`, then
loops `ra_i2c_scan(1, 0x43)`.
