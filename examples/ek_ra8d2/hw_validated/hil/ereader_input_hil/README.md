...
(`ereader_chrome_hil`); this app closes the *input-routing* gap with **synthetic**
...
```
make ereader_input_hil
scripts/hil_run_local.sh ereader_input_hil      # flash + scrape the banner
```
...
`scripts/board_sim_smoke.sh ereader_input_hil` PASS.
