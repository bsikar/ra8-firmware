/**
 * @file examples/ek_ra8d2/hw_validated/hil/fault_crashlog_hil/vector_table.c
 ...
 * in the shared libs/ra8_board_ek_ra8d2/ld/linker_script.ld defines
...
void SystemInit(void); /* shared libs/ra8_board_ek_ra8d2/boot/system_init.c */
