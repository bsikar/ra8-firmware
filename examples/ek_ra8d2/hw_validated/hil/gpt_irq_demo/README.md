...
ICU IELSR table to an NVIC line with `ra_isr_register`, starts GPT0 in saw-wave
...
This is also the timer-interrupt proof target for `tools/board_sim`: the emulator
