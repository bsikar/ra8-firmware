/**
 * @file examples/ek_ra8d2/hw_validated/hil/spi_loopback/vector_table.c
 ...
 * in spi_loopback/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in spi_loopback/system_init.c */
