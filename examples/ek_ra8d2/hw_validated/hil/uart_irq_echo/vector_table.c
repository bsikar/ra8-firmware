/**
 * @file examples/ek_ra8d2/hw_validated/hil/uart_irq_echo/vector_table.c
 ...
 * in uart_irq_echo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in the board BSP boot layer */
