/**
 * @file examples/ek_ra8d2/hw_validated/hil/epub_parse/vector_table.c
 ...
 * in epub_parse/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in epub_parse/system_init.c */
