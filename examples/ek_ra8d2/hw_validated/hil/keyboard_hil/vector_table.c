/**
 * @file examples/ek_ra8d2/hw_validated/hil/keyboard_hil/vector_table.c
 ...
 * in keyboard_hil/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in keyboard_hil/system_init.c */
