/**
 * @file examples/ek_ra8d2/i3c_loopback/vector_table.c
 ...
 * in i3c_loopback/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in i3c_loopback/system_init.c */
