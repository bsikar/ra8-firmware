...
```
make reflow_content_hil
scripts/hil_run_local.sh reflow_content_hil      # flash + scrape the banner
```
...
`scripts/board_sim_smoke.sh reflow_content_hil` PASS; the identical host run
