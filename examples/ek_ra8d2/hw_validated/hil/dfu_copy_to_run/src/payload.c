/**
 * @file examples/ek_ra8d2/hw_validated/hil/dfu_copy_to_run/src/payload.c
 ...
 *
 * Build with `examples/ek_ra8d2/hw_validated/hil/dfu_copy_to_run/scripts/
 * build_payload.sh` (also emits `payload_image.h` for the demo).
 *
