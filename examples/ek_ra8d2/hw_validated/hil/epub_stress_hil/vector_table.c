/**
 * @file examples/ek_ra8d2/hw_validated/hil/epub_stress_hil/vector_table.c
 ...
 * in epub_stress_hil/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in epub_stress_hil/system_init.c */
