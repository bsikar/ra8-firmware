...
tens of KB, so it bakes into MRAM and opens in memory like `epub_parse_hil` --
...
```
cd examples/ek_ra8d2/hw_validated/hil/epub_stress_hil
...
```
make epub_stress_hil
make -C examples/ek_ra8d2/hw_validated/hil/epub_stress_hil flash
```
