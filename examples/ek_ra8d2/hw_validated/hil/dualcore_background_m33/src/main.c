/**
 * @file examples/ek_ra8d2/hw_validated/hil/dualcore_background_m33/src/main.c
 ...
 *       or finer (a Debug build). `just apps::emulator::run dualcore_background_m33` builds
 ...
 * @since 0.1.0
 */
static bool wait_for_m33_sig(const volatile dualcore_bg_t* bg)
{
 ...
 * @since 0.1.0
 */
static bool wait_for_done(const volatile dualcore_bg_t* bg)
{
