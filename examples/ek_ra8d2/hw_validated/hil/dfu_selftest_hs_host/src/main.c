/**
 * @file examples/ek_ra8d2/hw_validated/hil/dfu_selftest_hs_host/src/main.c
...
[[nodiscard]] static ra8_err_t dfu_host_pass(void)
{
  ...
  err       = ra8_dfu_host_run(k_ra8_usb_speed_hs, s_dfu_image, (uint32_t)k_dfu_image_bytes, &res);
  s_dbg_pid = res.pid;
...
{
  static CHAR s_device_thread_name[] = "dfu_device";
  static CHAR s_host_thread_name[]   = "dfu_host";
