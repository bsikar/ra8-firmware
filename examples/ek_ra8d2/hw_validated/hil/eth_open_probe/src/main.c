 ...
 * two vectors each (taken / not taken) fully cover them. Both dependency
 * outcomes are exercised on host in
 * `tests/misc/src/test_ra8_board_ek_ra8d2_ethernet_cov.c` and
 * `tests/misc/src/test_ra8_eth.c` through the HAL fault-injection seams.
 *
 * @since 0.1.0
 */
