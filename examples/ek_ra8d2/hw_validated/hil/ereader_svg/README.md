...
(`<rect>`, `<circle>`, `<polygon>`) through the `reflow` SVG renderer (#112,
...
`apps/shared_libs/reflow/tests/src/test_svg.c`; this app is what runs it on the target and pins the
rendered output.
