/**
 * @file examples/ek_ra8d2/i2c_i3c_combined/vector_table.c
 ...
 * in i2c_i3c_combined/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in i2c_i3c_combined/system_init.c */
