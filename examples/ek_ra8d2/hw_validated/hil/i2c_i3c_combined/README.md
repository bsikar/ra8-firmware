...
- `ra8_i2c` (RIIC) ch1 -> on-board U15 expander at `0x43` -- a real
  controller<->device round-trip (U15 ACKs).
- `ra8_i3c` (I3C) ch0 in I2C-compatibility mode -> J27 header -- a
...
- `i2c_loopback` -- RIIC (`ra8_i2c`) alone against U15.
- `i3c_loopback` -- I3C (`ra8_i3c`, i2c-mode) controller alone.
