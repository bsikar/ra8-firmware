/**
 * @file examples/ek_ra8d2/hw_validated/hil/cache_coherency_hil/src/main.c
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static bool internal_wait_for_pong(const volatile cache_coherency_shared_t* shared,
                                                uint32_t                                 target)
{
  if (shared == nullptr) {
    return false;
