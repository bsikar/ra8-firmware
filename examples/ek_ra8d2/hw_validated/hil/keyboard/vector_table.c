/**
 * @file examples/ek_ra8d2/hw_validated/hil/keyboard/vector_table.c
 ...
 * in keyboard/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in keyboard/system_init.c */
