...
# ereader_cover_hil gate opens this blob in memory with ra_epub_open(), pulls
# the cover bytes with ra_epub_get_cover_image(), decodes + scales + blits them
# with ra_img_decode_blit(), and CRC-gates the framebuffer.
#
...
# (unlike the 4-byte stand-in in tests/test_ra_epub.c, which only exercises the
...
# --- Minimal EPUB3 parts (shape mirrors tests/test_ra_epub.c) ----------------
CONTAINER_XML = (
    '<?xml version="1.0"?>\n'
