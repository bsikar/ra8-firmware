/**
 * @file examples/ek_ra8d2/hw_validated/hil/ereader_cover_hil/vector_table.c
 ...
 * in ereader_cover_hil/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in ereader_cover_hil/system_init.c */
