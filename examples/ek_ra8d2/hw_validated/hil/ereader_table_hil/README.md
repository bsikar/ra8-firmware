...
```
make ereader_table_hil
scripts/hil_run_local.sh ereader_table_hil      # flash + scrape the banner
```
...
`scripts/board_sim_smoke.sh ereader_table_hil` PASS; the identical host layout
