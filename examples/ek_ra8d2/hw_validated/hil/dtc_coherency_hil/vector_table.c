/**
 * @file examples/ek_ra8d2/hw_validated/hil/dtc_coherency_hil/vector_table.c
 ...
 * in dtc_coherency_hil/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in libs/ra_board_ek_ra8d2/boot/system_init.c */
