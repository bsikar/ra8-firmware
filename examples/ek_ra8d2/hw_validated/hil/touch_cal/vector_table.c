/**
 * @file examples/ek_ra8d2/hw_validated/hil/touch_cal/vector_table.c
 ...
 * in the board layer's linker script (libs/ra8_board_ek_ra8d2/ld/
 * linker_script.ld) defines them with this exact spelling.
 */
...
void SystemInit(void); /* board layer: libs/ra8_board_ek_ra8d2/boot/system_init.c */
