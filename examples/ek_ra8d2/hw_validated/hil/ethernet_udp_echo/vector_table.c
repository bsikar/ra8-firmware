/**
 * @file examples/ek_ra8d2/ethernet_udp_echo/vector_table.c
 ...
 * in ethernet_udp_echo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in ethernet_udp_echo/system_init.c */
