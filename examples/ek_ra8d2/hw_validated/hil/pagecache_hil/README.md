...
Like the sibling SD HIL apps (`sd_font_render`, `epub_open_hil`), this
...
BOARD_SIM_WALL_S=550 BOARD_SIM_MAX_CHUNKS=8000000 \
  ...
  examples/ek_ra8d2/hw_validated/hil/pagecache_hil/build/pagecache_hil.elf \
...
```sh
make pagecache_hil
make -C examples/pagecache_hil flash        # via on-board J-Link OB
```
