/**
 * @file examples/ek_ra8d2/hw_validated/hil/rtc_alarm/main.c
...
int32_t main(void)
{
  ...
  while (1) {
    ...
    if (ra8_board_uart_console_write(k_rtc_demo_log_msg,
                                     (size_t)(sizeof(k_rtc_demo_log_msg) - 1U)) != k_ra8_ok) {
      break;
    }
