/**
 * @file examples/ek_ra8d2/hw_validated/hil/touch_demo/vector_table.c
 ...
 * in touch_demo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in touch_demo/system_init.c */
