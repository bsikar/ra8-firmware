/**
 * @file examples/ek_ra8d2/elc_event_demo/vector_table.c
 ...
 * in elc_event_demo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in elc_event_demo/system_init.c */
