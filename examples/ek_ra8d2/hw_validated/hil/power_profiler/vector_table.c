/**
 * @file examples/ek_ra8d2/power_profiler/vector_table.c
 ...
 * in power_profiler/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in power_profiler/system_init.c */
