...
```
make ereader_link_hil
scripts/hil_run_local.sh ereader_link_hil      # flash + scrape the banner
```
...
`scripts/board_sim_smoke.sh ereader_link_hil` runs the firmware ELF on the
