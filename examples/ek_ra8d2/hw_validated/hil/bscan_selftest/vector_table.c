/**
 * @file examples/ek_ra8d2/hw_validated/hil/bscan_selftest/vector_table.c
 ...
 * in bscan_selftest/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in bscan_selftest/system_init.c */
