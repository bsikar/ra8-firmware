/**
 * @file examples/ek_ra8d2/hw_validated/hil/usb_host_keyboard/src/main.c
...
{
  static CHAR s_semaphore_name[]   = "hid_active";
  static CHAR s_host_thread_name[] = "hid_host";

  (void)first_unused_memory;
  s_tx_kernel_up = true;
  (void)tx_semaphore_create(&s_usb_host_keyboard_hid_active_sem, s_semaphore_name, 0U);
