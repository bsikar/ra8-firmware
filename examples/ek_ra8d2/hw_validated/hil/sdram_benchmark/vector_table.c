/**
 * @file examples/ek_ra8d2/sdram_benchmark/vector_table.c
 ...
 * in sdram_benchmark/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in sdram_benchmark/system_init.c */
