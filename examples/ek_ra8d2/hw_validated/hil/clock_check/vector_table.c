/**
 * @file examples/ek_ra8d2/hw_validated/hil/clock_check/vector_table.c
 ...
 * in clock_check/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in clock_check/system_init.c */
