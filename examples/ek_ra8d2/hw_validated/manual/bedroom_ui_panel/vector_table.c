/**
 * @file examples/ek_ra8d2/hw_validated/manual/bedroom_ui_panel/vector_table.c
 ...
 * in bedroom_ui_panel/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in lcd_demo/system_init.c */
