 ...
 */
/**
 * @file examples/ek_ra8d2/hw_validated/manual/threadx_usbx_cdc_demo/main.c
 ...
 * @since 0.1.0
 */
static const char* s_demo_tag = "USBXCDC";
...
int32_t main(void)
{
  ...
  ra8_log_init();
  ra8_log_info(s_demo_tag, "threadx_usbx_cdc_demo boot, CGC PLL2 enable OK");
