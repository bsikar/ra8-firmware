/**
 * @file examples/ek_ra8d2/hw_validated/manual/threadx_usbx_cdc_demo/vector_table.c
 ...
 * in threadx_usbx_cdc_demo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in threadx_usbx_cdc_demo/system_init.c */
