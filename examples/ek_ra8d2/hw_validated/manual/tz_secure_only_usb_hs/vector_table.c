/**
 * @file examples/ek_ra8d2/hw_validated/manual/tz_secure_only_usb_hs/vector_table.c
 ...
 * in tz_secure_only_usb_hs/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in tz_secure_only_usb_hs/system_init.c */
