/**
 * @file examples/ek_ra8d2/hw_validated/manual/tz_secure_only_usb_hs/src/main.c
...
void main(void)
{
  ...
  ra8_log_init();
  ra8_log_info("TZSECONLYHS", "tz_secure_only_usb_hs boot, CGC OK, USBHS pin routed");
