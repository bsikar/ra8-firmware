/**
 * @file examples/ek_ra8d2/hw_validated/hil/imu_lsm6dso_demo/vector_table.c
 ...
 * in imu_lsm6dso_demo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in imu_lsm6dso_demo/system_init.c */
