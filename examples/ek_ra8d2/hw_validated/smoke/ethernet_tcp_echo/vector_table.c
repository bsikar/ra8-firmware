/**
 * @file examples/ek_ra8d2/ethernet_tcp_echo/vector_table.c
 ...
 * in ethernet_tcp_echo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in ethernet_tcp_echo/system_init.c */
