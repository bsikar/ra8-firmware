/**
 * @file examples/ek_ra8d2/usb_host_keyboard/vector_table.c
 ...
 * in usb_host_keyboard/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in usb_host_keyboard/system_init.c */
