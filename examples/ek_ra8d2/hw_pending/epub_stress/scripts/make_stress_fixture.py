...
under the k_epub_max_chapters=64 cap), 60 extra manifest-only resources, an
...
Usage:
    python3 examples/ek_ra8d2/hw_pending/epub_stress/scripts/make_stress_fixture.py
"""
...
N_CHAPTERS = 60  # spine length; must stay < k_epub_max_chapters (64)
...
# Suppression rationale: preserve the reviewed twelve-byte rows in this binary fixture
# fmt: off
COVER_PNG = bytes(
    [
...
def bake_header(epub: bytes) -> str:
    ...
    return (
        ...
        " *\n"
        " * @generated by examples/ek_ra8d2/hw_pending/epub_stress/scripts/"
        "make_stress_fixture.py -- do not edit by hand.\n"
        " * The generator owns\n"
...
def main() -> int:
    """Regenerate the owning component's inc/epub_stress_fixture.h.
    ...
    """
    epub = build_epub()
    output = Path(__file__).resolve().parent.parent / "inc" / "epub_stress_fixture.h"
