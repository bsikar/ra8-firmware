/**
 * @file examples/ek_ra8d2/hw_pending/dualcore_mailbox/cpu1_main.c
 ...
 * runtime via `ra_cpu1_release` (HUM Ch 2.9.1 "CPU control registers").
 *
 ...
 *       primary core's ITM stream, so an M33 `ra_log` line would be invisible
