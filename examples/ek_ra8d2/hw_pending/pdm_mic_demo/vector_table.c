/**
 * @file examples/ek_ra8d2/hw_pending/pdm_mic_demo/vector_table.c
 ...
 * in pdm_mic_demo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in pdm_mic_demo/system_init.c */
