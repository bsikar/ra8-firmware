/**
 * @file examples/ek_ra8d2/hw_pending/lowpower_holdpage/inc/lowpower_holdpage.h
...
typedef enum : uintptr_t {
  k_lowpower_mailbox_addr = k_ra8_board_shared_ram_base, /**< Mailbox base = window base. */
