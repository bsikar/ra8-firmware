/**
 * @file examples/ek_ra8d2/usb_host_cdc_echo/vector_table.c
 ...
 * in usb_host_cdc_echo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in usb_host_cdc_echo/system_init.c */
