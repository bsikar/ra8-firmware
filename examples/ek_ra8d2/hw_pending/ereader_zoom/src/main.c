 ...
 * ::ra8_tile_cache, and drives it with the `zoom` viewport engine:
 *
 ...
 *      *only what changed* with the waveform ``zoom`` asks for -- A2 during
 ...
 * @warning Overwritten by every zoom render.
 * @since 0.1.0
 */
 ...
 *          this capacity by zoom_view_open().
