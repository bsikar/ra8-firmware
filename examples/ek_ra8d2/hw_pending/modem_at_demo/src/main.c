/**
 * @file examples/ek_ra8d2/hw_pending/modem_at_demo/src/main.c
 ...
 * ``tests/mocks/src/test_app_modem_at_demo.c``.
 *
...
typedef enum : uint32_t {
  ...
  /** SCI7. */
  k_modem_uart_channel = k_ra8_board_mikrobus_uart_sci_channel,
} modem_const_t;
...
/* =============================================================================
 * Pure decision logic (mirrored + MC/DC-tested in tests/mocks/src/test_app_modem_at_demo.c)
 * =============================================================================
 */
