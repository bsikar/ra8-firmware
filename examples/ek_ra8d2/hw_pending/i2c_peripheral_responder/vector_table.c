/**
 * @file examples/ek_ra8d2/hw_pending/i2c_peripheral_responder/vector_table.c
 ...
 * in i2c_loopback/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in i2c_loopback/system_init.c */
