...
## ra8_emulator gate (no hardware)

`scripts/emu/smoke.sh usb_msc_sdcard` builds a 64 MiB FAT32 card
image with `tools/mkbookimg`, attaches it with `--sd`, and lets
ra8_emulator's virtual USB host (#67) enumerate the device and drive the
