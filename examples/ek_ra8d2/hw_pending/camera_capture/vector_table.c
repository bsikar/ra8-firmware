/**
 * @file examples/ek_ra8d2/hw_pending/camera_capture/vector_table.c
 ...
 * in the shared board linker script defines them with this exact spelling.
 */
...
void SystemInit(void); /* in camera_capture/system_init.c */
