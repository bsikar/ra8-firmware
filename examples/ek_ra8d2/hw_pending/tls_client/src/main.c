/**
 * @file examples/ek_ra8d2/hw_pending/tls_client/src/main.c
 ...
 * ``tests/wireless/src/test_ra8_tls_net.c`` (which drives the same ``ra8_tls`` API over
...
/** @brief Persistent mutable names retained by NetX Duo and ThreadX objects. */
