/**
 * @file examples/ek_ra8d2/hw_pending/smbus_demo/vector_table.c
 ...
 * in smbus_demo/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in smbus_demo/system_init.c */
