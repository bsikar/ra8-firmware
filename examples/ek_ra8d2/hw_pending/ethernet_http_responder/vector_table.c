/**
 * @file examples/ek_ra8d2/ethernet_http_responder/vector_table.c
 ...
 * in ethernet_http_responder/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in ethernet_http_responder/system_init.c */
