/**
 * @file examples/usb_host_msc_browse/vector_table.c
 ...
 * in usb_host_msc_browse/linker_script.ld defines them with this exact spelling.
 */
...
void SystemInit(void); /* in usb_host_msc_browse/system_init.c */
