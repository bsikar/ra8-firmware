/**
 * @file examples/ek_ra8d2/hil_needs_revalidation/psa_crypto_hil/src/main.c
 ...
 *
 * This is the on-silicon counterpart of tests/misc/src/test_psa_real_kat.c and proves that
