/**
 * @file examples/ek_ra8d2/hil_needs_revalidation/lpm_wake_matrix_demo/src/main.c
 ...
 * ``tests/mocks/src/test_app_lpm_wake_matrix_demo.c`` but running on real silicon
 ...
 * tests/mocks/src/test_app_lpm_wake_matrix_demo.c.
 *
 ...
 * covered in tests/mocks/src/test_app_lpm_wake_matrix_demo.c.
 *
 * @return Error code from the first failing arm call.
