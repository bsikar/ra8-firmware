...
- Decisions at 100% MC/DC (`yes`): **370**
- Decisions partially covered (`partial`): **89**
- Decisions fully uncovered (`no`): **80**
- Coverage rate (yes / total): **68.6%**
