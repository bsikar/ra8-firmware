...
| libs/ra8_hal/src/ra8_jpeg_sw.c | 4 | ra8_jpeg_sw_idct8x8 | `if (mk >= k_jpeg_marker_sof_lo && mk <= k_jpeg_marker_sof...` | Annotated deactivation: dec_parse_sof0 unsupported-SOFn d... |
...
| libs/ra8_hal/src/ra8_jpeg_sw_decode.c | 2 | ra8_jpeg_sw_priv_parse_sos | `if (r < 0 && t != 0) {` | Annotated deactivation: dec_parse_sos ra8_jpeg_sw_br_get_... |
...
| ra8_ble_att | 5 | 5 | 0 | 0 |
| ra8_ble_l2cap_advertise | 5 | 5 | 0 | 0 |
