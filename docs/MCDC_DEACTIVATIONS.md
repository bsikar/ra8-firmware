...
- **Rationale**: Annotated deactivation: priv_ra8_epub_xml_attr attribute re-walk gate; internal_attributes fixed event-&gt;attribute_count by successfully parsing exactly that many attributes over these immutable bytes, so the bounded re-parse cannot fail and ra8_xml_attr_next() only clears `present` once `emitted` reaches that same count, which this loop never exceeds -- both conditions are constant-false.
- **DO-178C 6.4.4.3 basis**: defensive guard whose upstream contract is enforced on every public-API entry.

### libs/ra8_epub/src/ra8_epub_xml_shim.c::priv_ra8_epub_xml_ancestor_frame::return-err-k_ra8_ok-manifest_

- **Function**: `priv_ra8_epub_xml_ancestor_frame`
- **Conditions in decision**: 3
- **Current llvm-cov status**: no
...
### libs/ra8_epub/src/ra8_epub_xml_shim.c::priv_ra8_epub_xml_ancestor_frame::if-err-k_ra8_ok-event-kind
...
### libs/ra8_epub/src/ra8_epub_xml_shim.c::priv_ra8_epub_xml_ancestor_frame::if-err-k_ra8_ok-saw_manifest
...
### libs/ra8_epub/src/ra8_epub_xml_shim.c::priv_ra8_epub_xml_ancestor_frame::for-uint16_t-i-0U-err-k_ra8_ok
...
### libs/ra8_epub/src/ra8_epub_xml_shim.c::priv_ra8_epub_xml_ancestor_frame::if-err-k_ra8_ok-book-cover_pa
...
### libs/ra8_epub/src/ra8_epub_xml_shim.c::priv_ra8_epub_xml_ancestor_frame::if-err-k_ra8_ok-book-toc_kind

- **Function**: `priv_ra8_epub_xml_ancestor_frame`
- **Conditions in decision**: 3
- **Current llvm-cov status**: partial
- **Source line**: `if ((err == k_ra8_ok) && (book->toc_kind != (uint8_t)k_ra8_epub_toc_nav) &&`
...
### libs/ra8_epub/src/ra8_epub_xml_toc.c::internal_toc_marker::if-err-k_ra8_ok-event-kind
...
### libs/ra8_epub/src/ra8_epub_xml_toc.c::internal_ncx_event::if-err-k_ra8_ok-event-kind
...
### libs/ra8_epub/src/ra8_epub_xml_toc.c::internal_ncx_event::if-err-k_ra8_ok-fallback-kind
...
### libs/ra8_epub/src/ra8_epub_xml_toc.c::internal_nav_event::else-if-event-kind-uint8_t-k_ra
...
### libs/ra8_epub/src/ra8_epub_xml_toc.c::internal_nav_event::if-err-k_ra8_ok-event-kind
...
### libs/ra8_epub/src/ra8_epub_xml_toc.c::internal_nav_event::if-err-k_ra8_ok-ctx-saw_ol
...
### libs/ra8_xml/src/ra8_xml_decode.c::internal_digit::if-cursor-end-source-cursor
...
### libs/ra8_xml/src/ra8_xml_decode.c::internal_digit::if-internal_decoded_byte-source-li
