...
chain: `scripts/secrets/rot_sign.py sign` signs every launched image with the **private**
...
image is `scripts/secrets/rot_sign.py sign`. Both take `--help`, which is the authority
on their arguments.
