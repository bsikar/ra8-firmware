...
script rather than being some file you do not have. Run these three steps and
you will get the identical bytes.

**Step 1 -- generate the source image.** A 200 x 300 RGB PNG, an 8-pixel
...
**Step 2 -- convert.** The converter picked a band geometry (`tile_w == width`)
...
**Step 3 -- inspect.** Verbose mode adds the raw header/footer hexdumps and the
