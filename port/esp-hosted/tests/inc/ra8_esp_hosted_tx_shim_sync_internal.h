/**
 * @file port/esp-hosted/tests/inc/ra8_esp_hosted_tx_shim_sync_internal.h
 ...
 *
 * Including this test-support header is always sufficient on its own -- it
 * pulls in the base header, so no translation unit has to remember the
 * ordering. Target production builds include neither half.
 *
