/**
 * @file port/mbedtls/inc/mbedtls_sha256_alt.h
 * @brief SHA256_ALT context override for Mbed TLS on RA8 RSIP-E50D
 *
 * @par Tag
 ...
 *
 * On the RA8 the underlying primitive is the RSIP-E50D HASH core,
