/**
 * @file port/mbedtls/inc/mbedtls_aes_alt.h
 * @brief AES_ALT context override for Mbed TLS on RA8 RSIP-E50D
 *
 * @par Tag
 ...
 *
 * On the RA8 we satisfy that contract by storing a wrapped
