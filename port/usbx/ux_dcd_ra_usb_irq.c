/**
 * @file port/usbx/ux_dcd_ra_usb_irq.c
 * @brief USBX device-controller-driver bridge to ra_usb -- IRQ pipe-walk.
 *
 * @par Tag
 * [Ring 5 / PORT] {World: S}
 *
 * @details
 * The ISR bottom-half ``ux_dcd_ra_usb_irq`` and its per-pipe BRDY / BEMP
