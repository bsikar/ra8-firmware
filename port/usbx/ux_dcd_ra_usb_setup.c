/**
 * @file port/usbx/ux_dcd_ra_usb_setup.c
 * @brief USBX device-controller-driver bridge to ra_usb -- SETUP / chapter-9 control path.
 *
 * @par Tag
 * [Ring 5 / PORT] {World: S}
 *
 ...
 *
 * Split out of ``ux_dcd_ra_usb.c`` to keep each translation unit under
 * the maintainability line cap; the cross-translation-unit contract
 * lives in ``ux_dcd_ra_usb_internal.h``.
 *
...
#include "ux_dcd_ra_usb_internal.h"
