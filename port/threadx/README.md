...
The example app `examples/threadx_blink/` defaults `RA_USE_THREADX=ON`
...
`examples/threadx_blink` skips `ra_cgc_init()` for exactly this reason,
matching `examples/blink_hal`.
