/**
 * @file port/threadx/src/cortex_m85/tx_systick_ready.c
 ...
 * ``ra8_time_init`` and ``tx_kernel_enter`` give SysTick plenty of
 ...
 * @since 0.1.0
 */
volatile uint32_t g_ra8_threadx_systick_ready = 0U;
