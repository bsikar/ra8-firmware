...
typedef enum : uint16_t {
  k_ra8_key_import_blob_bytes  = 36U, /**< 32-byte key + 4-byte MAC.         */
  k_ra8_key_import_mac_bytes   = 4U,  /**< Trailing MAC length.              */
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra8_err_t ra8_key_import_build_blob(const uint8_t* key, uint8_t* out_blob);
