 ...
 * @details Volatile load from a Secure-only memory-mapped register; the
 *          @c volatile cast prevents the compiler from caching or reordering the
 *          access relative to other register touches in the SAU bring-up.
 * @param[in] addr Secure-only MMIO address.
