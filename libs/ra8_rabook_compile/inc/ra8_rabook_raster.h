 ...
 * ::ra8_book_image_t. Every byte of working storage is supplied by the caller;
...
typedef struct {
  ...
  uint8_t  pixel_format; /**< ::ra8_book_image_pixfmt_t emitted.        */
 ...
 * @param[in]  pixel_format ::k_ra8_book_pixfmt_gray4 or
 *                           ::k_ra8_book_pixfmt_gray8.
