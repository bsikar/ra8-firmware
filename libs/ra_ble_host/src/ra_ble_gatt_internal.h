/**
 * @file ra_ble_gatt_internal.h
 * @brief Test-access surface for ra_ble_gatt internal helpers (MC/DC).
 *
 ...
 * (line 569) memcpy guards in libs/ra_ble_host/src/ra_ble_gatt.c.
 *
