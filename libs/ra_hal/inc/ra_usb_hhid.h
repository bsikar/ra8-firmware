 ...
 *
 * Lifecycle (mirrors `ra_usb_hcdc.h` / `ra_usb_hmsc.h` shape):
 *
 *  1. `ra_usb_hhid_init(speed)` flips the controller to host mode,
 ...
 *  5. `ra_usb_hhid_get_input_report` polls the interrupt-IN pipe non-
 *     blockingly to drain the next input report.
 *  6. `ra_usb_hhid_close()` drops bus power and releases the device.
 *
...
typedef enum : uint16_t {
  k_ra_hhid_intr_max_packet_default = 8U,    /**< Boot-protocol default. */
  k_ra_hhid_intr_max_packet_fs      = 64U,   /**< FS ceiling.            */
  k_ra_hhid_intr_max_packet_hs      = 1024U, /**< HS ceiling.            */
} ra_usb_hhid_packet_t;

/**
 * @enum ra_usb_hhid_class_t
 ...
 */
typedef enum : uint8_t {
  k_ra_hhid_req_get_report   = 0x01U, /**< GET_REPORT.   */
  k_ra_hhid_req_get_idle     = 0x02U, /**< GET_IDLE.     */
  k_ra_hhid_req_get_protocol = 0x03U, /**< GET_PROTOCOL. */
  k_ra_hhid_req_set_report   = 0x09U, /**< SET_REPORT.   */
  k_ra_hhid_req_set_idle     = 0x0AU, /**< SET_IDLE.     */
  k_ra_hhid_req_set_protocol = 0x0BU, /**< SET_PROTOCOL. */
} ra_usb_hhid_request_t;

/**
 * @enum ra_usb_hhid_report_type_t
 ...
 */
typedef enum : uint8_t {
  k_ra_hhid_report_type_input   = 0x01U, /**< Input report.   */
  k_ra_hhid_report_type_output  = 0x02U, /**< Output report.  */
  k_ra_hhid_report_type_feature = 0x03U, /**< Feature report. */
} ra_usb_hhid_report_type_t;

/**
 * @enum ra_usb_hhid_protocol_select_t
 ...
 */
typedef enum : uint8_t {
  k_ra_hhid_proto_boot   = 0U, /**< Boot protocol.   */
  k_ra_hhid_proto_report = 1U, /**< Report protocol. */
} ra_usb_hhid_protocol_select_t;

/**
 * @enum ra_usb_hhid_desc_t
 ...
 */
typedef enum : uint16_t {
  k_ra_hhid_report_desc_max = 256U, /**< Cached Report desc max len. */
} ra_usb_hhid_report_buf_t;

/**
 * @struct ra_usb_hhid_device_t
 ...
 */
typedef void (*ra_usb_hhid_attach_fn_t)(void* ctx, const ra_usb_hhid_device_t* device);
 ...
 * @retval k_ra_ok Host-HID ready, awaiting attach.
 ...
 * @see ra_usb_hhid_attach_callback
 * @see ra_usb_hhid_close
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_init(ra_usb_speed_t speed);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_close(void);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_attach_callback(ra_usb_hhid_attach_fn_t on_attach, void* ctx);
 ...
 * `ra_usb_host_setup_request`; the controller drives the data + status
 * stages.
 *
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_get_report(ra_usb_hhid_report_type_t target_report_type,
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_set_report(ra_usb_hhid_report_type_t target_report_type,
                                              uint8_t                   target_report_id,
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_set_idle(uint8_t duration, uint8_t report_id);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_set_protocol(ra_usb_hhid_protocol_select_t boot_or_report);
 ...
 * (interrupt IN) into `out_buf`. Returns `k_ra_err_no_data` if the
 ...
 */
[[nodiscard]] ra_err_t
ra_usb_hhid_get_input_report(uint8_t* out_buf, uint16_t max_len, uint16_t* got_len);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_hhid_step(void);
