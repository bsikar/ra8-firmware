 ...
 * out of the umbrella ra_etha.h to keep that header under the per-file
 * line budget; this is a pure move of the original declarations. The data
 * types these functions take live in ra_etha_types.h, the register enums
 * in ra8d2_etha_regs.h, and the PHY link type in ra_rmac.h.
 *
