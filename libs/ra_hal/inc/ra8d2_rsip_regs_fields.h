/**
 * @file ra8d2_rsip_regs_fields.h
 * @brief RSIP-E50D register field/value enums and the reg32 accessor
 *
 * @details
 * Sub-header of @ref ra8d2_rsip_regs.h. Carries every register
 ...
 * plus the @ref ra_rsip_reg32 register-pointer accessor.
 *
 ...
 * ``crypto_procedures_protected/.../ra_rsip_e50d``.
 *
