 ...
 * `ra8d2_glcdc_regs.h` (`k_ra_ceu_base_addr` in the
 * `ra_display_addr_t` enum), so this header pulls that header in
...
#include "ra8d2_glcdc_regs.h" /* pulls in k_ra_ceu_base_addr */

/**
 * @enum ra_ceu_plane_off_t
 ...
 * `ra_ceu_plane_off_t` and `ra_ceu_reg32_plane`.
 */
typedef enum : uint16_t {
  k_ra_ceu_off_capsr  = 0x0000U, /**< Capture Start Register.                  */
  k_ra_ceu_off_capcr  = 0x0004U, /**< Capture Control Register.                */
  k_ra_ceu_off_camcr  = 0x0008U, /**< Camera Interface Control Register.       */
  k_ra_ceu_off_cmcyr  = 0x000CU, /**< Camera Interface Cycle Register.         */
  k_ra_ceu_off_camor  = 0x0010U, /**< Camera Interface Offset Register.        */
  k_ra_ceu_off_capwr  = 0x0014U, /**< Camera Interface Width Register.         */
  k_ra_ceu_off_caifr  = 0x0018U, /**< Camera Interface Input Format Register.  */
  k_ra_ceu_off_crcntr = 0x0028U, /**< Register Control Register.               */
  k_ra_ceu_off_crcmpr = 0x002CU, /**< Register Forcible Control Register.      */
  k_ra_ceu_off_cflcr  = 0x0030U, /**< Capture Filter Control Register.         */
  k_ra_ceu_off_cfszr  = 0x0034U, /**< Capture Filter Size Clip Register.       */
  k_ra_ceu_off_cdwdr  = 0x0038U, /**< Capture Destination Width Register.      */
  k_ra_ceu_off_cdayr  = 0x003CU, /**< Capture Data Y Address Register.         */
  k_ra_ceu_off_cdacr  = 0x0040U, /**< Capture Data C Address Register.         */
  k_ra_ceu_off_cdbyr  = 0x0044U, /**< Capture Data Y Bottom-Field Register.    */
  k_ra_ceu_off_cdbcr  = 0x0048U, /**< Capture Data C Bottom-Field Register.    */
  k_ra_ceu_off_cbdsr  = 0x004CU, /**< Capture Bundle Destination Size.         */
  k_ra_ceu_off_cfwcr  = 0x005CU, /**< Firewall Operation Control Register.     */
  k_ra_ceu_off_clfcr  = 0x0060U, /**< Capture Low-Pass Filter Control.         */
  k_ra_ceu_off_cdocr  = 0x0064U, /**< Capture Data Output Control Register.    */
  k_ra_ceu_off_ceier  = 0x0070U, /**< Capture Event Interrupt Enable Register. */
  k_ra_ceu_off_cetcr  = 0x0074U, /**< Capture Event Flag Clear Register.       */
  k_ra_ceu_off_cstsr  = 0x007CU, /**< Capture Status Register (R).             */
  k_ra_ceu_off_cdssr  = 0x0084U, /**< Capture Data Size Status Register.       */
  k_ra_ceu_off_cdayr2 = 0x0090U, /**< Capture Data Y Address Register 2.       */
  k_ra_ceu_off_cdacr2 = 0x0094U, /**< Capture Data C Address Register 2.       */
  k_ra_ceu_off_cdbyr2 = 0x0098U, /**< Capture Data Y2 Bottom-Field Register.   */
  k_ra_ceu_off_cdbcr2 = 0x009CU, /**< Capture Data C2 Bottom-Field Register.   */
} ra_ceu_off_t;

/**
 * @enum ra_ceu_capsr_bit_t
...
/**
 * @enum ra_ceu_capcr_mask_t
 * @brief CAPCR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_capcr_mask_ctncp = (1UL << 16),    /**< CTNCP: continuous mode.   */
  k_ra_ceu_capcr_mask_mtcm  = (3UL << 20),    /**< MTCM[1:0] burst-size sel. */
  k_ra_ceu_capcr_mask_fdrp  = (0xFFUL << 24), /**< FDRP[7:0] frame-drop cnt. */
} ra_ceu_capcr_mask_t;

/**
 * @enum ra_ceu_camcr_shift_t
...
/**
 * @enum ra_ceu_camcr_mask_t
 * @brief CAMCR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_camcr_mask_hdpol  = (1UL << 0),
  k_ra_ceu_camcr_mask_vdpol  = (1UL << 1),
  k_ra_ceu_camcr_mask_jpg    = (3UL << 4),
  k_ra_ceu_camcr_mask_dtary  = (3UL << 8),
  k_ra_ceu_camcr_mask_dtif   = (1UL << 12),
  k_ra_ceu_camcr_mask_fldpol = (1UL << 16),
  k_ra_ceu_camcr_mask_dsel   = (1UL << 24),
  k_ra_ceu_camcr_mask_fldsel = (1UL << 25),
  k_ra_ceu_camcr_mask_hdsel  = (1UL << 26),
  k_ra_ceu_camcr_mask_vdsel  = (1UL << 27),
} ra_ceu_camcr_mask_t;

/**
 * @enum ra_ceu_cmcyr_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ceu_camor_shift_hofst = 0U,  /**< HOFST[12:0] @ [12:0].  */
  k_ra_ceu_camor_shift_vofst = 16U, /**< VOFST[11:0] @ [27:16]. */
} ra_ceu_camor_shift_t;

/**
 * @enum ra_ceu_camor_mask_t
 * @brief CAMOR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_camor_mask_hofst = 0x00001FFFUL, /**< HOFST @ [12:0].  */
  k_ra_ceu_camor_mask_vofst = 0x0FFF0000UL, /**< VOFST @ [27:16]. */
} ra_ceu_camor_mask_t;

/**
 * @enum ra_ceu_capwr_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ceu_capwr_shift_hwdth = 0U,  /**< HWDTH[12:0] @ [12:0].  */
  k_ra_ceu_capwr_shift_vwdth = 16U, /**< VWDTH[11:0] @ [27:16]. */
} ra_ceu_capwr_shift_t;

/**
 * @enum ra_ceu_capwr_mask_t
 * @brief CAPWR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_capwr_mask_hwdth = 0x00001FFFUL,
  k_ra_ceu_capwr_mask_vwdth = 0x0FFF0000UL,
} ra_ceu_capwr_mask_t;

/**
 * @enum ra_ceu_caifr_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ceu_caifr_shift_fci = 0U, /**< FCI[1:0] @ [1:0]. */
  k_ra_ceu_caifr_shift_cim = 4U, /**< CIM @ bit 4.      */
  k_ra_ceu_caifr_shift_ifs = 8U, /**< IFS @ bit 8.      */
} ra_ceu_caifr_shift_t;

/**
 * @enum ra_ceu_caifr_mask_t
 * @brief CAIFR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_caifr_mask_fci = (3UL << 0), /**< FCI[1:0] mask. */
  k_ra_ceu_caifr_mask_cim = (1UL << 4), /**< CIM mask.      */
  k_ra_ceu_caifr_mask_ifs = (1UL << 8), /**< IFS mask.      */
} ra_ceu_caifr_mask_t;

/**
 * @enum ra_ceu_crcntr_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_crcmpr_mask_ra = (1UL << 0), /**< RA: force plane swap. */
} ra_ceu_crcmpr_mask_t;

/**
 * @enum ra_ceu_cflcr_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ceu_cflcr_shift_hfrac = 0U,
  k_ra_ceu_cflcr_shift_hmant = 12U,
  k_ra_ceu_cflcr_shift_vfrac = 16U,
  k_ra_ceu_cflcr_shift_vmant = 28U,
} ra_ceu_cflcr_shift_t;

/**
 * @enum ra_ceu_cflcr_mask_t
 * @brief CFLCR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_cflcr_mask_hfrac = 0x00000FFFUL,
  k_ra_ceu_cflcr_mask_hmant = 0x0000F000UL,
  k_ra_ceu_cflcr_mask_vfrac = 0x0FFF0000UL,
  k_ra_ceu_cflcr_mask_vmant = 0xF0000000UL,
} ra_ceu_cflcr_mask_t;

/**
 * @enum ra_ceu_cfszr_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ceu_cfszr_shift_hfclp = 0U,
  k_ra_ceu_cfszr_shift_vfclp = 16U,
} ra_ceu_cfszr_shift_t;

/**
 * @enum ra_ceu_cfszr_mask_t
 * @brief CFSZR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_cfszr_mask_hfclp = 0x00000FFFUL,
  k_ra_ceu_cfszr_mask_vfclp = 0x0FFF0000UL,
} ra_ceu_cfszr_mask_t;

/**
 * @enum ra_ceu_cdwdr_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_cdwdr_mask_chdw = 0x00001FFFUL, /**< CHDW[12:0] stride. */
} ra_ceu_cdwdr_mask_t;

/**
 * @enum ra_ceu_cbdsr_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_cbdsr_mask_cbvs = 0x007FFFFFUL, /**< CBVS[22:0] bundle size. */
} ra_ceu_cbdsr_mask_t;

/**
 * @enum ra_ceu_cfwcr_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ceu_cfwcr_shift_fwe = 0U,
  k_ra_ceu_cfwcr_shift_fwv = 5U,
} ra_ceu_cfwcr_shift_t;

/**
 * @enum ra_ceu_cfwcr_mask_t
 * @brief CFWCR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_cfwcr_mask_fwe = (1UL << 0),   /**< FWE: enable.        */
  k_ra_ceu_cfwcr_mask_fwv = 0xFFFFFFE0UL, /**< FWV[26:0] @ [31:5]. */
} ra_ceu_cfwcr_mask_t;

/**
 * @enum ra_ceu_clfcr_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_clfcr_mask_lpf = (1UL << 0), /**< LPF: enable LPF. */
} ra_ceu_clfcr_mask_t;

/**
 * @enum ra_ceu_cdocr_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ceu_cdocr_shift_cobs = 0U,
  k_ra_ceu_cdocr_shift_cows = 1U,
  k_ra_ceu_cdocr_shift_cols = 2U,
  k_ra_ceu_cdocr_shift_cds  = 4U,
  k_ra_ceu_cdocr_shift_cbe  = 16U,
} ra_ceu_cdocr_shift_t;

/**
 * @enum ra_ceu_cdocr_mask_t
 * @brief CDOCR field masks.
 */
typedef enum : uint32_t {
  k_ra_ceu_cdocr_mask_cobs = (1UL << 0),
  k_ra_ceu_cdocr_mask_cows = (1UL << 1),
  k_ra_ceu_cdocr_mask_cols = (1UL << 2),
  k_ra_ceu_cdocr_mask_cds  = (1UL << 4),
  k_ra_ceu_cdocr_mask_cbe  = (1UL << 16),
} ra_ceu_cdocr_mask_t;

/**
 * @enum ra_ceu_cstsr_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_cstsr_mask_cpton = (1UL << 0),  /**< CPTON: capture running. */
  k_ra_ceu_cstsr_mask_cpfld = (1UL << 16), /**< CPFLD: current field.   */
  k_ra_ceu_cstsr_mask_crst  = (1UL << 24), /**< CRST: reset in flight.  */
} ra_ceu_cstsr_mask_t;

/**
 * @enum ra_ceu_cetcr_mask_t
...
/**
 * @enum ra_ceu_evt_mask_group_t
 * @brief Convenience groupings of CETCR events for callbacks.
 *
 * @details
 * Hand-curated unions of `ra_ceu_cetcr_mask_t` values that callers
 * tend to enable as a set. `k_ra_ceu_evt_mask_all_errors` covers
 * every fault condition the HUM lists; `k_ra_ceu_evt_mask_all`
 * is the universal mask used by `ra_ceu_clear_status` callers
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_cdssr_mask_cdss = 0xFFFFFFFFUL, /**< CDSS[31:0] data byte count. */
} ra_ceu_cdssr_mask_t;
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_buffer_align_bytes = 8U,
} ra_ceu_align_t;

/**
 * @enum ra_ceu_burst_align_t
 ...
 */
typedef enum : uint32_t {
  k_ra_ceu_bundle_align_mask = 0x7U,
} ra_ceu_burst_align_t;

/**
 * @enum ra_ceu_firewall_align_t
 ...
 * mask is used by `ra_ceu_firewall_set` to compose the value.
 */
typedef enum : uint32_t {
  k_ra_ceu_firewall_align_mask = 0x1FU,
} ra_ceu_firewall_align_t;
 ...
 *
 * @param[in] offset One of the `k_ra_ceu_off_*` enum values.
 * @return Volatile pointer to the register at
 *         `k_ra_ceu_base_addr + offset`.
 *
 * @pre `offset` is a member of `ra_ceu_off_t` (compile-time
 ...
 *       32-bit access.
 *
 * @note Routes through `ra_sim_mmap` on host test builds so that
 *       writes target real RAM rather than segfaulting.
 *
 * @since 0.1.0
 */
static inline volatile uint32_t* ra_ceu_reg32(ra_ceu_off_t offset)
{
  return (volatile uint32_t*)(k_ra_ceu_base_addr + (uint16_t)offset);
}
 ...
 * `k_ra_ceu_base_addr + plane + offset` so callers can read/write
 ...
 *
 * @pre `offset` is a member of `ra_ceu_off_t`.
 * @pre `plane` is a member of `ra_ceu_plane_off_t`.
...
{
  return (volatile uint32_t*)(k_ra_ceu_base_addr + (uint16_t)plane + (uint16_t)offset);
}
