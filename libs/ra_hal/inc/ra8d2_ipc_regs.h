 ...
 * with `RA_SIMULATOR_MODE` and the sim mmap covers the secure
 * 0x4xxxxxxx peripheral window.
 */
typedef enum : uintptr_t {
  k_ra_ipc_base_addr   = 0x40020000UL, /**< IPC block base (Secure).        */
  k_ra_ipc_cpscu_addr  = 0x40008000UL, /**< CPSCU base for IPCSAR/IPCPAR.   */
  k_ra_ipc_ipcsar_addr = 0x40008610UL, /**< IPC Security Attribution Reg.   */
  k_ra_ipc_ipcpar_addr = 0x40008614UL, /**< IPC Privileged Attribution Reg. */
} ra_ipc_addr_t;

/**
 * @enum ra_ipc_offset_t
 * @brief In-block offsets relative to ``k_ra_ipc_base_addr``.
 *
 * @details
 ...
 */
typedef enum : uint8_t {
  k_ra_ipc_unit_ipc0 = 0U, /**< CPU1 -> CPU0 (M33 sends, M85 receives). */
  k_ra_ipc_unit_ipc1 = 1U, /**< CPU0 -> CPU1 (M85 sends, M33 receives). */
} ra_ipc_unit_id_t;

/**
 * @enum ra_ipc_core_id_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ipc_core_cpu0 = 0U, /**< Cortex-M85 (primary core).   */
  k_ra_ipc_core_cpu1 = 1U, /**< Cortex-M33 (secondary core). */
} ra_ipc_core_id_t;

/**
 * @enum ra_ipc_sta_mask_t
...
typedef enum : uint32_t {
  k_ra_ipc_sta_mask_irq0    = 0x00000001U, /**< IRQ0 event.                    */
  k_ra_ipc_sta_mask_irq1    = 0x00000002U, /**< IRQ1 event.                    */
  k_ra_ipc_sta_mask_irq2    = 0x00000004U, /**< IRQ2 event.                    */
  k_ra_ipc_sta_mask_irq3    = 0x00000008U, /**< IRQ3 event.                    */
  k_ra_ipc_sta_mask_irq4    = 0x00000010U, /**< IRQ4 event.                    */
  k_ra_ipc_sta_mask_irq5    = 0x00000020U, /**< IRQ5 event.                    */
  k_ra_ipc_sta_mask_irq6    = 0x00000040U, /**< IRQ6 event.                    */
  k_ra_ipc_sta_mask_irq7    = 0x00000080U, /**< IRQ7 event.                    */
  k_ra_ipc_sta_mask_irq_all = 0x000000FFU, /**< IRQ7..IRQ0 event bits.         */
  k_ra_ipc_sta_mask_rdy     = 0x00010000U, /**< RDY: FIFO non-empty.           */
  k_ra_ipc_sta_mask_full    = 0x00020000U, /**< FULL: FIFO full.               */
  k_ra_ipc_sta_mask_rerr    = 0x01000000U, /**< RERR: read-while-empty.        */
  k_ra_ipc_sta_mask_ferr    = 0x02000000U, /**< FERR: write-while-full.        */
  k_ra_ipc_sta_mask_event   = 0x030000FFU, /**< Any event the ISR cares about. */
  k_ra_ipc_sta_mask_err_any = 0x03000000U, /**< RERR | FERR.                   */
} ra_ipc_sta_mask_t;

/**
 * @enum ra_ipc_clr_mask_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ipc_attr_shift_ir_base  = 16U, /**< SAIPCIR0 / PAIPCIR0 bit position. */
  k_ra_ipc_attr_shift_nmi_base = 8U,  /**< SAIPCNMI0 / PAIPCNMI0 position.   */
} ra_ipc_attr_shift_t;

/**
 * @enum ra_ipc_elc_event_t
 ...
 */
typedef enum : uint8_t {
  k_ra_ipc_sem_group_low  = 0U, /**< IPCSEM0..IPCSEM7  attribution group. */
  k_ra_ipc_sem_group_high = 1U, /**< IPCSEM8..IPCSEM15 attribution group. */
} ra_ipc_sem_attr_group_t;
 ...
 *         `channel >= k_ra_ipc_channel_count`.
 */
static inline volatile r_ipc_channel_regs_t* ra_ipc_channel(uint8_t channel)
{
 ...
 *         `unit >= k_ra_ipc_nmi_unit_count`.
 */
static inline volatile r_ipc_nmi_regs_t* ra_ipc_nmi(uint8_t unit)
{
 ...
 */
static inline volatile uint32_t* ra_ipc_ipcsar(void)
{
  /* HUM Ch 3.2.1 "IPCSAR" p 205 */
  return (volatile uint32_t*)k_ra_ipc_ipcsar_addr;
}
 ...
 */
static inline volatile uint32_t* ra_ipc_ipcpar(void)
{
  /* HUM Ch 3.2.2 "IPCPAR" p 208 */
  return (volatile uint32_t*)k_ra_ipc_ipcpar_addr;
}
 ...
 *         when `sem_id >= k_ra_ipc_sem_count`.
 */
static inline volatile uint32_t* ra_ipc_sem(uint8_t sem_id)
{
