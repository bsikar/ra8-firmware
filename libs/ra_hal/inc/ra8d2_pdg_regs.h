...
/**
 * @enum ra_pdg_gtdlycr_mask_t
 * @brief Masks for GTDLYCR fields.
 */
/* HUM Ch 23.2.1 "GTDLYCR" p 1154 */
typedef enum : uint16_t {
  k_ra_pdg_gtdlycr_mask_dllen  = (uint16_t)(1U << (uint16_t)k_ra_pdg_gtdlycr_bit_dllen),
  k_ra_pdg_gtdlycr_mask_dlyrst = (uint16_t)(1U << (uint16_t)k_ra_pdg_gtdlycr_bit_dlyrst),
  k_ra_pdg_gtdlycr_mask_frange = (uint16_t)(0x3U << (uint16_t)k_ra_pdg_gtdlycr_shift_frange),
} ra_pdg_gtdlycr_mask_t;

/**
 * @enum ra_pdg_frange_t
...
/**
 * @enum ra_pdg_gtdlycr2_mask_t
 * @brief Masks for GTDLYCR2 fields.
 */
/* HUM Ch 23.2.2 "GTDLYCR2" p 1155 */
typedef enum : uint16_t {
  k_ra_pdg_gtdlycr2_mask_dlybs = (uint16_t)(0xFU << (uint16_t)k_ra_pdg_gtdlycr2_shift_dlybs),
  k_ra_pdg_gtdlycr2_mask_dlyen = (uint16_t)(0xFU << (uint16_t)k_ra_pdg_gtdlycr2_shift_dlyen),
} ra_pdg_gtdlycr2_mask_t;

/**
 * @enum ra_pdg_dly_field_t
...
typedef enum : uint32_t {
  k_ra_pdg_freq_low_min_hz  = 80000000UL,  /**< 80 MHz.                  */
  k_ra_pdg_freq_low_max_hz  = 160000000UL, /**< 160 MHz.                 */
  k_ra_pdg_freq_high_min_hz = 155000000UL, /**< 155 MHz.                 */
  k_ra_pdg_freq_high_max_hz = 300000000UL, /**< 300 MHz.                 */
  k_ra_pdg_freq_overlap_top = 160000000UL, /**< Top of the overlap zone. */
  k_ra_pdg_freq_overlap_bot = 155000000UL, /**< Bottom of overlap zone.  */
} ra_pdg_freq_band_t;
...
/**
 * @struct r_pdg_regs_t
 * @brief PDG block register window mapped at ``k_ra_pdg_base_addr``.
 *
 * @details
 ...
 *
 * @return Volatile pointer at ``k_ra_pdg_base_addr``.
 *
 ...
 * @since 0.1.0
 */
static inline volatile r_pdg_regs_t* ra_pdg(void)
{
  return (volatile r_pdg_regs_t*)k_ra_pdg_base_addr;
}
