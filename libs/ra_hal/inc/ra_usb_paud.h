 ...
 *
 * @details
 * Glues the device-mode `ra_usb` controller driver to a USB Audio
...
typedef enum : uint8_t {
  k_ra_paud_pipe_iso_in  = 1U, /**< PIPE1 -> EP1 IN  (capture).  */
  k_ra_paud_pipe_iso_out = 2U, /**< PIPE2 -> EP2 OUT (playback). */
} ra_usb_paud_pipe_t;

/**
 * @enum ra_usb_paud_ep_t
 * @brief USB endpoint addresses used by the device-Audio function.
 */
typedef enum : uint8_t {
  k_ra_paud_ep_iso_in_addr  = 1U, /**< EP1 IN address.  */
  k_ra_paud_ep_iso_out_addr = 2U, /**< EP2 OUT address. */
} ra_usb_paud_ep_t;

/**
 * @enum ra_usb_paud_packet_t
...
typedef enum : uint16_t {
  k_ra_paud_iso_max_packet_fs_default = 192U,  /**< 48 kHz stereo 16-bit. */
  k_ra_paud_iso_max_packet_fs         = 1023U, /**< FS iso ceiling.       */
  k_ra_paud_iso_max_packet_hs         = 1024U, /**< HS iso ceiling.       */
} ra_usb_paud_packet_t;

/**
 * @enum ra_usb_paud_class_t
 ...
 */
typedef enum : uint8_t {
  k_ra_paud_req_set_cur  = 0x01U, /**< SET_CUR.  */
  k_ra_paud_req_get_cur  = 0x81U, /**< GET_CUR.  */
  k_ra_paud_req_set_min  = 0x02U, /**< SET_MIN.  */
  k_ra_paud_req_get_min  = 0x82U, /**< GET_MIN.  */
  k_ra_paud_req_set_max  = 0x03U, /**< SET_MAX.  */
  k_ra_paud_req_get_max  = 0x83U, /**< GET_MAX.  */
  k_ra_paud_req_set_res  = 0x04U, /**< SET_RES.  */
  k_ra_paud_req_get_res  = 0x84U, /**< GET_RES.  */
  k_ra_paud_req_get_stat = 0xFFU, /**< GET_STAT. */
} ra_usb_paud_request_t;

/**
 * @enum ra_usb_paud_control_sel_t
...
/**
 * @typedef ra_usb_paud_setup_fn_t
 ...
 */
typedef ra_err_t (*ra_usb_paud_setup_fn_t)(void* ctx, const ra_usb_setup_t* setup);
 ...
 * dropped. The caller raises it via `ra_usb_device_attach` once
 * descriptors are set.
 *
 * @param[in] speed Which USB controller (FS or HS).
 *
 * @return `ra_err_t` error code.
 * @retval k_ra_ok Device-Audio ready.
 ...
 * @see ra_usb_paud_set_descriptors
 * @see ra_usb_paud_close
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_init(ra_usb_speed_t speed);
 ...
 *       device-Audio API calls return `k_ra_err_invalid_state`.
 *
 * @note Not thread-safe.
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_close(void);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_set_descriptors(const uint8_t* desc, uint16_t desc_len);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_send_frame(const uint8_t* frame, uint16_t len);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_recv_frame(uint8_t* buf, uint16_t max_len, uint16_t* got_len);
 ...
 * @pre `ra_usb_paud_init` succeeded.
 *
 * @post `ra_usb_paud_get_format` reflects the new value.
 *
 * @note Not thread-safe.
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_set_format(ra_usb_paud_format_t format);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_get_format(ra_usb_paud_format_t* out_format);
 ...
 * @pre `ra_usb_paud_init` succeeded.
 *
 * @post `ra_usb_paud_get_volume` reflects the new value.
 *
 * @note Not thread-safe.
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_set_volume(int16_t volume_q8_8);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_get_volume(int16_t* out_volume);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_attach_setup_handler(ra_usb_paud_setup_fn_t setup_fn, void* ctx);
 ...
 * with `k_ra_err_not_supported` so the caller can fall back to its
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_usb_paud_handle_setup(const ra_usb_setup_t* setup);
