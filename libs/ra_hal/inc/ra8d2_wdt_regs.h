 ...
 * higher-level driver (``ra_wdt.h``) layers semantic enum names on
 * top.
 *
 ...
 * ``ra_ofs.c`` owns the writable side. ``ra_wdt_ofs_get`` reads them
...
typedef enum : uint8_t {
  k_ra_wdt_refresh_a = 0x00U, /**< First byte of the refresh sequence.  */
  k_ra_wdt_refresh_b = 0xFFU, /**< Second byte of the refresh sequence. */
} ra_wdt_refresh_t;

/**
 * @enum ra_wdt_instance_t
 ...
 */
typedef enum : uint16_t {
  k_ra_wdt_sr_cnt_mask = 0x3FFFU, /**< CNTVAL[13:0] mask. */
  k_ra_wdt_sr_undff    = 0x4000U, /**< UNDFF bit 14.      */
  k_ra_wdt_sr_refef    = 0x8000U, /**< REFEF bit 15.      */
} ra_wdt_wdtsr_layout_t;

/**
 * @enum ra_wdt_wdtrcr_layout_t
 ...
 */
typedef enum : uint8_t {
  k_ra_wdt_rcr_rstirqs = 0x80U, /**< RSTIRQS = bit 7 (1 = reset, 0 = NMI / IRQ). */
} ra_wdt_wdtrcr_layout_t;

/**
 * @enum ra_wdt_wdtcstpr_layout_t
 ...
 */
typedef enum : uint8_t {
  k_ra_wdt_cstpr_slcstp = 0x80U, /**< SLCSTP = bit 7 (1 = halt counter in Sleep). */
} ra_wdt_wdtcstpr_layout_t;

/**
 * @enum ra_wdt_cycles_t
 ...
 */
typedef enum : uint16_t {
  k_ra_wdt_cycles_1024  = 1024U,  /**< TOPS = 0b00. */
  k_ra_wdt_cycles_4096  = 4096U,  /**< TOPS = 0b01. */
  k_ra_wdt_cycles_8192  = 8192U,  /**< TOPS = 0b10. */
  k_ra_wdt_cycles_16384 = 16384U, /**< TOPS = 0b11. */
} ra_wdt_cycles_t;

/**
 * @enum ra_wdt_div_value_t
 ...
 */
typedef enum : uint16_t {
  k_ra_wdt_div_value_4    = 4U,
  k_ra_wdt_div_value_64   = 64U,
  k_ra_wdt_div_value_128  = 128U,
  k_ra_wdt_div_value_512  = 512U,
  k_ra_wdt_div_value_2048 = 2048U,
  k_ra_wdt_div_value_8192 = 8192U,
} ra_wdt_div_value_t;

/**
 * @enum ra_wdt_nmier_layout_t
...
typedef enum : uint32_t {
  k_ra_wdt_nmier_wdten_mask = 0x00000002UL, /**< NMIER.WDTEN = bit 1. */
} ra_wdt_nmier_layout_t;

/**
 * @enum ra_wdt_ofs_layout_t
 ...
 * @see HUM Ch 27.1 "Overview" p 1256.
 */
static inline volatile r_wdt_regs_t* ra_wdt_for(ra_wdt_instance_t which)
{
  /* HUM Ch 27.1 "Overview" p 1256 */
  switch (which) {
    case k_ra_wdt0:
      return (volatile r_wdt_regs_t*)k_ra_wdt0_base_addr;
    case k_ra_wdt1:
      return (volatile r_wdt_regs_t*)k_ra_wdt1_base_addr;
 ...
 *
 * @param[in] which Instance selector.
 * @return ``k_ra_wdt_ofs0_addr`` for WDT0, ``k_ra_wdt_ofs3_addr`` for
 ...
 * dropped by silicon.
 *
 * @pre WDT0 is in register-start mode and ``ra_wdt_init`` has run,
