...
/**
 * @enum ra_mipi_dsi_rxrinfoowscr_t
...
/**
 * @enum ra_mipi_dsi_linksr_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_dsi_link_sq0run = 1UL << 0,  /**< Sequence ch 0 running.        */
  k_ra_mipi_dsi_link_sq1run = 1UL << 4,  /**< Sequence ch 1 running.        */
  k_ra_mipi_dsi_link_vrun   = 1UL << 8,  /**< Video-mode operation running. */
  k_ra_mipi_dsi_link_hsbusy = 1UL << 12, /**< HS operation busy.            */
  k_ra_mipi_dsi_link_lpbusy = 1UL << 13, /**< LP operation busy.            */
} ra_mipi_dsi_linksr_mask_t;

/**
 * @enum ra_mipi_dsi_txset_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_dsi_dsisetr_eccen       = 1UL << 16, /**< ECC check enable.        */
  k_ra_mipi_dsi_dsisetr_vc0crcen    = 1UL << 20, /**< VC-0 CRC check enable.   */
  k_ra_mipi_dsi_dsisetr_vc1crcen    = 1UL << 21, /**< VC-1 CRC check enable.   */
  k_ra_mipi_dsi_dsisetr_vc2crcen    = 1UL << 22, /**< VC-2 CRC check enable.   */
  k_ra_mipi_dsi_dsisetr_vc3crcen    = 1UL << 23, /**< VC-3 CRC check enable.   */
  k_ra_mipi_dsi_dsisetr_scren       = 1UL << 29, /**< Data scramble enable.    */
  k_ra_mipi_dsi_dsisetr_extemd      = 1UL << 30, /**< External tearing detect. */
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_dsi_rxsr_btarend  = 1UL << 0,  /**< BTA request end.           */
  k_ra_mipi_dsi_rxsr_lrxhto   = 1UL << 1,  /**< LP-RX host processor TO.   */
  k_ra_mipi_dsi_rxsr_tato     = 1UL << 2,  /**< Turnaround ack timeout.    */
  k_ra_mipi_dsi_rxsr_rxresp   = 1UL << 8,  /**< Response packet received.  */
  k_ra_mipi_dsi_rxsr_rxeotp   = 1UL << 10, /**< EoTp received.             */
  k_ra_mipi_dsi_rxsr_rxte     = 1UL << 13, /**< Tearing-effect trigger rx. */
  k_ra_mipi_dsi_rxsr_rxack    = 1UL << 14, /**< ACK trigger received.      */
  k_ra_mipi_dsi_rxsr_extedet  = 1UL << 15, /**< External TE detect.        */
  k_ra_mipi_dsi_rxsr_mlferr   = 1UL << 16, /**< Malform error.             */
  k_ra_mipi_dsi_rxsr_eccerrm  = 1UL << 17, /**< Multi-bit ECC error.       */
  k_ra_mipi_dsi_rxsr_unexerr  = 1UL << 18, /**< Unexpected packet error.   */
  k_ra_mipi_dsi_rxsr_wcerr    = 1UL << 20, /**< Word count error.          */
  k_ra_mipi_dsi_rxsr_crcerr   = 1UL << 21, /**< CRC error.                 */
  k_ra_mipi_dsi_rxsr_iberr    = 1UL << 22, /**< Internal bus error.        */
  k_ra_mipi_dsi_rxsr_rxovferr = 1UL << 23, /**< Receive buffer overflow.   */
  k_ra_mipi_dsi_rxsr_prtoerr  = 1UL << 24, /**< Peripheral resp timeout.   */
  k_ra_mipi_dsi_rxsr_noreserr = 1UL << 25, /**< No response error.         */
  k_ra_mipi_dsi_rxsr_rsizeerr = 1UL << 26, /**< Return packet size error.  */
  k_ra_mipi_dsi_rxsr_eccerrs  = 1UL << 28, /**< Single-bit ECC error.      */
  k_ra_mipi_dsi_rxsr_rxake    = 1UL << 30, /**< Ack-and-error report rx.   */
  k_ra_mipi_dsi_rxsr_clear_all =
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_dsi_ferrsr_htxto     = 1UL << 0,  /**< HS Tx timeout.              */
  k_ra_mipi_dsi_ferrsr_lrxhto    = 1UL << 1,  /**< LP-RX host timeout.         */
  k_ra_mipi_dsi_ferrsr_tato      = 1UL << 2,  /**< Turnaround ack timeout.     */
  k_ra_mipi_dsi_ferrsr_escent    = 1UL << 16, /**< Escape-mode entry error.    */
  k_ra_mipi_dsi_ferrsr_syncesc   = 1UL << 17, /**< LPDT sync error.            */
  k_ra_mipi_dsi_ferrsr_ctrl      = 1UL << 18, /**< Control error.              */
  k_ra_mipi_dsi_ferrsr_clp0      = 1UL << 19, /**< LP0 contention error.       */
  k_ra_mipi_dsi_ferrsr_clp1      = 1UL << 20, /**< LP1 contention error.       */
  k_ra_mipi_dsi_ferrsr_clp0s     = 1UL << 27, /**< LP0 contention status (RO). */
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_dsi_vmset0_vstart  = 1UL << 0,  /**< VSTART: start video mode.   */
  k_ra_mipi_dsi_vmset0_vstop   = 1UL << 1,  /**< VSTOP : request video stop. */
  k_ra_mipi_dsi_vmset0_hsanolp = 1UL << 8,  /**< HSA period stays HS.        */
  k_ra_mipi_dsi_vmset0_hbpnolp = 1UL << 9,  /**< HBP period stays HS.        */
  k_ra_mipi_dsi_vmset0_hfpnolp = 1UL << 10, /**< HFP period stays HS.        */
} ra_mipi_dsi_vmset0_t;

/**
 * @enum ra_mipi_dsi_vmset1_t
...
/**
 * @enum ra_mipi_dsi_dsc0a_shift_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_dsi_dsc0c_finact        = 1UL << 0,     /**< Finish action flag. */
  k_ra_mipi_dsi_dsc0c_auxop         = 1UL << 22,    /**< Auxiliary op flag.  */
  k_ra_mipi_dsi_dsc0c_actcode_shift = 24U,          /**< Action code shift.  */
  k_ra_mipi_dsi_dsc0c_actcode_mask  = 0xFFUL << 24, /**< ACTCODE[31:24].     */
} ra_mipi_dsi_dsc0c_t;

/**
 * @enum ra_mipi_dsi_bta_t
 ...
 */
typedef enum : uint8_t {
  k_ra_mipi_dsi_bta_none     = 0U, /**< No bus-turnaround.                  */
  k_ra_mipi_dsi_bta_after    = 1U, /**< BTA after Tx (default ack request). */
  k_ra_mipi_dsi_bta_read     = 2U, /**< BTA followed by read.               */
  k_ra_mipi_dsi_bta_no_write = 3U, /**< Immediate BTA, no write first.      */
} ra_mipi_dsi_bta_t;
 ...
 *
 * @details
 * Always returns the Secure-world alias. In `RA_SIMULATOR_MODE` the
 * host test harness has already mmap'd the peripheral window so this
 * pointer is dereferenceable.
 *
 * @pre Caller has called `ra_mstp_enable(k_ra_mstp_mipi_dsi)` first
 ...
 * @since 0.1.0
 */
static inline volatile r_mipi_dsi_regs_t* ra_mipi_dsi(void)
{
  return (volatile r_mipi_dsi_regs_t*)k_ra_mipi_dsi_base_addr_s;
}
