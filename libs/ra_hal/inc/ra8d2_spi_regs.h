 ...
 * the chapter. The earlier (legacy) SPI block in ``ra8d2_spi_regs.h``
...
typedef enum : uintptr_t {
  k_ra_spi0_base_addr = 0x4035C000UL, /**< HUM Ch 43, SPI0 base. */
  k_ra_spi1_base_addr = 0x4035C100UL, /**< HUM Ch 43, SPI1 base. */
} ra_spi_addr_t;

/**
 * @enum ra_spi_limits_t
 ...
 */
typedef enum : uint32_t {
  k_ra_spsr_mask_spdrf = 0x00800000UL,
  k_ra_spsr_mask_ovrf  = 0x01000000UL,
  k_ra_spsr_mask_idlnf = 0x02000000UL,
  k_ra_spsr_mask_modf  = 0x04000000UL,
  k_ra_spsr_mask_perf  = 0x08000000UL,
  k_ra_spsr_mask_udrf  = 0x10000000UL,
...
/**
 * @enum ra_spsrc_mask_t
 * @brief SPSRC (status clear, write-1-to-clear) masks. HUM Ch 43.2.13 p 2905.
 */
typedef enum : uint32_t {
  k_ra_spsrc_mask_spdrfc = 0x00800000UL,
  k_ra_spsrc_mask_ovrfc  = 0x01000000UL,
  k_ra_spsrc_mask_modfc  = 0x04000000UL,
  k_ra_spsrc_mask_perfc  = 0x08000000UL,
  k_ra_spsrc_mask_udrfc  = 0x10000000UL,
...
/**
 * @enum ra_spcr3_misc_t
 * @brief SPCR3 misc constants used in driver-side bit-shifting math.
 */
typedef enum : uint8_t {
  k_ra_spbr_max = 0xFFU, /**< SPBR is 8-bit unsigned. */
} ra_spcr3_misc_t;

/**
 * @enum ra_spfcr_mask_t
