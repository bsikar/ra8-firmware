...
/* Register layout verified against FSP R_SPI0_Type in
 * R7KA8D2KF_core0.h lines 13700-13900. */
typedef struct {
  ...
  volatile uint8_t  SPDCR;    /**< +0x0B Data Control.         */
  volatile uint8_t  SPCKD;    /**< +0x0C Clock Delay.          */
  volatile uint8_t  SSLND;    /**< +0x0D SSL Negation Delay.   */
  volatile uint8_t  SPND;     /**< +0x0E Next-Access Delay.    */
  volatile uint8_t  SPCR2;    /**< +0x0F Control 2.            */
  volatile uint16_t SPCMD[8]; /**< +0x10..+0x1E Command 0..7.  */
  volatile uint8_t  SPDCR2;   /**< +0x20 Data Control 2.        */
  volatile uint8_t  _r0[3];
  volatile uint32_t SPDCMD; /**< +0x24 Data Command.          */
} r_spi_regs_t;
