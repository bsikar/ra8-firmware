 ...
 * referenced by Wave 9 once TrustZone is wired up.
 *
 ...
 * column from the HUM tables, prefixed with ``k_ra_mstp_``.
 *
 ...
 *   ref-counted helper in ``ra_mstp.c`` performs the read-back; the
 ...
 *   setting MSTPAi bit (i = 22, 23)." Caller responsibility -- ra_mstp
 ...
 * ``ra_mstp_enable(id) / ra_mstp_disable(id)``, never write the
 * register directly.
 *
...
typedef enum : uint16_t {
  ...
  k_ra_mstp_sram0 = (uint16_t)(k_ra_mstp_reg_a << 8),        /**< MSTPA0  SRAM0          */
  k_ra_mstp_sram1 = (uint16_t)((k_ra_mstp_reg_a << 8) | 1U), /**< MSTPA1  SRAM1          */
  k_ra_mstp_sram2 = (uint16_t)((k_ra_mstp_reg_a << 8) | 2U), /**< MSTPA2  SRAM2          */
  k_ra_mstp_sram3 = (uint16_t)((k_ra_mstp_reg_a << 8) | 3U), /**< MSTPA3  SRAM3          */
  k_ra_mstp_dmac0_dtc0 =
    (uint16_t)((k_ra_mstp_reg_a << 8) | 22U), /**< MSTPA22 DMAC0+DTC0 (shared) */
  k_ra_mstp_dmac1_dtc1 =
