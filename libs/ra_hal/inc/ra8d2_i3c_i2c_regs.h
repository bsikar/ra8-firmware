...
typedef enum : uintptr_t {
  k_ra_i3c_i2c0_base_addr = 0x4035F000UL, /**< HUM Ch 40.2, p 2452 */
} ra_i3c_i2c_addr_t;

/**
 * @enum ra_i3c_i2c_limits_t
 * @brief Channel-count limits.
 */
typedef enum : uint16_t {
  k_ra_i3c_i2c_channel_count = 1U, /**< HUM Ch 40.1.1, p 2445 */
} ra_i3c_i2c_limits_t;

/**
 * @enum ra_i3c_i2c_rsv_words_t
...
typedef enum : uint8_t {
  k_ra_i3c_i2c_rsv_words_svtdlg_to_stctl    = 23U, /**< +0x00C4..0x011F gap. */
  k_ra_i3c_i2c_rsv_words_ntdtbp0_to_nibiqp  = 8U,  /**< +0x015C..0x017B gap. */
  k_ra_i3c_i2c_rsv_words_ntbthctl_to_nrqthc = 10U, /**< +0x0198..0x01BF gap. */
} ra_i3c_i2c_rsv_words_t;
 ...
 * via the ``k_ra_i3c_i2c_*_pos`` and ``k_ra_i3c_i2c_*_msk`` enums below.
 *
 ...
 * ``ra_i3c_i2c.c`` only knows how to drive the I2C single-buffer mode
 * (it writes NTDTBP0 directly without composing an I3C command queue
 * entry), so it must set PRTMD = 1 during init.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_prts_prtmd_pos = 0U, /**< HUM 40.2.1 PRTS.PRTMD, p 2449 */
} ra_i3c_i2c_prts_t;

/**
 * @enum ra_i3c_i2c_cectl_t
 * @brief CECTL field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_cectl_clke_pos = 0U, /**< HUM 40.2 CECTL.CLKE, p 2453 */
} ra_i3c_i2c_cectl_t;

/**
 * @enum ra_i3c_i2c_bctl_t
 * @brief BCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_bctl_buse_pos = 31U, /**< HUM 40.2 BCTL.BUSE, p 2454 */
} ra_i3c_i2c_bctl_t;

/**
 * @enum ra_i3c_i2c_rstctl_t
 * @brief RSTCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_rstctl_ri3crst_pos = 0U, /**< HUM 40.2 RSTCTL.RI3CRST, p 2456 */
} ra_i3c_i2c_rstctl_t;

/**
 * @enum ra_i3c_i2c_prsst_t
 * @brief PRSST field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_prsst_crms_pos = 2U, /**< HUM 40.2 PRSST.CRMS, p 2457 */
  k_ra_i3c_i2c_prsst_trmd_pos = 4U, /**< HUM 40.2 PRSST.TRMD, p 2457 */
} ra_i3c_i2c_prsst_t;

/**
 * @enum ra_i3c_i2c_bfctl_t
...
/**
 * @enum ra_i3c_i2c_stdbr_t
 * @brief STDBR field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_stdbr_sbrlo_pos = 0U, /**< HUM 40.2 STDBR.SBRLO, p 2462 */
  k_ra_i3c_i2c_stdbr_sbrho_pos = 8U, /**< HUM 40.2 STDBR.SBRHO, p 2462 */
} ra_i3c_i2c_stdbr_t;

/**
 * @enum ra_i3c_i2c_ackctl_t
...
/**
 * @enum ra_i3c_i2c_scstrctl_t
 * @brief SCSTRCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_scstrctl_rwe_pos = 1U, /**< HUM 40.2 SCSTRCTL.RWE, p 2469 */
} ra_i3c_i2c_scstrctl_t;

/**
 * @enum ra_i3c_i2c_cndctl_t
 * @brief CNDCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_cndctl_stcnd_pos = 0U, /**< HUM 40.2 CNDCTL.STCND, p 2473 */
  k_ra_i3c_i2c_cndctl_srcnd_pos = 1U, /**< HUM 40.2 CNDCTL.SRCND, p 2473 */
  k_ra_i3c_i2c_cndctl_spcnd_pos = 2U, /**< HUM 40.2 CNDCTL.SPCND, p 2473 */
} ra_i3c_i2c_cndctl_t;

/**
 * @enum ra_i3c_i2c_bst_t
 * @brief BST (Bus Status) field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_bst_stcnddf_pos = 0U,  /**< HUM 40.2 BST.STCNDDF, p 2482 */
  k_ra_i3c_i2c_bst_spcnddf_pos = 1U,  /**< HUM 40.2 BST.SPCNDDF, p 2482 */
  k_ra_i3c_i2c_bst_nackdf_pos  = 4U,  /**< HUM 40.2 BST.NACKDF,  p 2482 */
  k_ra_i3c_i2c_bst_tendf_pos   = 8U,  /**< HUM 40.2 BST.TENDF,   p 2482 */
  k_ra_i3c_i2c_bst_alf_pos     = 16U, /**< HUM 40.2 BST.ALF,     p 2482 */
  k_ra_i3c_i2c_bst_todf_pos    = 20U, /**< HUM 40.2 BST.TODF,    p 2482 */
} ra_i3c_i2c_bst_t;

/**
 * @enum ra_i3c_i2c_ntst_t
 * @brief NTST (Normal Transfer Status) field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_ntst_tdbef0_pos = 0U, /**< HUM 40.2 NTST.TDBEF0, p 2486 */
  k_ra_i3c_i2c_ntst_rdbff0_pos = 1U, /**< HUM 40.2 NTST.RDBFF0, p 2486 */
} ra_i3c_i2c_ntst_t;

/**
 * @enum ra_i3c_i2c_ntie_t
 * @brief NTIE (Normal Transfer Interrupt Enable) field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_ntie_tdbeie0_pos = 0U, /**< HUM 40.2 NTIE.TDBEIE0, p 2488 */
  k_ra_i3c_i2c_ntie_rdbfie0_pos = 1U, /**< HUM 40.2 NTIE.RDBFIE0, p 2488 */
} ra_i3c_i2c_ntie_t;

/**
 * @enum ra_i3c_i2c_bie_t
 * @brief BIE (Bus Interrupt Enable) field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_bie_nackdie_pos = 4U,  /**< HUM 40.2 BIE.NACKDIE, p 2484 */
  k_ra_i3c_i2c_bie_tendie_pos  = 8U,  /**< HUM 40.2 BIE.TENDIE,  p 2484 */
  k_ra_i3c_i2c_bie_alie_pos    = 16U, /**< HUM 40.2 BIE.ALIE,    p 2484 */
  k_ra_i3c_i2c_bie_todie_pos   = 20U, /**< HUM 40.2 BIE.TODIE,   p 2484 */
} ra_i3c_i2c_bie_t;

/**
 * @enum ra_i3c_i2c_bcst_t
 * @brief BCST (Bus Condition Status) field positions.
 */
typedef enum : uint8_t {
  k_ra_i3c_i2c_bcst_bfref_pos = 0U, /**< HUM 40.2 BCST.BFREF, p 2491 */
} ra_i3c_i2c_bcst_t;
...
static inline volatile r_i3c_i2c_regs_t* i3c_i2c_regs(uint8_t channel)
{
  ...
  return (volatile r_i3c_i2c_regs_t*)k_ra_i3c_i2c0_base_addr;
}
