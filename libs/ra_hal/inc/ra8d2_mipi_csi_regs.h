 ...
 * ``ra8d2_glcdc_regs.h`` (alongside its display-block siblings
 * GLCDC, MIPI DSI, MIPI PHY, CEU) so all four display peripherals
 * share one address enum. We re-use ``k_ra_mipi_csi_base_addr``
...
#include "ra8d2_glcdc_regs.h" /* for k_ra_mipi_csi_base_addr */

/**
 * @enum ra_mipi_csi_off_t
 ...
 * DLST0 / DLSC0 / DLIE0. Helpers ``ra_mipi_csi_vc_off()`` and
 * ``ra_mipi_csi_dl_off()`` below compute the offsets safely.
 */
typedef enum : uint16_t {
  ...
  k_ra_mipi_csi_off_gsst = 0x284U, /**< Generic Short Packet Status.      */
  k_ra_mipi_csi_off_gssc = 0x288U, /**< Generic Short Packet Stat Clear.  */
  k_ra_mipi_csi_off_gsie = 0x28CU, /**< Generic Short Packet IRQ Enable.  */
  k_ra_mipi_csi_off_gsht = 0x290U, /**< Generic Short Packet Header (RO). */
  k_ra_mipi_csi_off_gsiu = 0x294U, /**< Generic Short Packet Info Update. */
} ra_mipi_csi_off_t;

/**
 * @enum ra_mipi_csi_limits_t
...
/**
 * @enum ra_mipi_csi_dt_low_bits_t
...
/**
 * @enum ra_mipi_csi_dt_high_bits_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_csi_rxst_frm_mask     = 0x0000FFFFUL, /**< [15:0] FRMn flags. */
  k_ra_mipi_csi_rxst_ract_mask    = 0x00010000UL, /**< [16] RX active.    */
  k_ra_mipi_csi_rxst_ractdet_mask = 0x00020000UL, /**< [17] RX detected.  */
} ra_mipi_csi_rxst_bits_t;

/**
 * @enum ra_mipi_csi_rxsc_bits_t
 * @brief RXSC (Receive Status Clear) -- write 1 to clear RACTDET.
 * @details HUM Ch 66.3.13 p 3945.
 */
typedef enum : uint32_t {
  k_ra_mipi_csi_rxsc_ractdetc_mask = 0x00020000UL, /**< [17] clear RXDET. */
} ra_mipi_csi_rxsc_bits_t;

/**
 * @enum ra_mipi_csi_rxie_bits_t
...
} ra_mipi_csi_vcst_bits_t;

/**
 * @enum ra_mipi_csi_vcsc_bits_t
...
/**
 * @enum ra_mipi_csi_vcie_bits_t
 * @brief VCIE(M) (Virtual Channel M Interrupt Enable) bits.
 * @details HUM Ch 66.3.20 p 3952-3953. Bit positions match VCST.
 */
typedef enum : uint32_t {
  k_ra_mipi_csi_vcie_mlfe_mask = 0x00000001UL, /**< [0]  MLF IRQ enable. */
  k_ra_mipi_csi_vcie_ecde_mask = 0x00000002UL, /**< [1]  ECD IRQ enable. */
  k_ra_mipi_csi_vcie_crce_mask = 0x00000004UL, /**< [2]  CRC IRQ enable. */
  k_ra_mipi_csi_vcie_idee_mask = 0x00000008UL, /**< [3]  IDE IRQ enable. */
  k_ra_mipi_csi_vcie_wcee_mask = 0x00000010UL, /**< [4]  WCE IRQ enable. */
  k_ra_mipi_csi_vcie_ecce_mask = 0x00000020UL, /**< [5]  ECC IRQ enable. */
  k_ra_mipi_csi_vcie_ecne_mask = 0x00000040UL, /**< [6]  ECN IRQ enable. */
  k_ra_mipi_csi_vcie_frse_mask = 0x00000100UL, /**< [8]  FRS IRQ enable. */
  k_ra_mipi_csi_vcie_frde_mask = 0x00000200UL, /**< [9]  FRD IRQ enable. */
  k_ra_mipi_csi_vcie_ovfe_mask = 0x00010000UL, /**< [16] OVF IRQ enable. */
  k_ra_mipi_csi_vcie_fsre_mask = 0x01000000UL, /**< [24] FSR IRQ enable. */
  k_ra_mipi_csi_vcie_fere_mask = 0x02000000UL, /**< [25] FER IRQ enable. */
  k_ra_mipi_csi_vcie_lsre_mask = 0x04000000UL, /**< [26] LSR IRQ enable. */
  k_ra_mipi_csi_vcie_lere_mask = 0x08000000UL, /**< [27] LER IRQ enable. */
  k_ra_mipi_csi_vcie_etre_mask = 0x10000000UL, /**< [28] ETR IRQ enable. */
  k_ra_mipi_csi_vcie_all_mask  = 0x1F01037FUL, /**< Enable everything.   */
} ra_mipi_csi_vcie_bits_t;

/**
 * @enum ra_mipi_csi_pmst_bits_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_csi_gsct_shth_mask  = 0x0000007FUL, /**< [6:0] threshold.     */
  k_ra_mipi_csi_gsct_shth_shift = 0U,           /**< SHTH shift.          */
  k_ra_mipi_csi_gsct_gfif_mask  = 0x00010000UL, /**< [16] FIFO store en.  */
  k_ra_mipi_csi_gsct_shth_max   = 0x0FUL,       /**< Max meaningful SHTH. */
} ra_mipi_csi_gsct_bits_t;

/**
 * @enum ra_mipi_csi_gsst_bits_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_csi_gsiu_finc_mask  = 0x00000001UL, /**< [0]  FIFO increment. */
  k_ra_mipi_csi_gsiu_gfclr_mask = 0x00000100UL, /**< [8]  FIFO clear req. */
  k_ra_mipi_csi_gsiu_gfen_mask  = 0x00010000UL, /**< [16] FIFO re-enable. */
} ra_mipi_csi_gsiu_bits_t;
 ...
 * heap memory.
 *
 * @param[in] off One of the ``k_ra_mipi_csi_off_*`` enum values.
 * @return Volatile 32-bit pointer to the register.
 */
static inline volatile uint32_t* ra_mipi_csi_reg32(ra_mipi_csi_off_t off)
{
  return (volatile uint32_t*)(k_ra_mipi_csi_base_addr + (uint16_t)off);
}

/**
 * @brief Compute the byte offset of a per-virtual-channel register.
 *
 * @param[in] base One of ``k_ra_mipi_csi_off_vcst0`` /
 *                 ``k_ra_mipi_csi_off_vcsc0`` /
 *                 ``k_ra_mipi_csi_off_vcie0`` (caller chooses status,
 ...
 *
 * @param[in] base One of ``k_ra_mipi_csi_off_dlst0`` /
 *                 ``k_ra_mipi_csi_off_dlsc0`` /
 *                 ``k_ra_mipi_csi_off_dlie0``.
