 ...
 * `ra_mipi_dsi_types.h` (enums / structs / typedefs) and
 * `ra_mipi_dsi_api.h` (function prototypes). Consumers keep including
 * `ra_mipi_dsi.h` unchanged; everything is re-exported below.
 *
...
#include "ra_mipi_dsi_api.h"
#include "ra_mipi_dsi_types.h"
