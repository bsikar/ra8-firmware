...
typedef enum : uintptr_t {
  k_ra_mrms_base_addr = 0x4013C000UL, /**< R_MRMS base. */
} ra_mrms_addr_t;
...
typedef enum : uint32_t {
  k_ra_mrcfreq_key = 0x1E000000UL, /**< MRCFREQ unlock key, upper byte = 0x1E. */
  k_ra_mrefreq_key = 0xE1000000UL, /**< MREFREQ unlock key, upper byte = 0xE1. */
} ra_mrms_key_t;
 ...
 */
typedef enum : uint32_t {
  k_ra_mrcpfb_threshold_mhz = 100UL, /**< Minimum MRICLK MHz to enable PFB. */
} ra_mrms_pfb_threshold_t;
 ...
 * @since 0.1.0
 */
static inline volatile uint32_t* ra_mrms_mrcpfb(void)
{
  return (volatile uint32_t*)(k_ra_mrms_base_addr + k_ra_mrms_off_mrcpfb);
}
 ...
 * @since 0.1.0
 */
static inline volatile uint32_t* ra_mrms_mrcfreq(void)
{
  return (volatile uint32_t*)(k_ra_mrms_base_addr + k_ra_mrms_off_mrcfreq);
}
 ...
 * @since 0.1.0
 */
static inline volatile uint32_t* ra_mrms_mrefreq(void)
{
  return (volatile uint32_t*)(k_ra_mrms_base_addr + k_ra_mrms_off_mrefreq);
}
