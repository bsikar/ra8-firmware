 ...
 * is split out of ``ra_flash.h`` (the thin umbrella) and holds every
 ...
 * function-prototype sub-headers (``ra_flash_core.h`` and
 * ``ra_flash_fsp.h``) and, transitively, by the ``ra_flash.h`` umbrella
