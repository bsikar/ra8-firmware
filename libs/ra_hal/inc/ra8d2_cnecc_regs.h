...
typedef enum : uintptr_t {
  k_ra_cnecc0_base_addr = 0x4036F200UL, /**< ECCMB0 (CAN0 MRAM). */
  k_ra_cnecc1_base_addr = 0x4036F300UL, /**< ECCMB1 (CAN1 MRAM). */
} ra_cnecc_addr_t;

/**
 * @enum ra_cnecc_limits_t
 ...
 */
typedef enum : uint8_t {
  k_ra_cnecc_bit_ecdcs  = 1U,  /**< ECDCS decoder input source (R/W). */
  k_ra_cnecc_bit_ectmce = 7U,  /**< ECTMCE test-mode enable (R/W).    */
  k_ra_cnecc_bit_etma0  = 14U, /**< ETMA[1:0] write-trigger lo.       */
  k_ra_cnecc_bit_etma1  = 15U, /**< ETMA[1:0] write-trigger hi.       */
} ra_cnecc_tmc_bit_t;

/**
 * @enum ra_cnecc_tmc_mask_t
...
static inline volatile r_cnecc_regs_t* ra_cnecc(uint8_t instance)
{
  ...
  const uintptr_t base =
    k_ra_cnecc0_base_addr + ((uintptr_t)instance * (uintptr_t)k_ra_cnecc_stride);
