 ...
 * sub-header is split out of ``ra_flash.h`` (the thin umbrella) and holds
 ...
 * ``ra_flash_core.h`` and share its DANGEROUS / brick-capable warnings,
 * documented on the ``ra_flash.h`` umbrella ``@file`` banner.
 *
