 ...
 * The full SYSC layout is described in ``ra8d2_system_regs.h``; this
 ...
 *
 * @details
 * Same physical base as ``k_ra_system_base_addr`` -- the BAT*
...
typedef enum : uintptr_t {
  k_ra_bkup_base_addr = 0x4001E000UL, /**< SYSC + battery backup base. */
} ra_bkup_addr_t;
...
/**
 * @enum ra_bkup_vbtber_bit_t
 * @brief Bit positions inside VBTBER (HUM Ch 12.2.6 p 504).
 */
typedef enum : uint8_t {
  k_ra_bkup_vbtber_bit_vbae = 3U, /**< VBAE: VBTBKRn access enable. */
} ra_bkup_vbtber_bit_t;

/**
 * @enum ra_bkup_vbtber_mask_t
 * @brief Single-bit masks for VBTBER fields.
 */
typedef enum : uint8_t {
  k_ra_bkup_vbtber_mask_vbae = 0x08U, /**< VBAE @ bit 3. */
} ra_bkup_vbtber_mask_t;

/**
 * @enum ra_bkup_vbtbpcr1_bit_t
 * @brief Bit positions inside VBTBPCR1 (HUM Ch 12.2.11 p 507).
 */
typedef enum : uint8_t {
  k_ra_bkup_vbtbpcr1_bit_bpwswstp = 0U, /**< Battery power-supply switch stop. */
} ra_bkup_vbtbpcr1_bit_t;

/** @brief Single-bit masks for VBTBPCR1. */
typedef enum : uint8_t {
  k_ra_bkup_vbtbpcr1_mask_bpwswstp = 0x01U, /**< BPWSWSTP @ bit 0. */
} ra_bkup_vbtbpcr1_mask_t;

/**
 * @enum ra_bkup_vbtbpcr2_bit_t
 * @brief Bit positions inside VBTBPCR2 (HUM Ch 12.2.12 p 508).
 */
typedef enum : uint8_t {
  k_ra_bkup_vbtbpcr2_bit_vdete = 4U, /**< VDETE: VCC drop-detection enable. */
  k_ra_bkup_vbtbpcr2_shift_lvl = 0U, /**< VDETLVL[2:0] @ [2:0].             */
} ra_bkup_vbtbpcr2_bit_t;
...
typedef enum : uint8_t {
  k_ra_bkup_vbtbpsr_mask_vbporf = 0x01U, /**< VBATT_POR flag. */
  k_ra_bkup_vbtbpsr_mask_vbporm = 0x10U, /**< VBATT_R OK.     */
  k_ra_bkup_vbtbpsr_mask_swm    = 0x20U, /**< Switch monitor. */
} ra_bkup_vbtbpsr_mask_t;

/** @brief Single-bit masks for VBATTMNSELR (HUM Ch 12.2.5 p 503). */
typedef enum : uint8_t {
  k_ra_bkup_vbattmnselr_mask_vbtmnsel = 0x01U, /**< VBTMNSEL @ bit 0. */
} ra_bkup_vbattmnselr_mask_t;

/** @brief Single-bit masks for VBTADSR tamper-detection flags (HUM Ch 12.2.14 p 510). */
typedef enum : uint8_t {
  k_ra_bkup_vbtadsr_mask_vbtadf0 = 0x01U, /**< VBTADF0: RTCIC0 event. */
  k_ra_bkup_vbtadsr_mask_vbtadf1 = 0x02U, /**< VBTADF1: RTCIC1 event. */
  k_ra_bkup_vbtadsr_mask_vbtadf2 = 0x04U, /**< VBTADF2: RTCIC2 event. */
  k_ra_bkup_vbtadsr_mask_all     = 0x07U, /**< Combined VBTADF[2:0].  */
} ra_bkup_vbtadsr_mask_t;

/** @brief Bit masks for VBTADCR1 (HUM Ch 12.2.15 p 510). */
typedef enum : uint8_t {
  k_ra_bkup_vbtadcr1_mask_vbtadie0 = 0x01U, /**< VBTADIE0 @ bit 0. */
  k_ra_bkup_vbtadcr1_mask_vbtadie1 = 0x02U, /**< VBTADIE1 @ bit 1. */
  k_ra_bkup_vbtadcr1_mask_vbtadie2 = 0x04U, /**< VBTADIE2 @ bit 2. */
  k_ra_bkup_vbtadcr1_mask_vbtadce0 = 0x10U, /**< VBTADCE0 @ bit 4. */
  k_ra_bkup_vbtadcr1_mask_vbtadce1 = 0x20U, /**< VBTADCE1 @ bit 5. */
  k_ra_bkup_vbtadcr1_mask_vbtadce2 = 0x40U, /**< VBTADCE2 @ bit 6. */
  k_ra_bkup_vbtadcr1_mask_ie_all   = 0x07U, /**< All IE bits.      */
  k_ra_bkup_vbtadcr1_mask_ce_all   = 0x70U, /**< All CE bits.      */
} ra_bkup_vbtadcr1_mask_t;
...
typedef enum : uint8_t {
  k_ra_bkup_vbtadcr3_mask_vbtadze0 = 0x01U, /**< VBTADZE0 @ bit 0. */
  k_ra_bkup_vbtadcr3_mask_vbtadze1 = 0x02U, /**< VBTADZE1 @ bit 1. */
  k_ra_bkup_vbtadcr3_mask_vbtadze2 = 0x04U, /**< VBTADZE2 @ bit 2. */
  k_ra_bkup_vbtadcr3_mask_all      = 0x07U, /**< All zeroize bits. */
} ra_bkup_vbtadcr3_mask_t;
...
typedef enum : uint8_t {
  k_ra_bkup_vbtimonr_mask_vch0mon = 0x01U, /**< VCH0MON @ bit 0. */
  k_ra_bkup_vbtimonr_mask_vch1mon = 0x02U, /**< VCH1MON @ bit 1. */
  k_ra_bkup_vbtimonr_mask_vch2mon = 0x04U, /**< VCH2MON @ bit 2. */
  k_ra_bkup_vbtimonr_mask_all     = 0x07U, /**< All MON bits.    */
} ra_bkup_vbtimonr_mask_t;

/** @brief Bit masks for VBTNCWCR (HUM Ch 12.2.18 p 511). */
typedef enum : uint8_t {
  k_ra_bkup_vbtncwcr_mask_vincw = 0x07U, /**< VINCW[2:0] @ [2:0]. */
} ra_bkup_vbtncwcr_mask_t;
...
/* =============================================================================
 * Inline accessor functions (mirrors style of ra8d2_system_regs.h)
 * =============================================================================
 */

/** @brief Pointer to 8-bit VBATTMNSELR (HUM Ch 12.2.5 p 503). */
static inline volatile uint8_t* ra_bkup_vbattmnselr(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbattmnselr);
}

/** @brief Pointer to 8-bit VBTBPCR1 (HUM Ch 12.2.11 p 507). */
static inline volatile uint8_t* ra_bkup_vbtbpcr1(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtbpcr1);
}

/** @brief Pointer to 8-bit VBTBER (HUM Ch 12.2.6 p 504). */
static inline volatile uint8_t* ra_bkup_vbtber(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtber);
}

/** @brief Pointer to 8-bit VBTBPCR2 (HUM Ch 12.2.12 p 508). */
static inline volatile uint8_t* ra_bkup_vbtbpcr2(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtbpcr2);
}

/** @brief Pointer to 8-bit VBTBPSR (HUM Ch 12.2.13 p 509). */
static inline volatile uint8_t* ra_bkup_vbtbpsr(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtbpsr);
}

/** @brief Pointer to 8-bit VBTADSR (HUM Ch 12.2.14 p 509). */
static inline volatile uint8_t* ra_bkup_vbtadsr(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtadsr);
}

/** @brief Pointer to 8-bit VBTADCR1 (HUM Ch 12.2.15 p 510). */
static inline volatile uint8_t* ra_bkup_vbtadcr1(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtadcr1);
}

/** @brief Pointer to 8-bit VBTADCR2 (HUM Ch 12.2.16 p 511). */
static inline volatile uint8_t* ra_bkup_vbtadcr2(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtadcr2);
}

/** @brief Pointer to 8-bit VBTADCR3 (HUM Ch 12.2.17 p 511). */
static inline volatile uint8_t* ra_bkup_vbtadcr3(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtadcr3);
}

/** @brief Pointer to 8-bit VBTICTLR (HUM Ch 12.2.8 p 505). */
static inline volatile uint8_t* ra_bkup_vbtictlr(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtictlr);
}

/** @brief Pointer to 8-bit VBTICTLR2 (HUM Ch 12.2.9 p 506). */
static inline volatile uint8_t* ra_bkup_vbtictlr2(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtictlr2);
}

/** @brief Pointer to 8-bit VBTIMONR (HUM Ch 12.2.10 p 506). */
static inline volatile uint8_t* ra_bkup_vbtimonr(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtimonr);
}

/** @brief Pointer to 8-bit VBTNCWCR (HUM Ch 12.2.18 p 511). */
static inline volatile uint8_t* ra_bkup_vbtncwcr(void)
{
  return (volatile uint8_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbtncwcr);
}

/** @brief Pointer to 32-bit BBFSAR (HUM Ch 12.2.1 p 500). */
static inline volatile uint32_t* ra_bkup_bbfsar(void)
{
  return (volatile uint32_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_bbfsar);
}

/** @brief Pointer to 16-bit VBRSABAR (HUM Ch 12.2.2 p 502). */
static inline volatile uint16_t* ra_bkup_vbrsabar(void)
{
  return (volatile uint16_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbrsabar);
}

/** @brief Pointer to 16-bit VBRPABARS (HUM Ch 12.2.3 p 502). */
static inline volatile uint16_t* ra_bkup_vbrpabars(void)
{
  return (volatile uint16_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbrpabars);
}

/** @brief Pointer to 16-bit VBRPABARNS (HUM Ch 12.2.4 p 503). */
static inline volatile uint16_t* ra_bkup_vbrpabarns(void)
{
  return (volatile uint16_t*)(k_ra_bkup_base_addr + k_ra_bkup_off_vbrpabarns);
}
...
static inline volatile uint8_t* ra_bkup_vbtbkr(uint16_t index)
{
  ...
  return (volatile uint8_t*)(k_ra_bkup_base_addr + (uintptr_t)k_ra_bkup_off_vbtbkr0 +
                             ((uintptr_t)index * (uintptr_t)k_ra_bkup_reg_stride));
}
...
static inline volatile uint32_t* ra_bkup_vbtbkr_word(uint8_t word_index)
{
  ...
  return (volatile uint32_t*)(k_ra_bkup_base_addr + (uintptr_t)k_ra_bkup_off_vbtbkr0 +
                              ((uintptr_t)word_index * (uintptr_t)k_ra_bkup_word_stride));
}
