 ...
 * consumer that `#include "ra_ceu.h"` continues to see the full API:
 *  - @ref ra_ceu_types.h -- configuration descriptors, enums,
 *    register-bundle structs, status snapshot, event-callback typedef.
 *  - @ref ra_ceu_api.h -- lifecycle, status/IRQ, power, capture,
...
#include "ra_ceu_api.h"
#include "ra_ceu_types.h"
#include "ra_err.h"
