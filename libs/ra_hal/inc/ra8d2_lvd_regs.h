 ...
 *
 * Offsets in ::ra_lvd_off_t are stored as absolute addresses (the
 ...
 * `ra_lvd_reg8` / `ra_lvd_reg32` accessor functions reduce to a single
...
typedef enum : uintptr_t {
  /* PVD1 -- m series. */
  k_ra_lvd_pvd1_cr1_off   = 0x4001E0E0UL, /**< PVD1CR1.   HUM 8.2.6 p 307 */
  k_ra_lvd_pvd1_sr_off    = 0x4001E0E1UL, /**< PVD1SR.    HUM 8.2.7 p 307 */
  k_ra_lvd_pvd1_cmpcr_off = 0x4001EA58UL, /**< PVD1CMPCR. HUM 8.2.2 p 303 */
  k_ra_lvd_pvd1_cr0_off   = 0x4001EA70UL, /**< PVD1CR0.   HUM 8.2.4 p 305 */
  k_ra_lvd_pvd1_fcr_off   = 0x4001EB20UL, /**< PVD1FCR.   HUM 8.2.8 p 308 */
  /* PVD2 -- m series. */
  k_ra_lvd_pvd2_cr1_off   = 0x4001E0E2UL, /**< PVD2CR1.   HUM 8.2.6 p 307 */
  k_ra_lvd_pvd2_sr_off    = 0x4001E0E3UL, /**< PVD2SR.    HUM 8.2.7 p 307 */
  k_ra_lvd_pvd2_cmpcr_off = 0x4001EA5CUL, /**< PVD2CMPCR. HUM 8.2.2 p 303 */
  k_ra_lvd_pvd2_cr0_off   = 0x4001EA74UL, /**< PVD2CR0.   HUM 8.2.4 p 305 */
  k_ra_lvd_pvd2_fcr_off   = 0x4001EB24UL, /**< PVD2FCR.   HUM 8.2.8 p 308 */
  /* PVD4 -- n series (no CR1, no SR). */
  k_ra_lvd_pvd4_cmpcr_off = 0x4001EA64UL, /**< PVD4CMPCR. HUM 8.2.3 p 304 */
  k_ra_lvd_pvd4_cr0_off   = 0x4001EA7CUL, /**< PVD4CR0.   HUM 8.2.5 p 306 */
  k_ra_lvd_pvd4_fcr_off   = 0x4001EB2CUL, /**< PVD4FCR.   HUM 8.2.9 p 309 */
  /* PVD5 -- n series (no CR1, no SR). */
  k_ra_lvd_pvd5_cmpcr_off = 0x4001EA68UL, /**< PVD5CMPCR. HUM 8.2.3 p 304 */
  k_ra_lvd_pvd5_cr0_off   = 0x4001EA80UL, /**< PVD5CR0.   HUM 8.2.5 p 306 */
 ...
 */
typedef enum : uint8_t {
  k_ra_lvd_cr0_shift_fsamp = 4U, /**< FSAMP[1:0] starts at bit 4. */
} ra_lvd_cr0_shift_t;

/**
 * @enum ra_lvd_cr1_mask_t
 ...
 */
typedef enum : uint8_t {
  k_ra_lvd_fcr_mask_rhsel = 0x01U, /**< RHSEL hysteresis-band selector. */
} ra_lvd_fcr_mask_t;
...
typedef enum : uint32_t {
  k_ra_lvd_pvdsar_mask_nonsec0 = 0x00000001UL, /**< NONSEC0: PVD1 -> NS. */
  k_ra_lvd_pvdsar_mask_nonsec1 = 0x00000002UL, /**< NONSEC1: PVD2 -> NS. */
  k_ra_lvd_pvdsar_mask_all     = 0x00000003UL, /**< Both PVD1 + PVD2 NS. */
} ra_lvd_pvdsar_mask_t;

/**
 * @enum ra_lvd_filter_const_t
 * @brief Constants used by `ra_lvd_filter_delay_us`.
 *
 * @details
...
/**
 * @enum ra_lvd_misc_const_t
 * @brief Miscellaneous PVD constants.
 *
 * @details
 * `k_ra_lvd_nmi_channel_count` is the number of monitor m channels
 ...
 * uses ::ra_lvd_reg32).
 *
 * @param[in] off Register offset constant from ::ra_lvd_off_t.
 * @return Volatile pointer to the register byte.
 *
 * @pre `off` is one of the enum values in ::ra_lvd_off_t.
 ...
 *
 * @details
 * Currently only ::k_ra_lvd_pvdsar_off is read or written via this
 * accessor (HUM Ch 8.2.1 "PVDSAR" p 302). Other PVD registers are
 * 8-bit and use ::ra_lvd_reg8.
 *
 * @param[in] off Register offset constant from ::ra_lvd_off_t.
