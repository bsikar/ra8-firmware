 ...
 * the interrupt path. Split out of ra_lvd.h so the public umbrella
 * header stays under the per-file line budget; the umbrella ra_lvd.h
 * re-includes this header, so consumers are unaffected.
 *
 * See ra_lvd.h for the driver overview and HUM Ch 8 "Programmable
