 ...
 * descriptor `ra_vin_config_t`, the pre-clip / UDS-scale / UDS-ctrl
 ...
 * that consume these types live in `ra_vin_api.h`; both are aggregated
 * by the thin umbrella `ra_vin.h`. See that umbrella for the full
