...
static_assert(sizeof(r_rtc_regs_t) == (size_t)k_ra_rtc_layout_size,
              "r_rtc_regs_t must be 128 bytes");
static_assert(offsetof(r_rtc_regs_t, RCR1) == (size_t)k_ra_rtc_layout_off_rcr1, "RCR1 at +0x22");
static_assert(offsetof(r_rtc_regs_t, RCR2) == (size_t)k_ra_rtc_layout_off_rcr2, "RCR2 at +0x24");
static_assert(offsetof(r_rtc_regs_t, RCR4) == (size_t)k_ra_rtc_layout_off_rcr4, "RCR4 at +0x28");
static_assert(offsetof(r_rtc_regs_t, RFRH) == (size_t)k_ra_rtc_layout_off_rfrh, "RFRH at +0x2A");
static_assert(offsetof(r_rtc_regs_t, RADJ) == (size_t)k_ra_rtc_layout_off_radj, "RADJ at +0x2E");
static_assert(offsetof(r_rtc_regs_t, RTCCR) == (size_t)k_ra_rtc_layout_off_rtccr, "RTCCR at +0x40");
static_assert(offsetof(r_rtc_regs_t, CP) == (size_t)k_ra_rtc_layout_off_cp, "CP at +0x50");
...
typedef enum : uint8_t {
  ...
  k_ra_rcr1_bit_rtcos  = 3U, /**< RTCOUT output select.              */
  k_ra_rcr1_bit_pes_lo = 4U, /**< PES[3:0] periodic select (b4..b7). */
} ra_rcr1_bit_t;
