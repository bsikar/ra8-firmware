 ...
 *
 * - ``ra_mipi_phy_types.h`` -- typed enums, register-mirror structs,
 * and the status-callback typedef.
 * - ``ra_mipi_phy_api.h`` -- lifecycle, status, interrupt-path, and
 * power-transition prototypes.
 * - ``ra_mipi_phy_ops.h`` -- runtime operations prototypes.
 *
 * Consumers continue to ``#include "ra_mipi_phy.h"`` unchanged.
 *
...
#include "ra_mipi_phy_api.h"
#include "ra_mipi_phy_ops.h"
#include "ra_mipi_phy_types.h"
