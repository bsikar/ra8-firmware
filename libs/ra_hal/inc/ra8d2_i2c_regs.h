 ...
 *
 * @invariant ``k_ra_i2c_channel_stride`` separates consecutive channels.
 */
typedef enum : uintptr_t {
  k_ra_i2c0_base_addr     = 0x4025E000UL, /**< HUM Ch 39.2.1, p 2369 */
  k_ra_i2c_channel_stride = 0x00000100UL, /**< HUM Ch 39.2.1, p 2369 */
} ra_i2c_addr_t;

/**
 * @enum ra_i2c_limits_t
...
static_assert(sizeof(r_i2c_regs_t) == (size_t)k_ra_i2c_regs_block_bytes,
 ...
 *
 * @pre ``ra_mstp_enable(k_ra_mstp_iicN)`` has been called for the channel.
 * @post Returned pointer is ``nullptr`` or aliases
 *       ``k_ra_i2c0_base_addr + channel * k_ra_i2c_channel_stride``.
 *
 ...
 * @since 0.1.0
 */
static inline volatile r_i2c_regs_t* ra_i2c_regs(uint8_t channel)
{
  if ((uint16_t)channel >= (uint16_t)k_ra_i2c_channel_count) {
    return nullptr;
  }
  const uintptr_t base =
    (uintptr_t)k_ra_i2c0_base_addr + ((uintptr_t)channel * (uintptr_t)k_ra_i2c_channel_stride);
