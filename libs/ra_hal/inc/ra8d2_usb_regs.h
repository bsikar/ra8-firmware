 ...
 *
 * @details Read these as `(INTSTS0 & k_ra_intsts0_mask_dvsq) ==
 * <value>`.
 */
typedef enum : uint16_t {
...
typedef enum : uint16_t {
  ...
  k_ra_fifosel_mbw_32  = 0x0800U, /**< 32-bit FIFO access width.   */
  k_ra_fifosel_mbw_msk = 0x0C00U, /**< MBW field mask.             */
  k_ra_fifosel_dreqe   = 0x1000U, /**< DREQ enable (DMA).          */
  k_ra_fifosel_dclrm   = 0x2000U, /**< Auto FIFO clear mode.       */
  k_ra_fifosel_rew     = 0x4000U, /**< Buffer rewind.              */
  k_ra_fifosel_rcnt    = 0x8000U, /**< Read count mode.            */
} ra_usb_fifosel_field_t;
...
/**
 * @enum ra_usb_pipecfg_field_t
 * @brief PIPECFG field masks / shifts used by the driver.
 */
typedef enum : uint16_t {
  k_ra_pipecfg_epnum_mask = 0x000FU, /**< Endpoint number [3:0].   */
  k_ra_pipecfg_dir_in     = 0x0010U, /**< 1 = IN, 0 = OUT (peri).  */
  k_ra_pipecfg_shtnak     = 0x0080U, /**< Auto NAK on short pkt.   */
  k_ra_pipecfg_dblb       = 0x0200U, /**< Double-buffer mode.      */
  k_ra_pipecfg_bfre       = 0x0400U, /**< BRDY notify on read end. */
  k_ra_pipecfg_type_bulk  = 0x4000U, /**< Type = bulk.             */
  k_ra_pipecfg_type_intr  = 0x8000U, /**< Type = interrupt.        */
  k_ra_pipecfg_type_iso   = 0xC000U, /**< Type = isochronous.      */
  k_ra_pipecfg_type_mask  = 0xC000U, /**< Type field mask.         */
