...
typedef enum : uintptr_t {
  k_ra_drw_base_addr    = 0x40444000UL, /**< DRW Secure base.     */
  k_ra_drw_ns_base_addr = 0x50444000UL, /**< DRW Non-Secure base. */
} ra_drw_addr_t;
...
/**
 * @enum ra_drw_blocksize_t
 * @brief Total DRW window size, used by static-assert clients.
 */
typedef enum : uint16_t {
  k_ra_drw_block_bytes = 0x104U, /**< 260 bytes -- matches FSP R_DRW_Type. */
} ra_drw_blocksize_t;
...
typedef enum : uint32_t {
  k_ra_drw_status_busyenum     = (1UL << 0U),  /**< Enumeration unit busy.     */
  k_ra_drw_status_busywrite    = (1UL << 1U),  /**< FB writeback busy.         */
  k_ra_drw_status_cachedirty   = (1UL << 2U),  /**< FB cache dirty.            */
  k_ra_drw_status_dlistactive  = (1UL << 3U),  /**< Display list reader busy.  */
  k_ra_drw_status_enumirq      = (1UL << 4U),  /**< Enumeration finished IRQ.  */
  k_ra_drw_status_dlistirq     = (1UL << 5U),  /**< Display list finished IRQ. */
  k_ra_drw_status_busirq       = (1UL << 6U),  /**< Bus error IRQ.             */
  k_ra_drw_status_buserrmfb    = (1UL << 8U),  /**< FB bus error.              */
 ...
 */
typedef enum : uint32_t {
  k_ra_drw_hwrev_rev_mask    = 0x00000FFFUL, /**< REV[11:0].             */
  k_ra_drw_hwrev_dlr         = (1UL << 17U), /**< Display list reader.   */
  k_ra_drw_hwrev_fbcache     = (1UL << 18U), /**< FB cache present.      */
  k_ra_drw_hwrev_txcache     = (1UL << 19U), /**< Texture cache present. */
  k_ra_drw_hwrev_perfcount   = (1UL << 20U), /**< 2 perf counters.       */
  k_ra_drw_hwrev_texclut     = (1UL << 21U), /**< Texture CLUT present.  */
  k_ra_drw_hwrev_rleunit     = (1UL << 23U), /**< RLE unit present.      */
  k_ra_drw_hwrev_texclut256  = (1UL << 24U), /**< CLUT is 256 entries.   */
  k_ra_drw_hwrev_colorkey    = (1UL << 25U), /**< Color key unit.        */
  k_ra_drw_hwrev_acblend     = (1UL << 27U), /**< Full alpha blend.      */
  k_ra_drw_hwrev_reset_value = 0x1FBE0017UL, /**< Power-on value.        */
} ra_drw_hwrev_mask_t;
 ...
 */
typedef enum : uint8_t {
  k_ra_drw_rle_1byte = 0U, /**< 1 byte per texel  (8-bit CLUT/I/A/ACLUT44). */
  k_ra_drw_rle_2byte = 1U, /**< 2 bytes per texel (16-bit RGB565/ARGB).     */
  k_ra_drw_rle_3byte = 2U, /**< 3 bytes per texel (24-bit RGB888).          */
  k_ra_drw_rle_4byte = 3U, /**< 4 bytes per texel (32-bit ARGB8888).        */
} ra_drw_rlepixel_t;
 ...
 */
typedef enum : uint16_t {
  k_ra_drw_perfev_disabled       = 0x0000U, /**< Disable counter.            */
  k_ra_drw_perfev_active_cycles  = 0x0001U, /**< 2D engine active cycles.    */
  k_ra_drw_perfev_fb_read        = 0x0002U, /**< FB read access count.       */
  k_ra_drw_perfev_fb_write       = 0x0003U, /**< FB write access count.      */
  k_ra_drw_perfev_tex_read       = 0x0004U, /**< Texture read accesses.      */
  k_ra_drw_perfev_invisible      = 0x0005U, /**< Invisible (alpha 0) pixels. */
  k_ra_drw_perfev_invisible_idle = 0x0006U, /**< Invisible while FIFO empty. */
  k_ra_drw_perfev_dlist_active   = 0x0007U, /**< Display list reader active. */
  k_ra_drw_perfev_fb_read_hit    = 0x0008U, /**< FB cache read hits.         */
  k_ra_drw_perfev_fb_read_miss   = 0x0009U, /**< FB cache read misses.       */
  k_ra_drw_perfev_fb_write_hit   = 0x000AU, /**< FB cache write hits.        */
  k_ra_drw_perfev_fb_write_miss  = 0x000BU, /**< FB cache write misses.      */
  k_ra_drw_perfev_tex_read_hit   = 0x000CU, /**< Texture cache read hits.    */
  k_ra_drw_perfev_tex_read_miss  = 0x000DU, /**< Texture cache read misses.  */
  k_ra_drw_perfev_every_cycle    = 0x001FU, /**< Free-running timer mode.    */
} ra_drw_perftrigger_t;

/**
 * @enum ra_drw_perfcounter_id_t
 ...
 */
typedef enum : uint8_t {
  k_ra_drw_size_height_pos      = 16U, /**< SIZEY in upper half-word.    */
  k_ra_drw_pitch_ssd_pos        = 16U, /**< SSD in upper half-word.      */
  k_ra_drw_perftrigger2_pos     = 16U, /**< Counter-2 selector pos.      */
  k_ra_drw_color_b_pos          = 0U,  /**< COLORnB[7:0].                */
  k_ra_drw_color_g_pos          = 8U,  /**< COLORnG[7:0].                */
  k_ra_drw_color_r_pos          = 16U, /**< COLORnR[7:0].                */
  k_ra_drw_color_a_pos          = 24U, /**< COLORnA[7:0].                */
  k_ra_drw_lvyxaddf_lvyaddf_pos = 16U, /**< LVYXADDF.LVYADDF in [31:16]. */
} ra_drw_geom_layout_t;

/**
 * @enum ra_drw_dim_limits_t
 ...
 *
 * @param[in] off One of the ``k_ra_drw_off_*`` values (low 12 bits
 *                of the absolute address).
 * @return Volatile pointer to the register.
 *
 * @pre Caller passes a well-formed offset from ``ra_drw_off_t``.
 ...
 */
static inline volatile uint32_t* ra_drw_reg32(ra_drw_off_t off)
{
  return (volatile uint32_t*)(k_ra_drw_base_addr + (uintptr_t)(uint16_t)off);
}
