...
typedef enum : uint8_t {
  k_ra_bscan_jtir_bits  = 4U,  /**< JTIR is 4 bits wide (TS[3:0]).        */
  k_ra_bscan_jtidr_bits = 32U, /**< JTIDR is 32 bits wide (DID[31:0]).    */
  k_ra_bscan_jtbpr_bits = 1U,  /**< JTBPR is a single bit shift register. */
} ra_bscan_width_t;
