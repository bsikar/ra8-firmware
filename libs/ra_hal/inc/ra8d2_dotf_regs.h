 ...
 * their xSPI partner -- see ``ra_mstp.h`` (``k_ra_mstp_ospi0`` releases
...
typedef enum : uintptr_t {
  k_ra_dotf0_base_addr    = 0x40268800UL, /**< DOTF channel 0 secure alias.     */
  k_ra_dotf1_base_addr    = 0x40268900UL, /**< DOTF channel 1 secure alias.     */
  k_ra_dotf0_ns_base_addr = 0x50268800UL, /**< DOTF channel 0 non-secure alias. */
  k_ra_dotf1_ns_base_addr = 0x50268900UL, /**< DOTF channel 1 non-secure alias. */
  k_ra_dotf_stride        = 0x100UL,      /**< Spacing between DOTF channels.   */
} ra_dotf_addr_t;

/**
 * @enum ra_dotf_xspi_window_t
 ...
 * passed to ``ra_dotf_set_region`` MUST land inside the matching
 * channel's window.
 */
 ...
 * and writes ``0`` to disable. ``ra_dotf_set_key_size`` uses the
 ...
 */
static inline volatile ra_dotf_regs_t* ra_dotf_regs(uint8_t channel)
{
