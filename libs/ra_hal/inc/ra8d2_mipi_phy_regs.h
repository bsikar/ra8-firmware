 ...
 *
 * Note: ``k_ra_mipi_phy_base_addr`` is already declared in
 * ``ra8d2_glcdc_regs.h`` as part of the ``ra_display_addr_t``
...
#include "ra8d2_glcdc_regs.h" /* k_ra_mipi_phy_base_addr */

/**
 * @enum ra_mipi_phy_block_off_t
...
typedef enum : uint16_t {
  k_ra_mipi_phy_off_refcr = 0x000U, /**< +0x000 DPHYREFCR -- ref clock cfg.  */
  k_ra_mipi_phy_off_plfcr = 0x004U, /**< +0x004 DPHYPLFCR -- PLL freq ctrl.  */
  k_ra_mipi_phy_off_plocr = 0x008U, /**< +0x008 DPHYPLOCR -- PLL op ctrl.    */
  k_ra_mipi_phy_off_esccr = 0x00CU, /**< +0x00C DPHYESCCR -- escape clk div. */
  k_ra_mipi_phy_off_pwrcr = 0x010U, /**< +0x010 DPHYPWRCR -- LDO pwr supply. */
  k_ra_mipi_phy_off_sfr   = 0x01CU, /**< +0x01C DPHYSFR   -- status flags.   */
  k_ra_mipi_phy_off_ocr   = 0x020U, /**< +0x020 DPHYOCR   -- D-PHY enable.   */
  k_ra_mipi_phy_off_tim1  = 0x024U, /**< +0x024 DPHYTIM1  -- TINIT.          */
  k_ra_mipi_phy_off_tim2  = 0x028U, /**< +0x028 DPHYTIM2  -- TCLK PREP/SETT. */
  k_ra_mipi_phy_off_tim3  = 0x02CU, /**< +0x02C DPHYTIM3  -- THS PREP/SETT.  */
...
typedef enum : uint32_t {
  k_ra_mipi_phy_pwrcr_pwrsen = 0x1U, /**< Bit 0 mask: enable D-PHY LDO. */
} ra_mipi_phy_pwrcr_bit_t;

/**
 * @enum ra_mipi_phy_plocr_bit_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_phy_plocr_pllstp = 0x1U, /**< Bit 0 mask: stop the PLL. */
} ra_mipi_phy_plocr_bit_t;

/**
 * @enum ra_mipi_phy_ocr_bit_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_phy_ocr_dphyen = 0x1U, /**< Bit 0 mask: enable D-PHY. */
} ra_mipi_phy_ocr_bit_t;

/**
 * @enum ra_mipi_phy_sfr_bit_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_phy_sfr_pwrsf      = 0x001U, /**< Bit 0 mask: LDO stable.       */
  k_ra_mipi_phy_sfr_pllsf      = 0x100U, /**< Bit 8 mask: PLL clock stable. */
  k_ra_mipi_phy_sfr_ready_mask = 0x101U, /**< PWRSF | PLLSF.                */
} ra_mipi_phy_sfr_bit_t;

/**
 * @enum ra_mipi_phy_mdc_bit_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_phy_esccr_escdiv_mask = 0x1FU, /**< ESCDIV[4:0] field. */
} ra_mipi_phy_esccr_mask_t;

/**
 * @enum ra_mipi_phy_tim1_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_phy_tim1_tinit_mask = 0x0007FFFFUL, /**< TINIT[18:0] field. */
} ra_mipi_phy_tim1_mask_t;

/**
 * @enum ra_mipi_phy_tim_byte_shift_t
 ...
 */
typedef enum : uint8_t {
  k_ra_mipi_phy_tim_shift_b0 = 0U,  /**< Byte 0 (bits 7:0).   */
  k_ra_mipi_phy_tim_shift_b1 = 8U,  /**< Byte 1 (bits 15:8).  */
  k_ra_mipi_phy_tim_shift_b2 = 16U, /**< Byte 2 (bits 23:16). */
  k_ra_mipi_phy_tim_shift_b3 = 24U, /**< Byte 3 (bits 31:24). */
} ra_mipi_phy_tim_byte_shift_t;

/**
 * @enum ra_mipi_phy_tim_byte_mask_t
 * @brief 8-bit per-field mask applied before shifting in DPHYTIM2..5.
 */
typedef enum : uint32_t {
  k_ra_mipi_phy_tim_byte_mask = 0xFFU, /**< Mask for each 8-bit lane. */
} ra_mipi_phy_tim_byte_mask_t;

/**
 * @enum ra_mipi_phy_tim6_mask_t
 ...
 */
typedef enum : uint32_t {
  k_ra_mipi_phy_tim6_tlpx_mask = 0xFFU, /**< TLPX[7:0] field. */
} ra_mipi_phy_tim6_mask_t;

/**
 * @enum ra_mipi_phy_pll_field_shift_t
...
/**
 * @enum ra_mipi_phy_pll_field_mask_t
...
/**
 * @enum ra_mipi_phy_lane_speed_limit_t
 ...
 */
typedef enum : uint16_t {
  k_ra_mipi_phy_line_rate_min_mbps = 80U,  /**< Lower line-rate limit. */
  k_ra_mipi_phy_line_rate_max_mbps = 720U, /**< Upper line-rate limit. */
} ra_mipi_phy_lane_speed_limit_t;

/**
 * @enum ra_mipi_phy_pll_band_t
 ...
 *
 * @param[in] offset Register offset from ``ra_mipi_phy_block_off_t``.
 ...
 */
static inline volatile uint32_t* ra_mipi_phy_reg32(ra_mipi_phy_block_off_t offset)
{
  return (volatile uint32_t*)(k_ra_mipi_phy_base_addr + (uintptr_t)offset);
}
