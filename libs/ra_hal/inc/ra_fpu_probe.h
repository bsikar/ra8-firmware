 ...
 *   `vadd.f64` / `vfma.f64`).
 *
 * `ra_fpu_dp_madd()` is a deliberately tiny `double` computation that both
 ...
 *       runs unchanged under `RA_SIMULATOR_MODE` and in the host unit tests
 ...
 * @see ra_device.h                  RA8D2/RA8P1 compile-time device switch.
 *
