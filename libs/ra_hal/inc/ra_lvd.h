 ...
 * callback typedef live in ra_lvd_types.h, and the public function
 * prototypes live in ra_lvd_api.h. Both are re-included here so every
 * existing consumer of `ra_lvd.h` is unaffected.
 *
...
#include "ra_lvd_api.h"
#include "ra_lvd_types.h"
