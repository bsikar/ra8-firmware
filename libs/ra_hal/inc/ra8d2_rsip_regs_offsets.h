/**
 * @file ra8d2_rsip_regs_offsets.h
 * @brief RSIP-E50D register base address, byte offsets, and layout asserts
 *
 * @details
 * Sub-header of @ref ra8d2_rsip_regs.h. Carries the memory-mapped base
 * address (@ref ra_rsip_addr_t), the full byte-offset table for every
 * register the HAL touches (@ref ra_rsip_off_t), the sub-block window
 * boundary constants (@ref ra_rsip_window_t), and the compile-time
 ...
 * ``crypto_procedures_protected/.../ra_rsip_e50d/r_rsip_reg.h``.
 *
