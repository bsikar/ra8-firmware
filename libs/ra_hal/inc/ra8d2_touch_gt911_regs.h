...
/**
 * @enum ra_touch_gt911_cmd_t
 * @brief Values written into ::k_ra_touch_gt911_reg_command.
 */
typedef enum : uint8_t {
...
/**
 * @enum ra_touch_gt911_status_mask_t
 * @brief Bit layout of the status byte at ::k_ra_touch_gt911_reg_status.
 */
typedef enum : uint8_t {
...
/**
 * @enum ra_touch_gt911_geometry_t
...
/**
 * @enum ra_touch_gt911_point_offset_t
