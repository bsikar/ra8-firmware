 ...
 * live in ``ra_mipi_phy_types.h``, which this header includes. The
 * lifecycle / status / interrupt / power prototypes live in
 * ``ra_mipi_phy_api.h``. All three are re-exported by the thin
 * umbrella ``ra_mipi_phy.h``.
 *
