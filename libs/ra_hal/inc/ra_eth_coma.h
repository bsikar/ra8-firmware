...
/** @brief Tear down COMA. @since 0.3.0 */
[[nodiscard]] ra_err_t ra_eth_coma_deinit(void);

/** @brief Read COMA_STS. @since 0.3.0 */
[[nodiscard]] ra_err_t ra_eth_coma_get_status(uint32_t* out_mask);

/** @brief Clear COMA_STS bits via COMA_ICLR. @since 0.3.0 */
...
/** @brief Dispatch a COMA event. @since 0.3.0 */
void ra_eth_coma_dispatch(void);

/** @brief Put COMA into MSTP-gated stop. @since 0.3.0 */
