 ...
 * Split out of ``ra_mipi_csi.h`` so the umbrella header stays under the
 * per-file line budget; consumers continue to include ``ra_mipi_csi.h``.
 *
