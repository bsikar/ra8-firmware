 ...
 * blob is then consumed by ``ra_rsip_protected_*`` calls.
 *
 * The implementation in ``ra_rsip_key_injection.c`` is a host-friendly
 ...
 * MAC. This mirrors the pattern used by ``ra_sce_key_injection`` so
 ...
 *          backend is wired up.
 *
 * @see ra_rsip.h  Underlying RSIP HAL surface.
 * @see ra_rsip_protected.h  Crypto operations driven by wrapped keys.
 *
...
/**
 * @enum ra_rsip_wrapped_key_const_t
 ...
 *
 * @invariant ``k_ra_rsip_wrapped_max_total`` ==
 *            ``k_ra_rsip_wrapped_type_bytes`` +
 *            ``k_ra_rsip_wrapped_mgmt_info_bytes`` +
 *            ``k_ra_rsip_wrapped_max_payload`` +
 *            ``k_ra_rsip_wrapped_mac_bytes``.
 *
 * @since 0.1.0
 */
...
/**
 * @enum ra_rsip_wrapped_key_type_t
...
/**
 * @enum ra_rsip_aes_key_bits_t
 * @brief AES key-width selector accepted by ``ra_rsip_key_inject_aes``.
 *
 * @since 0.1.0
 */
typedef enum : uint16_t {
  k_ra_rsip_aes_key_bits_128 = 128U, /**< AES-128. */
  k_ra_rsip_aes_key_bits_192 = 192U, /**< AES-192. */
  k_ra_rsip_aes_key_bits_256 = 256U, /**< AES-256. */
} ra_rsip_aes_key_bits_t;
 ...
 *       ``k_ra_rsip_wrapped_type_aes`` (little-endian).
 *
 * @note Thread safety: not thread-safe.
 *
 * @see ra_rsip_protected_aes_init
 *
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_rsip_key_inject_aes(uint8_t*               installed_key_buf,
 ...
 * ``k_ra_rsip_wrapped_type_rsa_priv``).
 *
 * @param[out] installed_key_buf Destination
 *                               (``k_ra_rsip_wrapped_max_total``).
 ...
 * @retval k_ra_err_invalid_arg Unsupported ``size``.
 *
 * @pre ``installed_key_buf`` is ``k_ra_rsip_wrapped_max_total`` bytes.
 ...
 * @note Thread safety: not thread-safe.
 *
 * @see ra_rsip_protected_rsa_decrypt
 *
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_rsip_key_inject_rsa(uint8_t*           installed_key_buf,
 ...
 * @note Thread safety: not thread-safe.
 *
 * @see ra_rsip_protected_ecdsa_sign
 *
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_rsip_key_inject_ecc(uint8_t*        installed_key_buf,
 ...
 *      ``k_ra_rsip_wrapped_max_total`` long.
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_rsip_key_validate(const uint8_t*             installed_key_buf,
