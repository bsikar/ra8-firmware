...
typedef enum : uint8_t {
  k_ra_sdramc_off_sdccr  = 0x00U, /**< SDCCR  -- SDC Control.           */
  k_ra_sdramc_off_sdcmod = 0x01U, /**< SDCMOD -- SDC Mode.              */
  k_ra_sdramc_off_sdamod = 0x02U, /**< SDAMOD -- SDRAM Access Mode.     */
  k_ra_sdramc_off_sdself = 0x10U, /**< SDSELF -- Self-Refresh Control.  */
  k_ra_sdramc_off_sdrfcr = 0x14U, /**< SDRFCR -- Refresh Control.       */
  k_ra_sdramc_off_sdrfen = 0x16U, /**< SDRFEN -- Auto-Refresh Control.  */
  k_ra_sdramc_off_sdicr  = 0x20U, /**< SDICR  -- Init Sequence Control. */
  k_ra_sdramc_off_sdir   = 0x24U, /**< SDIR   -- Initialization.        */
  k_ra_sdramc_off_sdadr  = 0x40U, /**< SDADR  -- Address.               */
  k_ra_sdramc_off_sdtr   = 0x44U, /**< SDTR   -- Timing.                */
  k_ra_sdramc_off_sdmod  = 0x48U, /**< SDMOD  -- Mode.                  */
  k_ra_sdramc_off_sdsr   = 0x50U, /**< SDSR   -- Status (RO).           */
} ra_sdramc_off_t;
 ...
 * from ::ra_sdramc_off_t, so a register-type change is caught by the
...
static_assert(offsetof(r_sdramc_regs_t, SDTR) == (size_t)k_ra_sdramc_off_sdtr,
              "SDRAMC SDTR offset");
static_assert(offsetof(r_sdramc_regs_t, SDSR) == (size_t)k_ra_sdramc_off_sdsr,
              "SDRAMC SDSR offset");
static_assert(offsetof(r_sdramc_regs_t, SDICR) == (size_t)k_ra_sdramc_off_sdicr,
              "SDRAMC SDICR offset");
static_assert(offsetof(r_sdramc_regs_t, SDADR) == (size_t)k_ra_sdramc_off_sdadr,
              "SDRAMC SDADR offset");
...
static inline volatile uint8_t* ra_sdramc_sdckocr(void)
{
  return (volatile uint8_t*)k_ra_system_sdckocr_addr;
}
