...
/**
 * @struct ra_layer3_switch_cfg_t
 * @brief Configuration descriptor for `ra_layer3_switch_open`.
 */
...
/**
 * @struct ra_layer3_switch_route_t
 ...
 * @retval k_ra_err_invalid_arg `port_count` zero or `mtu_bytes` zero.
 * @retval k_ra_err_exists Driver already opened.
 *
 * @pre Single-threaded init context.
 *
 * @post Driver in open state.
 * @post `ra_layer3_switch_close` will succeed.
 *
 * @note Not thread-safe.
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_layer3_switch_open(const ra_layer3_switch_cfg_t* cfg);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_layer3_switch_route_add(const ra_layer3_switch_route_t* route);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_layer3_switch_route_delete(uint32_t dst_ip, uint32_t mask);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_layer3_switch_status_get(uint8_t* out_open, uint8_t* out_promisc);
 ...
 * @post `ra_layer3_switch_open` may be called again.
 *
 * @note Not thread-safe.
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_layer3_switch_close(void);
