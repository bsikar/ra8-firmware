 ...
 *
 * The base address constants live in ra8d2_ether_regs.h; this file
 ...
 *
 * PTP timestamping itself stays in ra_eth_gptp -- this header exposes
 ...
 *
 * @details
 * Used as the first argument to every ra_rmac_* call. Maps directly
...
typedef enum : uint32_t {
  k_ra_rmac_mask_byte         = 0x000000FFUL, /**< One MAC octet.       */
  k_ra_rmac_mask_mrmac0_mau   = 0x0000FFFFUL, /**< MRMAC0.MAU valid.    */
  k_ra_rmac_mask_mpsm_phy_reg = 0x0000001FUL, /**< 5-bit PHY reg/dev.   */
  k_ra_rmac_mask_mpsm_op      = 0x00000003UL, /**< MPSM.POP[14:13].     */
  k_ra_rmac_mask_mpsm_data    = 0x0000FFFFUL, /**< MPSM.PRD[31:16].     */
  k_ra_rmac_mask_mpic_pis     = 0x00000007UL, /**< MPIC.PIS[2:0].       */
  k_ra_rmac_mask_mpic_lsc     = 0x00000007UL, /**< MPIC.LSC[5:3].       */
  k_ra_rmac_mask_mpic_psmcs   = 0x0000007FUL, /**< MPIC.PSMCS[22:16].   */
  k_ra_rmac_mask_mtpfc_pt     = 0x0000FFFFUL, /**< MTPFC.PT[15:0].      */
  k_ra_rmac_mask_mtpfc_pfrt   = 0x000000FFUL, /**< MTPFC.PFRT[23:16].   */
  k_ra_rmac_mask_mrfsc        = 0x0000FFFFUL, /**< 16-bit frame size.   */
  k_ra_rmac_mask_mrgc_pfcrc   = 0x000000FFUL, /**< MRGC.PFCRC.          */
  k_ra_rmac_mask_mpfc_val     = 0x000000FFUL, /**< MPFCt.PFBV octet.    */
  k_ra_rmac_mask_pfc_priority = 0x000000FFUL, /**< 8-bit prio bitmap.   */
  k_ra_rmac_mask_meis_all     = 0x3FFF3FFFUL, /**< MEIS valid bits.     */
  k_ra_rmac_mask_mmis0_all    = 0x00001FFFUL, /**< MMIS0 valid bits.    */
  k_ra_rmac_mask_mmis1_all    = 0x0000000FUL, /**< MMIS1 valid bits.    */
  k_ra_rmac_mask_mmis2_all    = 0x00000007UL, /**< MMIS2 valid bits.    */
  k_ra_rmac_mask_meis_rx      = 0x00000001UL, /**< Sample RX-error bit. */
  k_ra_rmac_mask_all          = 0xFFFFFFFFUL, /**< Wildcard write.      */
} ra_rmac_mask_t;

/**
 * @enum ra_rmac_offset_t
...
typedef enum : uint16_t {
  k_ra_rmac_off_mpsm      = 0x0000U, /**< PHY Station Management.    */
  k_ra_rmac_off_mpic      = 0x0004U, /**< PHY Interfaces Cfg.        */
  k_ra_rmac_off_mpim      = 0x0008U, /**< PHY Interfaces Monitoring. */
  k_ra_rmac_off_mioc      = 0x0010U, /**< I/O Configuration.         */
  k_ra_rmac_off_mtffc     = 0x0020U, /**< TX Frame Format Cfg.       */
  k_ra_rmac_off_mtpfc     = 0x0024U, /**< TX Pause/PFC Frame Cfg.    */
  k_ra_rmac_off_mtpfc2    = 0x0028U, /**< TX Pause/PFC Cfg 2.        */
  k_ra_rmac_off_mtpfc30   = 0x0030U, /**< TX PFC Cfg 3 group 0.      */
  k_ra_rmac_off_mtpfc31   = 0x0034U, /**< TX PFC Cfg 3 group 1.      */
  k_ra_rmac_off_mtatc0    = 0x0050U, /**< TX Auto Timestamp 0.       */
  k_ra_rmac_off_mtatc1    = 0x0054U, /**< TX Auto Timestamp 1.       */
  k_ra_rmac_off_mtim      = 0x0060U, /**< TX Interfaces Monitoring.  */
  k_ra_rmac_off_mrgc      = 0x0080U, /**< RX General Configuration.  */
  k_ra_rmac_off_mrmac0    = 0x0084U, /**< RX MAC Address Cfg 0.      */
  k_ra_rmac_off_mrmac1    = 0x0088U, /**< RX MAC Address Cfg 1.      */
  k_ra_rmac_off_mrafc     = 0x008CU, /**< RX Address Filter Cfg.     */
  k_ra_rmac_off_mrsce     = 0x0090U, /**< RX Storm Cfg E-frames.     */
  k_ra_rmac_off_mrscp     = 0x0094U, /**< RX Storm Cfg P-frames.     */
  k_ra_rmac_off_mrscc     = 0x0098U, /**< RX Storm Counter Cfg.      */
  k_ra_rmac_off_mrfsce    = 0x009CU, /**< RX Frame Size Cfg E.       */
  k_ra_rmac_off_mrfscp    = 0x00A0U, /**< RX Frame Size Cfg P.       */
  k_ra_rmac_off_mtrc      = 0x00A4U, /**< Timestamp RX Cfg.          */
  k_ra_rmac_off_mrpfm     = 0x00ACU, /**< RX Pause/PFC Monitoring.   */
  k_ra_rmac_off_mpfc0     = 0x0100U, /**< PTP Filter Cfg 0..15.      */
  k_ra_rmac_off_mlvc      = 0x0180U, /**< Link Verification Cfg.     */
  k_ra_rmac_off_meeec     = 0x0184U, /**< Energy Efficient Ethernet. */
  k_ra_rmac_off_mlbc      = 0x0188U, /**< Loopback Configuration.    */
  k_ra_rmac_off_mxgmiic   = 0x0190U, /**< XGMII Configuration.       */
  k_ra_rmac_off_mpch      = 0x0194U, /**< XGMII PCH Configuration.   */
  k_ra_rmac_off_manm      = 0x019CU, /**< Auto-Negotiation Message.  */
  k_ra_rmac_off_meis      = 0x0200U, /**< Error IRQ Status.          */
  k_ra_rmac_off_meie      = 0x0204U, /**< Error IRQ Enable.          */
  k_ra_rmac_off_meid      = 0x0208U, /**< Error IRQ Disable.         */
  k_ra_rmac_off_mmis0     = 0x0210U, /**< Monitor IRQ Status 0.      */
  k_ra_rmac_off_mmie0     = 0x0214U, /**< Monitor IRQ Enable 0.      */
  k_ra_rmac_off_mmid0     = 0x0218U, /**< Monitor IRQ Disable 0.     */
  k_ra_rmac_off_mmis1     = 0x0220U, /**< Monitor IRQ Status 1.      */
  k_ra_rmac_off_mmie1     = 0x0224U, /**< Monitor IRQ Enable 1.      */
  k_ra_rmac_off_mmid1     = 0x0228U, /**< Monitor IRQ Disable 1.     */
  k_ra_rmac_off_mmis2     = 0x0230U, /**< Monitor IRQ Status 2.      */
  k_ra_rmac_off_mmie2     = 0x0234U, /**< Monitor IRQ Enable 2.      */
  k_ra_rmac_off_mmid2     = 0x0238U, /**< Monitor IRQ Disable 2.     */
  k_ra_rmac_off_mmpftct   = 0x0300U, /**< Manual pause TX cnt.       */
  k_ra_rmac_off_mapftct   = 0x0304U, /**< Auto pause TX cnt.         */
 ...
 * operations into ra_rmac_mdio_c45_* helpers.
 */
typedef enum : uint8_t {
  k_ra_rmac_mdio_op_c22_write    = 1U, /**< 01 -- C22 write.        */
  k_ra_rmac_mdio_op_c22_read     = 2U, /**< 10 -- C22 read.         */
  k_ra_rmac_mdio_op_c45_address  = 0U, /**< 00 -- C45 address.      */
  k_ra_rmac_mdio_op_c45_write    = 1U, /**< 01 -- C45 write.        */
  k_ra_rmac_mdio_op_c45_read_inc = 2U, /**< 10 -- C45 post-incr rd. */
  k_ra_rmac_mdio_op_c45_read     = 3U, /**< 11 -- C45 read.         */
} ra_rmac_mdio_op_t;

/**
 * @enum ra_rmac_pause_mode_t
...
/**
 * @enum ra_rmac_meis_bit_t
 * @brief Per-bit names inside MEIS / MEIE / MEID (HUM Ch 33.4).
 */
typedef enum : uint32_t {
  k_ra_rmac_meis_tsls   = (1UL << 0),  /**< Transmit-side link state.  */
  k_ra_rmac_meis_ties   = (1UL << 1),  /**< TX interrupt error.        */
  k_ra_rmac_meis_pres   = (1UL << 2),  /**< PHY register error.        */
  k_ra_rmac_meis_pfrros = (1UL << 3),  /**< Pause/PFC frame RX over.   */
  k_ra_rmac_meis_fcds   = (1UL << 4),  /**< False carrier detect.      */
  k_ra_rmac_meis_tces   = (1UL << 5),  /**< TX collision error.        */
  k_ra_rmac_meis_tbcis  = (1UL << 6),  /**< TX byte counter overflow.  */
  k_ra_rmac_meis_bfes   = (1UL << 7),  /**< RX bad-fragment error.     */
  k_ra_rmac_meis_fces   = (1UL << 8),  /**< RX fragment-count error.   */
  k_ra_rmac_meis_reoes  = (1UL << 9),  /**< RX end-of-frame error.     */
  k_ra_rmac_meis_rpoes  = (1UL << 10), /**< RX preamble error.         */
  k_ra_rmac_meis_rpcres = (1UL << 11), /**< RX PCH CRC error.          */
  k_ra_rmac_meis_ctles0 = (1UL << 12), /**< Counter overflow group 0.  */
  k_ra_rmac_meis_ctles1 = (1UL << 13), /**< Counter overflow group 1.  */
  k_ra_rmac_meis_pdes   = (1UL << 20), /**< PFC frame decode error.    */
  k_ra_rmac_meis_pnaes  = (1UL << 21), /**< PFC not-allowed.           */
  k_ra_rmac_meis_fcmces = (1UL << 22), /**< Frame-check mCRC error.    */
  k_ra_rmac_meis_ffmes  = (1UL << 23), /**< Final fragment missing.    */
  k_ra_rmac_meis_cfces  = (1UL << 24), /**< Continuation fragment cnt. */
  k_ra_rmac_meis_frces  = (1UL << 25), /**< RMAC filter rejected.      */
  k_ra_rmac_meis_rpooms = (1UL << 26), /**< RX preamble out of margin. */
  k_ra_rmac_meis_ffs    = (1UL << 27), /**< First-fragment status.     */
  k_ra_rmac_meis_fues   = (1UL << 28), /**< Frame undersize error.     */
  k_ra_rmac_meis_foes   = (1UL << 29), /**< Frame oversize error.      */
} ra_rmac_meis_bit_t;

/**
 * @enum ra_rmac_mmis0_bit_t
...
/**
 * @enum ra_rmac_mmis1_bit_t
 * @brief MMIS1 PHY-station-management completion bits.
 */
typedef enum : uint32_t {
  k_ra_rmac_mmis1_pracs  = (1UL << 0), /**< PHY read access complete.  */
  k_ra_rmac_mmis1_pwacs  = (1UL << 1), /**< PHY write access complete. */
  k_ra_rmac_mmis1_paacs  = (1UL << 2), /**< PHY address access cmpl.   */
  k_ra_rmac_mmis1_ppracs = (1UL << 3), /**< PHY post-read autoinc cmpl */
} ra_rmac_mmis1_bit_t;
...
/**
 * @enum ra_rmac_mrgc_bit_t
 * @brief MRGC RX-general-config bits (HUM Ch 33.4).
 */
typedef enum : uint32_t {
  k_ra_rmac_mrgc_rcpt  = (1UL << 0), /**< Reception-control passthru. */
  k_ra_rmac_mrgc_pfrc  = (1UL << 1), /**< Pause-frame RX control.     */
  k_ra_rmac_mrgc_pfrtz = (1UL << 2), /**< Pause-frame request to zero */
  k_ra_rmac_mrgc_mpde  = (1UL << 3), /**< Magic-packet detect enable. */
  k_ra_rmac_mrgc_rfcfe = (1UL << 4), /**< Receive frame check-fail en */
} ra_rmac_mrgc_bit_t;

/**
 * @enum ra_rmac_mlbc_bit_t
...
/**
 * @enum ra_rmac_mxgmiic_bit_t
 * @brief MXGMIIC 10G-XGMII bits.
 */
typedef enum : uint32_t {
  k_ra_rmac_mxgmiic_lfs_txrfs  = (1UL << 0), /**< TX remote-fault sig. */
  k_ra_rmac_mxgmiic_lfs_txidle = (1UL << 1), /**< TX local-fault idle. */
 ...
 * every field as unused; each member is accessed via ``ra_rmac(port)``
 * in ``libs/ra_hal/src/ra_rmac.c``.
 */
 ...
 * @pre ``port`` is one of ::ra_rmac_port_t.
