...
typedef enum : uintptr_t {
  k_ra_iic_b0_base_addr = 0x4035F000UL, /**< HUM Ch 40.2, p 2452 */
} ra_iic_b_addr_t;

/**
 * @enum ra_iic_b_limits_t
 * @brief Channel-count limits.
 */
typedef enum : uint16_t {
  k_ra_iic_b_channel_count = 1U, /**< HUM Ch 40.1.1, p 2445 */
} ra_iic_b_limits_t;

/**
 * @enum ra_iic_b_rsv_words_t
 * @brief Reserved-word array sizes (in 32-bit words) used inside the
 *        IIC_B / I3C register block.
 *
 * @details
 * Names each reserved gap so ``r_iic_b_regs_t`` does not depend on
 * raw integer literals. Cross-checked against HUM Ch 40.2 offset
 * table.
 */
typedef enum : uint8_t {
  k_ra_iic_b_rsv_words_svtdlg_to_stctl    = 23U, /**< +0x00C4..0x011F gap. */
  k_ra_iic_b_rsv_words_ntdtbp0_to_nibiqp  = 8U,  /**< +0x015C..0x017B gap. */
  k_ra_iic_b_rsv_words_ntbthctl_to_nrqthc = 10U, /**< +0x0198..0x01BF gap. */
} ra_iic_b_rsv_words_t;

/**
 * @struct r_iic_b_regs_t
 ...
 * via the ``k_ra_iic_b_*_pos`` and ``k_ra_iic_b_*_msk`` enums below.
 *
...
typedef struct {
  ...
  volatile uint32_t RESERVED11[k_ra_iic_b_rsv_words_svtdlg_to_stctl];
  ...
  volatile uint32_t RESERVED14[k_ra_iic_b_rsv_words_ntdtbp0_to_nibiqp];
  ...
  volatile uint32_t RESERVED15[k_ra_iic_b_rsv_words_ntbthctl_to_nrqthc];
 ...
 */
typedef enum : uint8_t {
  k_ra_iic_b_cectl_clke_pos = 0U, /**< HUM 40.2 CECTL.CLKE, p 2453 */
} ra_iic_b_cectl_t;

/**
 * @enum ra_iic_b_bctl_t
 * @brief BCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_bctl_buse_pos = 31U, /**< HUM 40.2 BCTL.BUSE, p 2454 */
} ra_iic_b_bctl_t;

/**
 * @enum ra_iic_b_rstctl_t
 * @brief RSTCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_rstctl_ri3crst_pos = 0U, /**< HUM 40.2 RSTCTL.RI3CRST, p 2456 */
} ra_iic_b_rstctl_t;

/**
 * @enum ra_iic_b_prsst_t
 * @brief PRSST field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_prsst_crms_pos = 2U, /**< HUM 40.2 PRSST.CRMS, p 2457 */
  k_ra_iic_b_prsst_trmd_pos = 4U, /**< HUM 40.2 PRSST.TRMD, p 2457 */
} ra_iic_b_prsst_t;

/**
 * @enum ra_iic_b_bfctl_t
 * @brief BFCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_bfctl_male_pos   = 0U,  /**< HUM 40.2 BFCTL.MALE, p 2461 */
  k_ra_iic_b_bfctl_nale_pos   = 1U,  /**< HUM 40.2 BFCTL.NALE, p 2461 */
  k_ra_iic_b_bfctl_scsyne_pos = 8U,  /**< HUM 40.2 BFCTL.SCSYNE, p 2461 */
  k_ra_iic_b_bfctl_smbs_pos   = 12U, /**< HUM 40.2 BFCTL.SMBS, p 2461 */
  k_ra_iic_b_bfctl_fmpe_pos   = 14U, /**< HUM 40.2 BFCTL.FMPE, p 2461 */
} ra_iic_b_bfctl_t;

/**
 * @enum ra_iic_b_stdbr_t
 * @brief STDBR field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_stdbr_sbrlo_pos = 0U, /**< HUM 40.2 STDBR.SBRLO, p 2462 */
  k_ra_iic_b_stdbr_sbrho_pos = 8U, /**< HUM 40.2 STDBR.SBRHO, p 2462 */
} ra_iic_b_stdbr_t;

/**
 * @enum ra_iic_b_ackctl_t
 * @brief ACKCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_ackctl_ackt_pos   = 1U, /**< HUM 40.2 ACKCTL.ACKT, p 2468 */
  k_ra_iic_b_ackctl_acktwp_pos = 2U, /**< HUM 40.2 ACKCTL.ACKTWP, p 2468 */
} ra_iic_b_ackctl_t;

/**
 * @enum ra_iic_b_scstrctl_t
 * @brief SCSTRCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_scstrctl_rwe_pos = 1U, /**< HUM 40.2 SCSTRCTL.RWE, p 2469 */
} ra_iic_b_scstrctl_t;

/**
 * @enum ra_iic_b_cndctl_t
 * @brief CNDCTL field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_cndctl_stcnd_pos = 0U, /**< HUM 40.2 CNDCTL.STCND, p 2473 */
  k_ra_iic_b_cndctl_srcnd_pos = 1U, /**< HUM 40.2 CNDCTL.SRCND, p 2473 */
  k_ra_iic_b_cndctl_spcnd_pos = 2U, /**< HUM 40.2 CNDCTL.SPCND, p 2473 */
} ra_iic_b_cndctl_t;
 ...
 */
typedef enum : uint8_t {
  k_ra_iic_b_bst_stcnddf_pos = 0U,  /**< HUM 40.2 BST.STCNDDF, p 2482 */
  k_ra_iic_b_bst_spcnddf_pos = 1U,  /**< HUM 40.2 BST.SPCNDDF, p 2482 */
  k_ra_iic_b_bst_nackdf_pos  = 4U,  /**< HUM 40.2 BST.NACKDF,  p 2482 */
  k_ra_iic_b_bst_tendf_pos   = 8U,  /**< HUM 40.2 BST.TENDF,   p 2482 */
  k_ra_iic_b_bst_alf_pos     = 16U, /**< HUM 40.2 BST.ALF,     p 2482 */
  k_ra_iic_b_bst_todf_pos    = 20U, /**< HUM 40.2 BST.TODF,    p 2482 */
} ra_iic_b_bst_t;

/**
 * @enum ra_iic_b_ntst_t
 * @brief NTST (Normal Transfer Status) field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_ntst_tdbef0_pos = 0U, /**< HUM 40.2 NTST.TDBEF0, p 2486 */
  k_ra_iic_b_ntst_rdbff0_pos = 1U, /**< HUM 40.2 NTST.RDBFF0, p 2486 */
} ra_iic_b_ntst_t;

/**
 * @enum ra_iic_b_ntie_t
 * @brief NTIE (Normal Transfer Interrupt Enable) field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_ntie_tdbeie0_pos = 0U, /**< HUM 40.2 NTIE.TDBEIE0, p 2488 */
  k_ra_iic_b_ntie_rdbfie0_pos = 1U, /**< HUM 40.2 NTIE.RDBFIE0, p 2488 */
} ra_iic_b_ntie_t;
 ...
 */
typedef enum : uint8_t {
  k_ra_iic_b_bie_nackdie_pos = 4U,  /**< HUM 40.2 BIE.NACKDIE, p 2484 */
  k_ra_iic_b_bie_tendie_pos  = 8U,  /**< HUM 40.2 BIE.TENDIE,  p 2484 */
  k_ra_iic_b_bie_alie_pos    = 16U, /**< HUM 40.2 BIE.ALIE,    p 2484 */
  k_ra_iic_b_bie_todie_pos   = 20U, /**< HUM 40.2 BIE.TODIE,   p 2484 */
} ra_iic_b_bie_t;

/**
 * @enum ra_iic_b_bcst_t
 * @brief BCST (Bus Condition Status) field positions.
 */
typedef enum : uint8_t {
  k_ra_iic_b_bcst_bfref_pos = 0U, /**< HUM 40.2 BCST.BFREF, p 2491 */
} ra_iic_b_bcst_t;
...
typedef enum : uint32_t {
  ...
  k_ra_iic_b_msk_bfctl_male     = (uint32_t)(1U << 0U),  /**< HUM 40.2 BFCTL.MALE,   p 2461 */
  k_ra_iic_b_msk_bfctl_nale     = (uint32_t)(1U << 1U),  /**< HUM 40.2 BFCTL.NALE,   p 2461 */
  k_ra_iic_b_msk_bfctl_scsyne   = (uint32_t)(1U << 8U),  /**< HUM 40.2 BFCTL.SCSYNE, p 2461 */
  k_ra_iic_b_msk_bfctl_fmpe     = (uint32_t)(1U << 14U), /**< HUM 40.2 BFCTL.FMPE,   p 2461 */
  k_ra_iic_b_msk_ackctl_ackt    = (uint32_t)(1U << 1U),  /**< HUM 40.2 ACKCTL.ACKT,  p 2468 */
  k_ra_iic_b_msk_ackctl_acktwp  = (uint32_t)(1U << 2U),  /**< HUM 40.2 ACKCTL.ACKTWP,p 2468 */
  k_ra_iic_b_msk_scstrctl_rwe   = (uint32_t)(1U << 1U),  /**< HUM 40.2 SCSTRCTL.RWE, p 2469 */
  k_ra_iic_b_msk_cndctl_stcnd   = (uint32_t)(1U << 0U),  /**< HUM 40.2 CNDCTL.STCND, p 2473 */
  k_ra_iic_b_msk_cndctl_srcnd   = (uint32_t)(1U << 1U),  /**< HUM 40.2 CNDCTL.SRCND, p 2473 */
  k_ra_iic_b_msk_cndctl_spcnd   = (uint32_t)(1U << 2U),  /**< HUM 40.2 CNDCTL.SPCND, p 2473 */
  k_ra_iic_b_msk_bst_stcnddf    = (uint32_t)(1U << 0U),  /**< HUM 40.2 BST.STCNDDF,  p 2482 */
  k_ra_iic_b_msk_bst_spcnddf    = (uint32_t)(1U << 1U),  /**< HUM 40.2 BST.SPCNDDF,  p 2482 */
  k_ra_iic_b_msk_bst_nackdf     = (uint32_t)(1U << 4U),  /**< HUM 40.2 BST.NACKDF,   p 2482 */
  k_ra_iic_b_msk_bst_tendf      = (uint32_t)(1U << 8U),  /**< HUM 40.2 BST.TENDF,    p 2482 */
  k_ra_iic_b_msk_bst_alf        = (uint32_t)(1U << 16U), /**< HUM 40.2 BST.ALF,      p 2482 */
  k_ra_iic_b_msk_bst_todf       = (uint32_t)(1U << 20U), /**< HUM 40.2 BST.TODF,     p 2482 */
  k_ra_iic_b_msk_ntst_tdbef0    = (uint32_t)(1U << 0U),  /**< HUM 40.2 NTST.TDBEF0,  p 2486 */
  k_ra_iic_b_msk_ntst_rdbff0    = (uint32_t)(1U << 1U),  /**< HUM 40.2 NTST.RDBFF0,  p 2486 */
  k_ra_iic_b_msk_ntie_tdbeie0   = (uint32_t)(1U << 0U),  /**< HUM 40.2 NTIE.TDBEIE0, p 2488 */
  k_ra_iic_b_msk_ntie_rdbfie0   = (uint32_t)(1U << 1U),  /**< HUM 40.2 NTIE.RDBFIE0, p 2488 */
  k_ra_iic_b_msk_bie_nackdie    = (uint32_t)(1U << 4U),  /**< HUM 40.2 BIE.NACKDIE,  p 2484 */
  k_ra_iic_b_msk_bie_tendie     = (uint32_t)(1U << 8U),  /**< HUM 40.2 BIE.TENDIE,   p 2484 */
  k_ra_iic_b_msk_bie_alie       = (uint32_t)(1U << 16U), /**< HUM 40.2 BIE.ALIE,     p 2484 */
  k_ra_iic_b_msk_bie_todie      = (uint32_t)(1U << 20U), /**< HUM 40.2 BIE.TODIE,    p 2484 */
  k_ra_iic_b_msk_bcst_bfref     = (uint32_t)(1U << 0U),  /**< HUM 40.2 BCST.BFREF,   p 2491 */
} ra_iic_b_mask_t;
 ...
 *
 * @return ``volatile r_iic_b_regs_t*`` Pointer to channel registers,
 *         or ``nullptr`` when ``channel`` is out of range.
 *
 * @pre ``ra_mstp_enable(k_ra_mstp_i3c)`` has been called.
 * @post Returned pointer either is ``nullptr`` or aliases
 *       ``k_ra_iic_b0_base_addr``.
 *
 ...
 */
static inline volatile r_iic_b_regs_t* ra_iic_b(uint8_t channel)
{
  if ((uint16_t)channel >= k_ra_iic_b_channel_count) {
    return nullptr;
  }
  return (volatile r_iic_b_regs_t*)k_ra_iic_b0_base_addr;
}
