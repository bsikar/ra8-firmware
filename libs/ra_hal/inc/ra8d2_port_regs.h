...
typedef enum : uintptr_t {
  k_ra_port0_base_addr  = 0x40400000UL,
  k_ra_port1_base_addr  = 0x40400020UL,
  k_ra_port2_base_addr  = 0x40400040UL,
  k_ra_port3_base_addr  = 0x40400060UL,
  k_ra_port4_base_addr  = 0x40400080UL,
  k_ra_port5_base_addr  = 0x404000A0UL,
  k_ra_port6_base_addr  = 0x404000C0UL,
  k_ra_port7_base_addr  = 0x404000E0UL,
  k_ra_port8_base_addr  = 0x40400100UL,
  k_ra_port9_base_addr  = 0x40400120UL,
  k_ra_port10_base_addr = 0x40400140UL,
  k_ra_port11_base_addr = 0x40400160UL,
  k_ra_port12_base_addr = 0x40400180UL,
  k_ra_port13_base_addr = 0x404001A0UL,
  k_ra_port14_base_addr = 0x404001C0UL,
  k_ra_port_stride      = 0x20UL, /**< Bytes between adjacent ports. */
} ra_port_addr_t;
...
typedef enum : uint8_t {
  k_ra_port_regs_bytes = 16U,
} ra_port_regs_size_t;

static_assert(sizeof(r_port_regs_t) == (size_t)k_ra_port_regs_bytes,
 ...
 *
 * @param[in] port `ra_port_t` value (0..`k_ra_port_max`).
