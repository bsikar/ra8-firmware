 ...
 * here so consumers keep including ``ra8d2_rsip_regs.h`` unchanged:
 *
 *  | Sub-header                     | Contents                              |
 *  |--------------------------------|---------------------------------------|
 *  | ra8d2_rsip_regs_offsets.h      | base addr, byte offsets, window enums,|
 *  |                                | layout-insurance static_asserts       |
 *  | ra8d2_rsip_regs_fields.h       | field/bit/mask/command-value enums,   |
 *  |                                | published sizes, ra_rsip_reg32()      |
 *
...
#include "ra8d2_rsip_regs_fields.h"
#include "ra8d2_rsip_regs_offsets.h"
