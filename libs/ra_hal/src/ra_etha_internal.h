/**
 * @file ra_etha_internal.h
 * @brief Cross-TU shared surface for the ra_etha driver split.
 *
 * @par Tag
 * [Ring 3 / HAL] {World: NS}
 *
 ...
 * the per-file line-count cap: ra_etha.c holds the lifecycle, IRQ, and
 * traffic-shaping path, while ra_etha_stats.c holds the per-port
 ...
 * state. Defined once in ra_etha.c and referenced from the split-out
 ...
 * @retval true  port in 0 .. (k_ra_etha_port_count - 1).
