 ...
 *
 * @details
 * Single definition for the ra_ssie split; ``ra_ssie_stream.c`` shares this
 * object via the ``extern`` declaration in ``ra_hal_internal.h``. External
 ...
 */
ra_ssie_runtime_t s_ssie_runtime[k_ra_ssie_channel_count] = {
...
/** @brief Implementation of `ra_ssie_internal_regs()` -- bounds-check + accessor. */
