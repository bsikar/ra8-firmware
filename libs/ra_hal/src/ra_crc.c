 ...
 * to CRCDIR, and can be reset between operations via CRCCR1. This
 * driver covers init, single-shot compute, runtime polynomial
 * change, status read, reset, and lifecycle. Every register
 * access carries a HUM Ch 48 citation.
 *
...
{
  volatile r_crc_regs_t* reg = ra_crc();
  /* HUM Ch 48.2.2 "CRCCR1 : CRC Control Register 1" p 3182 -- toggle
   * CRCSWR to clear the running CRCDOR result. */
