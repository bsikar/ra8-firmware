/**
 * @file ra_rmac_phy_internal.h
 * @brief Test-access surface for ra_rmac_phy internal helpers (MC/DC).
 *
 ...
 * libs/ra_hal/src/ra_rmac_phy.c lines 352 and 356 inside
 * @c ra_rmac_phy_link_status_get.
 *
 ...
 *  - err=k_ra_ok, mask&val=0          -> false
 *  - err=k_ra_ok, mask&val=mask       -> true (varies right)
 *  - err!=k_ra_ok, mask&val=mask      -> false (varies left)
 *
 * @since 0.1.0
 */
