/**
 * @file libs/ra_board_ek_ra8d2/inc/ra_boot_intrinsics.h
 ...
 * @since 0.1.0
 */
static inline uint32_t ra_boot_read32(uintptr_t addr)
{
 ...
 * @since 0.1.0
 */
static inline void ra_boot_write32(uintptr_t addr, uint32_t value)
{
  *(volatile uint32_t*)addr = value;
}

/**
 * @brief Data synchronisation barrier (no-op under ``RA_SIMULATOR_MODE``).
 ...
 * @since 0.1.0
 */
static inline void ra_boot_dsb(void)
{
...
/**
 * @brief Instruction synchronisation barrier (no-op under ``RA_SIMULATOR_MODE``).
 ...
 * @since 0.1.0
 */
static inline void ra_boot_isb(void)
{
#ifndef RA_SIMULATOR_MODE
...
/**
 * @brief Mask IRQs / set PRIMASK (no-op under ``RA_SIMULATOR_MODE``).
 ...
 * @since 0.1.0
 */
static inline void ra_boot_disable_irq(void)
{
#ifndef RA_SIMULATOR_MODE
