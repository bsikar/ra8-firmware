 ...
 * "ra_board_ek_ra8d2.h"`` keep compiling unchanged:
 *
 *   - ``ra_board_ek_ra8d2_connectors.h`` -- board identity, user LEDs,
 *     user switches, parallel-RGB J1, audio CODEC, Arduino header,
 *     Pmod1/Pmod2, MikroBUS, and the project SW4-layout enum.
 *   - ``ra_board_ek_ra8d2_peripherals.h`` -- the U15 I/O-expander SW4
