/**
 * @file ra_board_ek_ra8d2_peripherals.h
 ...
 *
 * @details
 * Sub-header of ``ra_board_ek_ra8d2.h`` (the thin umbrella). Carries the
 ...
 * (Section 12).
 *
 * Every declaration here was moved VERBATIM out of ``ra_board_ek_ra8d2.h``;
 * no contract, Doxygen block, or HUM/UM citation has changed. The enum
 * that backs the SW4-layout output bytes
 * (``ra_board_pi4ioe_project_t``) lives in
 * ``ra_board_ek_ra8d2_connectors.h``, pulled in below so the I/O-expander
 * functions resolve their referenced constants. Consumers keep including
 * ``ra_board_ek_ra8d2.h``; this file is pulled in by that umbrella and
...
#include "ra_board_ek_ra8d2_connectors.h"
#include "ra_err.h"
 ...
 *     -- I/O-expander override functions (the ra_board_pi4ioe_project_t
