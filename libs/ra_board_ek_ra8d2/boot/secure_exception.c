/**
 * @file libs/ra_board_ek_ra8d2/boot/secure_exception.c
 ...
 * `ra_exception_report()` with exception number 7.
 ...
 * `g_ra_exception_last` record, best-effort logs every field,
 ...
 * tail-branches into `ra_exception_report()`, which snapshots the frame
 ...
 *
 * @post Control transfers to `ra_exception_report()` and never returns.
 * @post `g_ra_exception_last` carries exc_number 7 plus the SFSR/SFAR pair.
 *
