/**
 * @file ra_board_ek_ra8d2_comms.c
 ...
 *
 * @details
 * Sibling translation unit of ``ra_board_ek_ra8d2.c`` carrying the two
 ...
 * ``ra_mipi_*`` / ``ra_sci_*`` / ``ra_pfs_route_peripheral`` carry every
...
#include "ra_board_ek_ra8d2_internal.h"
#include "ra_cgc.h"
#include "ra_err.h"
