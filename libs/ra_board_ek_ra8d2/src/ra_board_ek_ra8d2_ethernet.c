/**
 * @file ra_board_ek_ra8d2_ethernet.c
 ...
 *
 * @details
 * Sibling translation unit of ``ra_board_ek_ra8d2.c`` carrying the full
 ...
 * agent windows; ``ra_etha_*`` / ``ra_rmac_*`` / ``ra_cgc_*`` / ``ra_mstp_*``
 * / ``ra_pfs_route_peripheral`` carry the per-peripheral register writes.
