/**
 * @file ra_board_ek_ra8d2_audio_usb.c
 ...
 *
 * @details
 * Sibling translation unit of ``ra_board_ek_ra8d2.c`` carrying the
 ...
 *
 * The BSP itself never touches MCU registers; ``ra_ssie_*`` /
 * ``ra_i2c_*`` / ``ra_mpc_*`` / ``ra_usb_*`` / ``ra_pfs_route_peripheral``
