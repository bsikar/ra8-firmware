 ...
 *
 * @details
 * Not part of the public DFU API. Carries the handful of ``ra_dfu_program.c``
 ...
 * ``ra_dfu.h`` surface; the only consumers of these symbols outside the
 ...
 * (``k_ra_flash_world_s``). This helper drives ``ra_flash_write_block``
 ...
 * by ::ra_dfu_program_prepare is still enforced inside
 ...
 * presentable on a public-API path); defined in @c ra_dfu_program.c.
 *
