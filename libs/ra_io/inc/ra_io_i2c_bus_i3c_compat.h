/**
 * @file ra_io_i2c_bus_i3c_compat.h
 * @brief I3C I2C-compatibility backend binder for the ra_io I2C-bus facade.
 *
 * @par Tag
 * [Ring 4 / PAL] {World: NS}
 *
 * @details
 * Binds a caller-owned ::ra_io_i2c_bus_t to the I3C block running in its
 * legacy I2C-compatibility controller mode via thin trampolines to
 * `ra_i3c_write` / `ra_i3c_read` / `ra_i3c_transfer` (`ra_i3c.h`,
 * unmodified). The channel must already be initialised through
 * `ra_i3c_init` with ::k_ra_i3c_mode_i2c -- the facade owns transfers
 * only, never bring-up.
 *
 ...
 * identical `ra_io_i2c_bus_*` semantics.
 *
 ...
 * `ra_i3c_init(channel, ...)` using ::k_ra_i3c_mode_i2c (before or after
 ...
 * @retval k_ra_ok              `bus` now dispatches to `ra_i3c_*`.
 ...
 *
 * @see ra_io_i2c_bus_bind_riic  The classic RIIC twin.
 *
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_io_i2c_bus_bind_i3c_compat(ra_io_i2c_bus_t* bus, uint8_t channel);
