/**
 * @file ra_io_i2c_bus_internal.h
 * @brief Internal vtable type for the ra_io I2C-bus facade.
 *
 * @par Tag
 * [Ring 4 / PAL] {World: NS}
 *
 ...
 * should.
 *
 * Defines ::ra_io_i2c_bus_iface -- the function-pointer table each backend
 * fills in and binds into a caller-owned ::ra_io_i2c_bus_t. It is forward
 * declared opaque in `ra_io_i2c_bus.h`.
 *
