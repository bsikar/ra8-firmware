 ...
 * @retval k_ra8_err_null_ptr A required pointer is null or @p request_len is zero.
 * @retval k_ra8_err_not_supported @p operation is not one ::ra8_mdl_rpc_id_t value.
 * @retval k_ra8_err_invalid_arg A decoded Start field is invalid.
 * @retval k_ra8_err_busy A Start arrived while another job is active.
 * @retval k_ra8_err_invalid_state Job, sequence, or offset did not correlate.
 * @retval k_ra8_err_invalid_size A request or response exceeds a fixed bound.
 * @retval k_ra8_err_protocol_error The request is not decodable generated bytes.
