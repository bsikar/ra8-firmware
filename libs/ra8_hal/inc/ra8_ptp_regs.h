 ...
 * ``ra8_ether_regs.h`` unchanged (a sibling driver consumes
...
typedef enum : uintptr_t {
  k_ra8_ptp_base_addr = 0x403E0100UL, /**< PTP SYNFP/STCA window. */
} ra8_ptp_addr_t;

/**
 * @enum ra8_ptp_ctrl_bits_t
...
typedef enum : uint8_t {
  k_ra8_ptp_bit_port_en = 0U, /**< Controller enable.    */
  k_ra8_ptp_bit_role0   = 1U, /**< Role[0] (LSB).        */
  k_ra8_ptp_bit_role1   = 2U, /**< Role[1] (MSB).        */
  k_ra8_ptp_bit_tx_sync = 8U, /**< TX trigger: Sync.     */
  k_ra8_ptp_bit_tx_annc = 9U, /**< TX trigger: Announce. */
} ra8_ptp_ctrl_bits_t;

/**
 * @enum ra8_ptp_ctrl_mask_t
 * @brief PTP_CTRL bit-field masks.
 */
typedef enum : uint32_t {
  k_ra8_ptp_mask_port_en = 0x00000001UL, /**< Controller enable bit. */
  k_ra8_ptp_mask_role    = 0x00000006UL, /**< ROLE[1:0] @ [2:1].     */
  k_ra8_ptp_mask_tx_sync = 0x00000100UL, /**< TX Sync trigger.       */
  k_ra8_ptp_mask_tx_annc = 0x00000200UL, /**< TX Announce trigger.   */
} ra8_ptp_ctrl_mask_t;

/**
 * @enum ra8_ptp_role_shift_t
 * @brief Shift count for ROLE[1:0] inside PTP_CTRL.
 */
typedef enum : uint8_t {
  k_ra8_ptp_role_shift = 1U, /**< ROLE field starts at bit 1. */
} ra8_ptp_role_shift_t;
