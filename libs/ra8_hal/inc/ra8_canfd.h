 ...
 * call to ::ra8_canfd_receive consumes the frame. Used by the
 * libFuzzer harness in ``tests/fuzz/fuzz_ra8_canfd.c``.
 *
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra8_err_t ra8_canfd_test_inject_frame(uint8_t        channel,
                                                    uint32_t       id_word,
                                                    uint32_t       ptr_word,
                                                    uint32_t       fdsts_word,
                                                    const uint8_t* data,
