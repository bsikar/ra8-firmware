/**
 * @file ra8_epub_xml_opf_internal.h
 * @brief Private contracts for the EPUB container and OPF consumers.
 * @details Declares the file-local helpers of `ra8_epub_xml_shim.c`; the
 * helpers it shares with the table-of-contents pass stay in
 * `ra8_epub_xml_consumer_internal.h`, which this header includes.
