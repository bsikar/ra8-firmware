/**
 * @file ra_reflow_types.h
 * @brief Reflow-engine data model: enums, structs, typedefs, and the handle.
 *
 * @details
 * This sub-header holds the data model for the `ra_reflow` HTML / CSS reflow
 ...
 * typedefs, and the engine handle (::ra_reflow_t) itself. It is split out of
 * the umbrella `ra_reflow.h` so that header stays small; consumers still
 * include `ra_reflow.h` and never reference this file directly.
 *
