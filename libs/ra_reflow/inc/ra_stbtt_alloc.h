 ...
 * auto-reset: each successful `ra_stbtt_malloc()` bumps an offset and a
 * live-block count; each `ra_stbtt_free()` decrements the count and, when
 ...
 * and immune to fragmentation. On exhaustion `ra_stbtt_malloc()` returns
...
/**
 * @brief Release a block previously returned by ra_stbtt_malloc().
 *
 ...
 * @return None.
 * @pre `p` was returned by ra_stbtt_malloc(), or is nullptr.
 * @pre Called single-threaded from the rasteriser.
