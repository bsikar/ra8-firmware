 ...
 *   - ra_reflow_css.c          -- parser entry, selector + `@font-face` parsing.
 *   - ra_reflow_css_decl.c     -- declaration-body parsing (colour / font-size /
 *                                 emphasis / align / `prop:value;` block).
 *   - ra_reflow_css_cascade.c  -- selector matching, the cascade, and the public
 ...
 * and no heap: all state lives in the caller-owned ::ra_css_sheet_t.
 *
 ...
 * string @p lit using ASCII case folding via ra_reflow_css_lower(). Returns true
 ...
 *
 * @details Advances past leading ra_reflow_css_is_ws() bytes and shrinks past
 ...
 * scanner ra_css_parse() (which lives in a different translation unit).
 *
