 ...
 * ::ra8_unarch_gzip_unwrap decodes exactly one gzip member fetched through
...
typedef enum : uint16_t {
  k_ra8_unarch_gzip_sig_len = 2U,    /**< Magic length (1F 8B).                */
  k_ra8_unarch_gzip_str_max = 2048U, /**< Max FNAME / FCOMMENT bytes accepted. */
} ra8_unarch_gzip_dims_t;
 ...
 * @since Version 0.1.0
 */
[[nodiscard]] bool ra8_unarch_gzip_magic(const uint8_t* sig, size_t sig_len);
 ...
 * @see ra8_unarch_gzip_magic()
 * @since Version 0.1.0
 */
[[nodiscard]] ra8_err_t ra8_unarch_gzip_unwrap(ra8_unarch_read_fn         read,
                                               void*                      ctx,
                                               uint64_t                   size,
                                               uint8_t*                   out,
                                               size_t                     out_cap,
