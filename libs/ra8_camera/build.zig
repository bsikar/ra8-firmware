...
pub fn build(b: *std.Build) void {
    ...
    // Keep the public C entry points and each backend in separate archive
    // members. This lets the system linker pull only the adapter(s) an
    // application actually uses; a monolithic root made capture-only apps
    // retain the software JPEG encoder and its 200+ KiB static scratch.
