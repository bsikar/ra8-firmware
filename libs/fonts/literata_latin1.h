 ...
 * (`const unsigned char g_ra_font_literata_latin1[]` + `_len`) that `#include`s
 ...
 * e-reader. A baked font is a valid TTF/OTF blob accepted by `ra_reflow_init`'s
 ...
 * time by `scripts/utils/font_to_c.py`. A valid TTF blob for `ra_reflow_init`.
 * @note Generated, build-only definition; read-only.
 * @since 0.1.0
 */
extern const unsigned char g_ra_font_literata_latin1[];

/**
 * @var g_ra_font_literata_latin1_len
 * @brief Length of ::g_ra_font_literata_latin1 in bytes.
 * @since 0.1.0
 */
