 ...
 *   (TZ builds), and forwards to ``ra_net_pal_send_frame``.
 *
 * @param[in] ns_frame Non-Secure source buffer holding the L2 frame.
 * @param[in] len      Frame length in bytes; 1..k_ra_nsc_eth_frame_max.
 *
 ...
 *
 * @note Thread-safe: serialises through the secure ra_net_pal lock.
 * @since 0.1.0
 */
