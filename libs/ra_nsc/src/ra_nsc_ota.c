 ...
 *   ``ra_ota_commit_swap_bank`` in the secure world.
 *
 * @param[in] target_bank Bank to boot from (k_ra_ota_bank_a/b).
 *
 ...
 *
 * @note Thread-safe: serialised by the secure ra_ota lock.
 * @since 0.1.0
 */
 ...
 *
 * @details
 * Forwards the 32-bit raw value through ``ra_ota_commit_set_bank_config``
 ...
 *
 * @return ra_err_t outcome.
 * @retval k_ra_ok               Bank-config word latched (after secure mask).
 * @retval k_ra_err_invalid_arg  Secure side rejected the value.
 *
