 ...
 *
 * @see @scoperef{md_docs_2formats_2ROT1,docs/formats/ROT1.md} -- the full ROT1 wire-format specification
 ...
 *       The signing tool ``scripts/secrets/rot_sign.py`` binds the identical material.
