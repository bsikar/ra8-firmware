 ...
 *          tree and signs every launched image via scripts/secrets/rot_sign.py. Public-key
 *          SHA-256 fingerprint:
 ...
 *          every shipped image to be signed with scripts/secrets/rot_sign.py; an unsigned
