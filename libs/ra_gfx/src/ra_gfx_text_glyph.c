/**
 * @file ra_gfx_text_glyph.c
 * @brief Glyph-cell blitting and text rendering for the ra_gfx software rasteriser.
 *
 * @details
 * Holds the text sub-responsibility of the software pixel-pusher: the 1-bpp
 * glyph-cell blitters and the public text entry points (ra_gfx_text_out,
 * ra_gfx_text_size). These share the single framebuffer binding
 * (s_gfx_text_state) and the low-level packers/plotters with the core
 * rasteriser TU (ra_gfx_text.c) via ra_gfx_internal.h.
 *
