/**
 * @file ra_gfx_internal.h
 * @brief Module-private declarations shared across the ra_gfx software rasteriser TUs.
 *
 * @details
 ...
 * @brief Single module-wide framebuffer binding shared by every ra_gfx TU.
 *
 * @details
 * Defined once in ra_gfx_text.c (populated by ra_gfx_init()); the text/glyph TU
 ...
 * @since 0.1.0
 */
extern ra_gfx_state_t s_gfx_text_state;
