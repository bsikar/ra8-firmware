 ...
 * @code{.c}
 * reg->CR |= (k_ra_bit_1 << k_ra_bit_7) | (k_ra_mask_lsn2 << k_ra_bit_3);
 * @endcode
 *
 * The second version is searchable (`grep k_ra_bit_7` tells you every
 ...
 *
 * @code{.c}
 * buf[k_ra_be_idx_hi16] = (uint8_t)(val >> k_ra_bit_8);
 * buf[k_ra_be_idx_lo16] = (uint8_t)(val & k_ra_mask_byte);
 * @endcode
 */
typedef enum : uint8_t {
