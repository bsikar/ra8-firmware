...
//!
//! C-test-only exports for the private MC/DC helpers. This adapter is linked
//! only by the host test graph; the firmware archive exposes the public C ABI.

const abi = @import("../src/ra8_modem_at_abi.zig");
