...
test "every entry point refuses before init" {
    ...
    try std.testing.expectEqual(impl.err.not_initialized, abi.ra8_gfx_rect(0, 0, 1, 1, 0, true));
    try std.testing.expectEqual(impl.err.not_initialized, abi.ra8_gfx_circle(0, 0, 1, 0, false));
}
...
test "a zero-extent rect is accepted and draws nothing" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(0, 0, 0, 4, 0xFFFFFF, true));
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(0, 0, 4, 0, 0xFFFFFF, true));
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(0, 0, -4, 4, 0xFFFFFF, false));
    try std.testing.expectEqual(@as(usize, 0), s.nonZeroCount());
}
...
test "a filled rect covers exactly its own area on the fast path" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(2, 1, 4, 3, 0x00FF_FFFF, true));
...
test "a filled rect on the per-pixel path covers the same area" {
    ...
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(2, 1, 4, 3, 0x0011_2233, true));
    try std.testing.expectEqual(@as(usize, 12), s.nonZeroCount());
...
test "a filled rect is clipped to the clip box" {
    ...
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(0, 0, 16, 8, 0x00FF_FFFF, true));
    try std.testing.expectEqual(@as(usize, 4), s.nonZeroCount());
}
...
test "an outlined rect draws its border and leaves the interior alone" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(1, 1, 5, 4, 0x00FF_FFFF, false));
...
test "a one-pixel outlined rect is a single pixel" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_rect(7, 3, 1, 1, 0x00FF_FFFF, false));
    try std.testing.expectEqual(@as(usize, 1), s.nonZeroCount());
...
test "circle refuses a negative radius" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.invalid_arg, abi.ra8_gfx_circle(8, 4, -1, 0xFFFFFF, false));
    try std.testing.expectEqual(@as(usize, 0), s.nonZeroCount());
}
...
test "a zero-radius circle marks its centre only" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_circle(8, 4, 0, 0x00FF_FFFF, false));
    try std.testing.expectEqual(@as(usize, 1), s.nonZeroCount());
...
test "an outlined circle stays on its radius" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_circle(8, 4, 3, 0x00FF_FFFF, false));
...
test "a filled circle fills its centre and respects the clip" {
    var s = Surface{};
    s.bind(16, 8, impl.format.rgb565);
    try std.testing.expectEqual(impl.err.ok, abi.ra8_gfx_circle(8, 4, 3, 0x00FF_FFFF, true));
