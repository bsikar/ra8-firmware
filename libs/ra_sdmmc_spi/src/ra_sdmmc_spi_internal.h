 ...
 *
 * @details
 * Shared between the core/init translation unit (``ra_sdmmc_spi.c``) and
 * the block-I/O translation unit (``ra_sdmmc_spi_io.c``) of the
 * ``ra_sdmmc_spi`` library. It carries the protocol enums both units use,
 ...
 *
 * This header is private to the ``ra_sdmmc_spi`` module; no other library
 ...
 * @brief Single driver instance, defined in ``ra_sdmmc_spi.c``.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok All @p n bytes clocked.
 * @retval other   Propagated from the transport ``xfer`` callback.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok CS asserted and one idle byte clocked.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok CS released and one idle byte clocked.
 * @retval other   Propagated from the transport ``cs`` / ``xfer`` callbacks.
 * @pre The transport is bound.
 * @pre The transport ``cs`` callback is non-NULL.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok          Command sent and R1 captured.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok  Both commands sent and R1 captured.
 * @retval other    Propagated from the transport callbacks.
 * @pre The transport is bound.
 * @pre @p out_r1 is non-NULL.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok            Data-start token observed.
 * @retval k_ra_err_hw_timeout Token did not appear within budget.
 * @retval other              Propagated from the transport callbacks.
 * @pre The transport is bound.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok            Card released busy.
 * @retval k_ra_err_hw_timeout Card stayed busy beyond @p max_polls.
 * @retval other              Propagated from the transport callbacks.
 * @pre The transport is bound.
 * @pre CS is asserted by the caller.
 ...
 * @details Convenience wrapper over ::ra_sdmmc_spi_wait_not_busy_bounded with
 *          the default worst-case write timeout.
 * @return ra_err_t Error code.
 * @retval k_ra_ok            Card released busy.
 * @retval k_ra_err_hw_timeout Card stayed busy beyond the default budget.
 * @retval other              Propagated from the transport callbacks.
 * @pre The transport is bound.
 * @pre CS is asserted by the caller.
 * @post On success the card is no longer busy.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok             Descriptor and all callbacks are non-NULL.
 * @retval k_ra_err_null_ptr   @p transport is NULL.
 * @retval k_ra_err_invalid_arg A callback is NULL.
 * @pre None.
 * @pre None.
 * @post No driver state is modified.
 ...
 * @return ra_err_t Error code.
 * @retval k_ra_ok               Card identified; type and capacity cached.
 * @retval k_ra_err_protocol_error A response was malformed.
