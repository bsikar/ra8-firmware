 ...
 *          form `ra8_epub` requires), then compiles via the builder arenas in
 ...
 *          with `ra8_epub_open_fs`, runs `ra8_rabook_compile_from_epub` to
 ...
 * @retval k_ra8_err_*        Propagated EPUB-open or compile error.
 *
