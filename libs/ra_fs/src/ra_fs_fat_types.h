 ...
 * scratch-sector buffer. It is pulled in by the `ra_fs_fat_internal.h` umbrella
 * (and therefore by every `ra_fs_fat*.c` file) and by the prototype sub-headers,
 ...
 *          data-sector access. Defined once in `ra_fs_fat_mount.c`.
 ...
 * @since 0.1.0
 */
extern uint8_t s_scratch[k_ra_fs_bytes_per_sector];
