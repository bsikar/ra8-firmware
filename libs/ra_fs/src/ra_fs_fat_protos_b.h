 ...
 * helpers live in `ra_fs_fat_protos_a.h`. Both are aggregated by the
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_write_dir_set(const ra_fs_mount_t* m,
                                  uint32_t             cluster,
                                  uint32_t             idx,
                                  const uint8_t*       set,
                                  uint32_t             bytes);
 ...
 * @since 0.1.0
 */
ra_err_t priv_fat_get(const ra_fs_mount_t* m, uint32_t cluster, uint32_t* out_value);
 ...
 * @since 0.1.0
 */
ra_err_t priv_fat_set(const ra_fs_mount_t* m, uint32_t cluster, uint32_t value);
 ...
 * @since 0.1.0
 */
ra_err_t priv_fmt_choose_geometry(ra_fs_fmt_geom_t* g, uint32_t spc_hint);
 ...
 * @since 0.1.0
 */
ra_err_t priv_fmt_clear_region(const ra_fs_backend_t* backend, uint32_t lba, uint32_t count);
 ...
 * @since 0.1.0
 */
uint32_t priv_fmt_reserved_for(ra_fs_type_t type);
 ...
 * @since 0.1.0
 */
ra_err_t priv_free_chain(const ra_fs_mount_t* m, uint32_t start);
 ...
 * @since 0.1.0
 */
uint8_t priv_is_eoc(const ra_fs_mount_t* m, uint32_t value);
 ...
 * @since 0.1.0
 */
ra_err_t priv_parse_bpb_into_mount(ra_fs_mount_t* m);
 ...
 * @since 0.1.0
 */
ra_err_t priv_parse_volume(ra_fs_mount_t* m);
 ...
 * @since 0.1.0
 */
ra_err_t priv_read_sector(const ra_fs_mount_t* m, uint32_t lba, uint8_t* buf);
 ...
 * @since 0.1.0
 */
ra_err_t priv_resolve_dir(const ra_fs_mount_t* m, const char* path, dir_loc_t* out);
 ...
 * @since 0.1.0
 */
ra_err_t priv_resolve_parent(const ra_fs_mount_t* m,
                             const char*          path,
 ...
 * @since 0.1.0
 */
ra_err_t priv_write_new_dir_entry(ra_fs_mount_t* handle,
 ...
 * @since 0.1.0
 */
ra_err_t priv_write_sector(const ra_fs_mount_t* m, uint32_t lba, const uint8_t* buf);
