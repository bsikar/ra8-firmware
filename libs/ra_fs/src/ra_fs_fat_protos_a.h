 ...
 * in `ra_fs_fat_protos_b.h`. Both are aggregated by the
 * `ra_fs_fat_internal.h` umbrella, which every `ra_fs_fat*.c` file includes.
 *
 ...
 * @since 0.1.0
 */
ra_err_t priv_alloc_cluster(const ra_fs_mount_t* m, uint32_t* out_cluster);
 ...
 * @since 0.1.0
 */
ra_err_t priv_alloc_eoc_cluster(const ra_fs_mount_t* m, uint32_t* out_c);
 ...
 * @since 0.1.0
 */
ra_fs_file_t* priv_alloc_file_slot(void);
 ...
 * @since 0.1.0
 */
uint32_t priv_cluster_to_lba(const ra_fs_mount_t* m, uint32_t cluster);
 ...
 * @since 0.1.0
 */
ra_err_t priv_dir_find(const ra_fs_mount_t* m,
                       const dir_loc_t*     loc,
 ...
 * @since 0.1.0
 */
ra_err_t priv_dir_find_free(const ra_fs_mount_t* m,
                            const dir_loc_t*     loc,
                            uint32_t*            out_lba,
                            uint32_t*            out_entry_off);
 ...
 * @since 0.1.0
 */
ra_err_t priv_dir_find_long(const ra_fs_mount_t* m,
                            const dir_loc_t*     loc,
                            const char*          want,
                            uint32_t*            out_lba,
                            uint32_t*            out_entry_off,
 ...
 * @since 0.1.0
 */
void priv_dir_walk_init_loc(const ra_fs_mount_t* m, const dir_loc_t* loc, dir_walk_t* w);
 ...
 * @since 0.1.0
 */
ra_err_t priv_dir_walk_next_sector(const ra_fs_mount_t* m, dir_walk_t* w, uint8_t* out_eod);
 ...
 * @since 0.1.0
 */
uint32_t priv_eoc_write(const ra_fs_mount_t* m);
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_create(ra_fs_mount_t* m, const char* path, const uint8_t* data, uint32_t len);
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_find(const ra_fs_mount_t* m,
                         const char*          path,
                         uint32_t*            out_first,
                         uint32_t*            out_size,
                         uint8_t*             out_nofat);
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_find_bitmap(const ra_fs_mount_t* m, uint32_t* out_clus, uint32_t* out_len);
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_listdir(const ra_fs_mount_t* m, ra_fs_listdir_cb_t cb, void* ctx);
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_next_entry(const ra_fs_mount_t* m, exfat_cursor_t* cur, uint8_t* out);
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_open(ra_fs_mount_t* handle,
                         const char*    path,
                         ra_fs_mode_t   mode,
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_rename(const ra_fs_mount_t* m, const char* old_path, const char* new_path);
 ...
 * @since 0.1.0
 */
ra_err_t priv_exfat_unlink(const ra_fs_mount_t* m, const char* path);
