...
/**
 * @enum ra8_mdl_storage_vfs_limits_t
 ...
 * @note Optional in ::ra8_mdl_storage_vfs_config_t. A null callback selects
 *       size/type validation only, suitable for format-agnostic raw bytes.
 * @since 0.1.0
 */
typedef ra8_err_t (*ra8_mdl_storage_vfs_validate_fn)(void*         ctx,
                                                     const char*   staging_path,
                                                     uint64_t      total_bytes,
                                                     const uint8_t sha256[k_ra8_mdl_sha256_bytes]);

/**
 * @struct ra8_mdl_storage_vfs_config_t
...
/**
 * @enum ra8_mdl_storage_vfs_state_t
 * @brief Observable adapter lifecycle state.
 * @since 0.1.0
 */
typedef enum : uint8_t {
  k_ra8_mdl_storage_vfs_idle      = 0, /**< No owned private object.       */
  k_ra8_mdl_storage_vfs_writing   = 1, /**< Private writer is open.        */
  k_ra8_mdl_storage_vfs_staged    = 2, /**< Writer closed; not validated.  */
  k_ra8_mdl_storage_vfs_ready     = 3, /**< Validated and ready to rename. */
  k_ra8_mdl_storage_vfs_committed = 4, /**< Destination was published.     */
} ra8_mdl_storage_vfs_state_t;

/**
 * @struct ra8_mdl_storage_vfs_t
 ...
 * fields as private after ::ra8_mdl_storage_vfs_init.
 *
 ...
 */
typedef struct {
  ra8_io_vfs_file_t*              file;                       /**< Open private writer.       */
  ra8_mdl_storage_vfs_validate_fn validate;                   /**< Optional delegated check.  */
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra8_err_t ra8_mdl_storage_vfs_init(ra8_mdl_storage_vfs_t*              storage,
