 ...
 * Arm v8-M ARM. Every access goes through the ::ra8_scb_reg address accessor
 ...
 *          `*ra8_scb_reg(k_...)` instead of an inline cast. Always inlined.
 *
 ...
 * @since 0.1.0
 */
RA8_HW_REGISTER_ACCESS static inline volatile uint32_t* ra8_scb_reg(ra8_scb_reg_addr_t addr)
{
...
ra8_err_t ra8_scb_read_fault_status(ra8_scb_fault_status_t* out)
{
  ...
  out->cfsr  = *ra8_scb_reg(k_ra8_scb_cfsr);
  out->hfsr  = *ra8_scb_reg(k_ra8_scb_hfsr);
  out->dfsr  = *ra8_scb_reg(k_ra8_scb_dfsr);
  out->mmfar = *ra8_scb_reg(k_ra8_scb_mmfar);
  out->bfar  = *ra8_scb_reg(k_ra8_scb_bfar);
  out->afsr  = *ra8_scb_reg(k_ra8_scb_afsr);
  ...
  out->sfsr = *ra8_scb_reg(k_ra8_scb_sfsr);
  out->sfar = *ra8_scb_reg(k_ra8_scb_sfar);
  return k_ra8_ok;
}
...
void ra8_scb_trace_enable(void)
{
  ...
  const uint32_t demcr          = *ra8_scb_reg(k_ra8_scb_demcr);
  *ra8_scb_reg(k_ra8_scb_demcr) = demcr | (uint32_t)k_ra8_scb_demcr_trcena;
}
