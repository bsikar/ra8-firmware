 ...
 *
 * @details
 * `ra_ui` is the interaction / controller layer for the e-reader UI
 * (issue #80). The rendering engines (`ra_reflow`, `ra_gfx`) emit boxes
 ...
 * `ra_gfx` today and `ra_reflow` box rectangles later.
 *
 ...
 *
 * @return ra_err_t
 * @retval k_ra_ok           Search completed (see @p out_hit).
 * @retval k_ra_err_null_ptr @p out_action / @p out_hit NULL, or
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_hit_test(const ra_ui_target_t* targets,
                                      uint16_t              count,
                                      int32_t               px,
                                      int32_t               py,
                                      uint16_t*             out_action,
 ...
 *
 * @return ra_err_t
 * @retval k_ra_ok           Initialised (`depth == 1`).
 * @retval k_ra_err_null_ptr @p nav is NULL.
 *
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_nav_init(ra_ui_nav_t* nav, uint16_t root_screen);
 ...
 *
 * @return ra_err_t
 * @retval k_ra_ok              Pushed (`depth` incremented).
 * @retval k_ra_err_null_ptr    @p nav is NULL.
 * @retval k_ra_err_no_mem      Stack already at `k_ra_ui_nav_max_depth`.
 * @retval k_ra_err_invalid_state Stack not initialised (`depth == 0`).
 *
 * @pre @p nav is non-NULL and initialised.
 * @pre `nav->depth < k_ra_ui_nav_max_depth` for success.
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_nav_push(ra_ui_nav_t* nav, uint16_t screen);
 ...
 *
 * @return ra_err_t
 * @retval k_ra_ok              Popped; `*out_screen` is the new top.
 * @retval k_ra_err_null_ptr    @p nav or @p out_screen is NULL.
 * @retval k_ra_err_invalid_state Already at the root (`depth <= 1`).
 *
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_nav_pop(ra_ui_nav_t* nav, uint16_t* out_screen);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_nav_replace(ra_ui_nav_t* nav, uint16_t screen);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_nav_top(const ra_ui_nav_t* nav, uint16_t* out_screen);
 ...
 *
 * @return ra_err_t
 * @retval k_ra_ok            Initialised at page 0.
 * @retval k_ra_err_null_ptr  @p p is NULL.
 * @retval k_ra_err_invalid_arg @p total is 0.
 *
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_pager_init(ra_ui_pager_t* p, uint16_t total);
 ...
 *
 * @return ra_err_t
 * @retval k_ra_ok           Done (see @p out_changed).
 * @retval k_ra_err_null_ptr @p p or @p out_changed is NULL.
 *
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_pager_next(ra_ui_pager_t* p, bool* out_changed);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_pager_prev(ra_ui_pager_t* p, bool* out_changed);
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t ra_ui_pager_goto(ra_ui_pager_t* p, uint16_t page, bool* out_changed);
