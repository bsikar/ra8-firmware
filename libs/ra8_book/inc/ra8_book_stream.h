/**
 * @file ra8_book_stream.h
 * @brief Strict, zero-allocation validation of a streamed RABOOK1 flat blob.
 * @ingroup grp_ereader
 *
 * @details The resident @ref ra8_book_validate API preserves the original v1
...
/**
 * @typedef ra8_book_stream_read_fn
 ...
 * @since Version 0.1.0
 */
typedef ra8_err_t (*ra8_book_stream_read_fn)(void*    ctx,
                                             uint64_t offset,
                                             uint8_t* dst,
                                             uint32_t len);
 ...
 * @since Version 0.1.0
 */
[[nodiscard]] ra8_err_t ra8_book_validate_stream_strict(ra8_book_stream_read_fn read,
                                                        void*                   read_ctx,
