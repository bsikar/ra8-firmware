/**
 * @file libs/ra8_board_ra8p1/src/boot/secure_exception.c
 ...
 *       TrustZone-M SecureFault behaviour (see libs/ra8_core/inc/ra8_device.h),
 *       so the handler is common to both boards.
 *
 * @details
 ...
 *
 * @note Runs only in SecureFault context and is not thread-callable.
 *
