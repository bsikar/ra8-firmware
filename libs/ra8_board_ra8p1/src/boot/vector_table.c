/**
 * @file libs/ra8_board_ra8p1/src/boot/vector_table.c
 * @brief Cortex-M85 vector table and default interrupt handlers for RA8D2/RA8P1
 *
 * @par Tag
 * [Ring 1 / Boot] {World: S}
 *
 ...
 *       vector layout and IRQ event numbering (see libs/ra8_core/inc/ra8_device.h),
 *       so the vector table is common. The RA8P1 foundation apps
 *       (examples/ra8p1_foundation) currently override this with an app-local
 *       vector_table.c; this canonical copy serves future RA8P1 apps that do not.
 *
 * @details
 ...
 * libs/ra8_board_ra8p1/ld/linker_script.ld) defines them with this
 * exact spelling.
 */
...
/**
 * @brief Enter an RA8P1 firmware image after processor reset.
