...
//!
//! Build graph for the Zig implementation of the Flash Translation Layer
//! core (`ra8_ftl`). CMake consumes the installed static library through the
//! unchanged `inc/ra8_ftl.h` C ABI; the `test` step covers the pure
...
pub fn build(b: *std.Build) void {
    ...
    const library_module = b.createModule(.{
        .root_source_file = b.path("src/ra8_ftl_abi.zig"),
        .target = target,
        .optimize = optimize,
    });
