 ...
 * @retval k_ra_err_invalid_arg  @p kind out of range.
 *
 ...
 *
 * @return ra_err_t Error code.
 * @retval k_ra_ok               Decision written.
 * @retval k_ra_err_null_ptr     @p p or @p out is NULL.
 * @retval k_ra_err_invalid_arg  @p event out of range.
 *
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t display_policy_decide(display_policy_t*          p,
 ...
 *
 * @return ra_err_t Error code.
 * @retval k_ra_ok              Rectangle written.
 * @retval k_ra_err_null_ptr    @p out is NULL.
 * @retval k_ra_err_invalid_arg @p w or @p h is 0.
 *
 * @pre @p out points to writable storage.
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra_err_t display_policy_full_rect(uint16_t w, uint16_t h, display_rect_t* out);
