...
/**
 * @enum ra_usb_pal_ep_type_t
 * @brief USB endpoint transfer type.
 */
typedef enum : uint8_t {
  k_ra_usb_pal_ep_type_control = 0U,
  k_ra_usb_pal_ep_type_iso     = 1U,
  k_ra_usb_pal_ep_type_bulk    = 2U,
  k_ra_usb_pal_ep_type_intr    = 3U,
} ra_usb_pal_ep_type_t;

/**
 * @enum ra_usb_pal_state_t
...
/* =============================================================================
 * Event bits (relayed from ra_usb status mask)
 * =============================================================================
 */

/**
 * @enum ra_usb_pal_event_t
 * @brief Event mask bits passed to ``ra_usb_pal_event_fn_t``.
 */
typedef enum : uint16_t {
 ...
 * @post ``ra_usb_pal_get_state`` returns ``detached``.
 *
