...
# the `RA_USE_FILEX` option; when ON, this file:
#
...
#      `ra_sdhi` block driver.
#
# Apps that want FileX `target_link_libraries(<app>.elf PRIVATE
# filex filex_port_ra_sdhi)` -- everything else (include dirs,
...
if(DEFINED _RA_FILEX_INCLUDED)
    return()
endif()
set(_RA_FILEX_INCLUDED TRUE)
...
if(NOT RA_USE_THREADX)
    message(FATAL_ERROR
        "RA_USE_FILEX=ON requires RA_USE_THREADX=ON. FileX's protection "
...
get_filename_component(_RA_FILEX_REPO_ROOT
    "${CMAKE_CURRENT_LIST_DIR}/.." ABSOLUTE)

set(_RA_FILEX_VENDOR_DIR  "${_RA_FILEX_REPO_ROOT}/libs/third_party/filex")
set(_RA_FILEX_COMMON_INC  "${_RA_FILEX_VENDOR_DIR}/common/inc")
set(_RA_FILEX_COMMON_SRC  "${_RA_FILEX_VENDOR_DIR}/common/src")
set(_RA_FILEX_PORT_INC    "${_RA_FILEX_VENDOR_DIR}/ports/cortex_m33/gnu/inc")

if(NOT EXISTS "${_RA_FILEX_COMMON_INC}/fx_api.h")
    message(FATAL_ERROR
        "RA_USE_FILEX=ON but FileX vendor tree is missing at "
        "${_RA_FILEX_VENDOR_DIR}.")
endif()
...
# added or removed.
file(GLOB _RA_FILEX_COMMON_SOURCES CONFIGURE_DEPENDS
    "${_RA_FILEX_COMMON_SRC}/*.c")
...
add_library(filex_objs OBJECT ${_RA_FILEX_COMMON_SOURCES})

target_include_directories(filex_objs PUBLIC
    ${_RA_FILEX_COMMON_INC}
    ${_RA_FILEX_PORT_INC})
...
# Now pull in our ra_sdhi <-> FileX shim.
add_subdirectory(${_RA_FILEX_REPO_ROOT}/port/filex
                 ${CMAKE_BINARY_DIR}/port_filex)

message(STATUS "FileX enabled: ${_RA_FILEX_VENDOR_DIR}")
