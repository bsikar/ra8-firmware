...
file(GLOB RA8_THREADX_NS_COMMON_SOURCES CONFIGURE_DEPENDS
     "${RA8_THREADX_ROOT}/common/src/*.c")
file(GLOB RA8_THREADX_NS_PORT_ASM CONFIGURE_DEPENDS
     "${RA8_THREADX_M85_GNU}/src/*.S")
file(GLOB RA8_THREADX_NS_PORT_C CONFIGURE_DEPENDS
     "${RA8_THREADX_M85_GNU}/src/*.c")

# Drop the upstream low-level init -- replaced by the project-tuned version.
list(FILTER RA8_THREADX_NS_PORT_ASM
