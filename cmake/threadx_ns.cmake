...
# RA_THREADX_NON_SECURE so port/threadx/tx_user.h selects TX_SINGLE_MODE_NON_SECURE
...
#
#     include(${RA_REPO_ROOT}/cmake/threadx_ns.cmake)
...
file(GLOB RA_THREADX_NS_COMMON_SOURCES CONFIGURE_DEPENDS
     "${RA_THREADX_ROOT}/common/src/*.c")
file(GLOB RA_THREADX_NS_PORT_ASM CONFIGURE_DEPENDS
     "${RA_THREADX_M85_GNU}/src/*.S")
file(GLOB RA_THREADX_NS_PORT_C CONFIGURE_DEPENDS
     "${RA_THREADX_M85_GNU}/src/*.c")

# Drop the upstream low-level init -- replaced by the project-tuned version.
list(FILTER RA_THREADX_NS_PORT_ASM
     EXCLUDE REGEX ".*/tx_initialize_low_level\\.S$")

set(RA_THREADX_NS_PROJECT_LOW_LEVEL
    "${RA_THREADX_PORT_DIR}/cortex_m85/tx_initialize_low_level.S")

add_library(threadx_ns STATIC
    ${RA_THREADX_NS_COMMON_SOURCES}
    ${RA_THREADX_NS_PORT_ASM}
    ${RA_THREADX_NS_PORT_C}
    ${RA_THREADX_NS_PROJECT_LOW_LEVEL}
...
# RA_THREADX_NON_SECURE flips tx_user.h to TX_SINGLE_MODE_NON_SECURE. PUBLIC so
# the consuming app's TUs (ns_main.c) see the same kernel-option view.
target_compile_definitions(threadx_ns PUBLIC
    TX_INCLUDE_USER_DEFINE_FILE
    RA_THREADX_NON_SECURE
)

target_link_options(threadx_ns INTERFACE
...
target_compile_options(threadx_ns PRIVATE
