...
function(ra_target_enable_project_warnings target)
    ...
    target_compile_options(${target} PRIVATE
        ...
        -Wextra
        -Werror
        # GUIX retirement (issue #81): the GUIX display path is marked
        # [[deprecated]] while the chrome migrates to ra_reflow (issue #80).
        # Keep those markers as visible warnings instead of -Werror build
        # breaks until GUIX is deleted. Remove this line with the GUIX stack.
