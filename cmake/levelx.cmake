...
get_filename_component(_RA8_LEVELX_REPO_ROOT
...
if(NOT EXISTS "${_RA8_LEVELX_COMMON_INC}/lx_api.h")
    message(FATAL_ERROR
        "RA8_USE_LEVELX=ON but LevelX vendor tree is missing at "
...
list(FILTER _RA8_LEVELX_NOR_SOURCES
...
add_subdirectory(${_RA8_LEVELX_REPO_ROOT}/port/levelx
