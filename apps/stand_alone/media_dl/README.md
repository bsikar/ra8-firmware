...
portable core under `apps/shared/media_dl`, written over an injected transport
...
streaming JPEG decoder, with no whole-image allocation, and the `ra8_longstrip`
