/**
 * @file apps/board/stand_alone/ereader/src/secure_exception.c
 ...
 * @pre The Secure exception stack contains the interrupted context.
 *
 * @post Logs the SFSR snapshot and spins.
 * @post Interrupts remain masked until an external reset.
 *
 * @note Runs only in Secure exception context and never returns.
 * @since 0.1.0
 *
