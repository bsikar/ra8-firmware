 ...
 * typedefs, and the engine handle (::reflow_t) itself. It is split out of
 * the umbrella `reflow.h` so that header stays small; consumers still
 * include `reflow.h` and never reference this file directly.
 *
 *
 * [Ring 4 / Reflow]
 * {World: NS}
...
typedef enum : uint32_t {
  k_reflow_max_tokens         = 4096U,  /**< Max parsed token count.              */
  k_reflow_text_pool_bytes    = 65536U, /**< Bytes of text pool.                  */
  k_reflow_max_glyphs         = 32768U, /**< Total positioned glyphs.             */
  k_reflow_max_pages          = 256U,   /**< Max paginated pages.                 */
  k_reflow_max_lines_per_page = 96U,    /**< Lines per page upper bound.          */
  k_reflow_max_images         = 64U,    /**< Max laid-out `<img>` boxes.          */
  k_reflow_max_links          = 255U,   /**< Max distinct `<a href>` per chapter. */
  k_reflow_max_link_rects     = 512U,   /**< Max positioned link rectangles.      */
  k_reflow_max_anchors        = 256U,   /**< Max `id=` anchor positions.          */
  k_reflow_max_faces          = 8U,     /**< Max embedded `@font-face` typefaces. */
} reflow_limits_t;

/**
 * @enum reflow_layout_t
...
typedef enum : uint16_t {
  k_reflow_margin_px        = 16U,  /**< Page edge inset, pixels.        */
  k_reflow_line_spacing_num = 12U,  /**< Line height numerator (= 1.2x). */
  k_reflow_line_spacing_den = 10U,  /**< Line height denominator.        */
  k_reflow_paragraph_gap_px = 8U,   /**< Vertical gap after a block.     */
  k_reflow_indent_px        = 24U,  /**< Indent for blockquote / li.     */
  k_reflow_default_font_px  = 18U,  /**< Default body font size.         */
  k_reflow_min_font_px      = 8U,   /**< Smallest accepted font size.    */
  k_reflow_max_font_px      = 96U,  /**< Largest accepted font size.     */
  k_reflow_min_font_bytes   = 16U,  /**< Smallest plausible font blob.   */
  k_reflow_h1_scale_pct     = 200U, /**< H1 size = 200 % of body.        */
  k_reflow_h2_scale_pct     = 175U, /**< H2 size = 175 % of body.        */
  k_reflow_h3_scale_pct     = 150U, /**< H3 size = 150 % of body.        */
  k_reflow_h4_scale_pct     = 125U, /**< H4 size = 125 % of body.        */
  k_reflow_h5_scale_pct     = 110U, /**< H5 size = 110 % of body.        */
  k_reflow_h6_scale_pct     = 100U, /**< H6 size = 100 % of body.        */
  k_reflow_pct_full         = 100U, /**< Percentage denominator.         */
} reflow_layout_t;

/**
 * @enum reflow_html_tag_t
...
typedef enum : uint8_t {
  k_reflow_tag_unknown    = 0U,  /**< Anything not in this enum.       */
  k_reflow_tag_p          = 1U,  /**< Paragraph block.                 */
  k_reflow_tag_h1         = 2U,  /**< Heading level 1.                 */
  k_reflow_tag_h2         = 3U,  /**< Heading level 2.                 */
  k_reflow_tag_h3         = 4U,  /**< Heading level 3.                 */
  k_reflow_tag_h4         = 5U,  /**< Heading level 4.                 */
  k_reflow_tag_h5         = 6U,  /**< Heading level 5.                 */
  k_reflow_tag_h6         = 7U,  /**< Heading level 6.                 */
  k_reflow_tag_em         = 8U,  /**< Italic emphasis (inline).        */
  k_reflow_tag_strong     = 9U,  /**< Bold emphasis (inline).          */
  k_reflow_tag_b          = 10U, /**< Bold (inline).                   */
  k_reflow_tag_i          = 11U, /**< Italic (inline).                 */
  k_reflow_tag_br         = 12U, /**< Line break (void).               */
  k_reflow_tag_hr         = 13U, /**< Horizontal rule (void).          */
  k_reflow_tag_ul         = 14U, /**< Unordered list block.            */
  k_reflow_tag_ol         = 15U, /**< Ordered list block.              */
  k_reflow_tag_li         = 16U, /**< List item.                       */
  k_reflow_tag_blockquote = 17U, /**< Blockquote indent.               */
  k_reflow_tag_a          = 18U, /**< Anchor (renders underlined).     */
  k_reflow_tag_img        = 19U, /**< Image (placeholder rect).        */
  k_reflow_tag_table      = 20U, /**< Table (grid layout).             */
  k_reflow_tag_tr         = 21U, /**< Table row.                       */
  k_reflow_tag_td         = 22U, /**< Table cell.                      */
  k_reflow_tag_th         = 23U, /**< Table header cell.               */
  k_reflow_tag_link       = 24U, /**< `<link>` (void; stylesheet ref). */
} reflow_html_tag_t;

/**
 * @enum reflow_font_style_t
 ...
 */
typedef enum : uint8_t {
  k_reflow_style_normal    = 0U,       /**< No emphasis.    */
  k_reflow_style_bold      = 1U << 0U, /**< Bold face.      */
  k_reflow_style_italic    = 1U << 1U, /**< Italic face.    */
  k_reflow_style_underline = 1U << 2U, /**< Underlined run. */
} reflow_font_style_t;

/**
 * @enum reflow_face_pack_t
 ...
 */
typedef enum : uint8_t {
  k_reflow_face_shift = 4U,    /**< Bit position of the face index in `style`. */
  k_reflow_face_mask  = 0x0FU, /**< Face-index mask once shifted down.         */
} reflow_face_pack_t;
 ...
 */
typedef enum : uint8_t {
  k_reflow_align_left    = 0U, /**< Left (default, ragged right).       */
  k_reflow_align_right   = 1U, /**< Right-aligned.                      */
  k_reflow_align_center  = 2U, /**< Centred.                            */
  k_reflow_align_justify = 3U, /**< Justified (last line left-aligned). */
} reflow_align_t;

/**
 * @enum reflow_token_kind_t
 * @brief Parsed token classification.
 *
 * @details
 * The parser converts the markup into a flat token stream. Block-start
 * and block-end tokens carry an `reflow_html_tag_t`; inline tokens
 * carry text (a slice of the engine text pool) plus a font-style
 * stamp.
 */
typedef enum : uint8_t {
  k_reflow_tok_block_start = 0U, /**< Open of a block-flow element.  */
  k_reflow_tok_block_end   = 1U, /**< Close of a block-flow element. */
  k_reflow_tok_text        = 2U, /**< Text run (slice into pool).    */
  k_reflow_tok_break       = 3U, /**< Forced line break (`<br>`).    */
  k_reflow_tok_rule        = 4U, /**< Horizontal rule (`<hr>`).      */
  k_reflow_tok_image       = 5U, /**< Image placeholder (`<img>`).   */
} reflow_token_kind_t;
 ...
 */
typedef enum : uint32_t {
  k_reflow_color_inherit = 0xFFFFFFFFU, /**< No per-run CSS colour. */
} reflow_color_t;
 ...
 * array of these. Treat fields as read-only outside of `reflow_*`.
 */
typedef struct {
  uint8_t  kind;        /**< `reflow_token_kind_t`.                            */
  uint8_t  tag;         /**< `reflow_html_tag_t` (0 if N/A).                   */
  ...
  uint32_t color;       /**< 0xRRGGBB CSS colour, or k_reflow_color_inherit.   */
 ...
 * (see reflow_set_image_loader()). Coordinates are page-local -- the same
 * space as reflow_glyph_t -- so render offsets them by the page origin.
 ...
 *
 * @param[in]  ctx       Opaque context passed to reflow_set_image_loader().
 ...
 * @since 0.1.0
 */
typedef ra8_err_t (*reflow_image_loader_fn)(void*           ctx,
                                            const char*     href,
                                            uint32_t        href_len,
 ...
 *
 * @details Dependency-injection seam (NASA P10 Rule 9 deviation: function
 * pointer for testability / DIP), mirroring ::reflow_image_loader_fn. The
 ...
 *
 * @param[in]  ctx       Opaque context passed to reflow_set_css_loader().
 ...
 * @since 0.1.0
 */
typedef ra8_err_t (*reflow_css_loader_fn)(void*           ctx,
                                          const char*     href,
                                          uint32_t        href_len,
                                          const uint8_t** out_bytes,
                                          size_t*         out_len);
 ...
 * Multiple positioned rectangles (::reflow_link_rect_t) can reference the
...
} reflow_link_target_t;

/**
 * @struct reflow_link_rect_t
 * @brief One tappable rectangle covering a run of `<a>` glyphs on a page.
 *
 * @details Page-local coordinates (the same space as reflow_glyph_t). A link
...
/**
 * @enum reflow_href_kind_t
 * @brief Classification of an in-content `<a href>` target.
 */
typedef enum : uint8_t {
  k_reflow_href_empty            = 0U, /**< Empty / whitespace-only href.       */
  k_reflow_href_fragment         = 1U, /**< "#id" -- same-chapter anchor.       */
  k_reflow_href_chapter          = 2U, /**< "path" -- another chapter, no frag. */
  k_reflow_href_chapter_fragment = 3U, /**< "path#id" -- chapter + anchor.      */
  k_reflow_href_external         = 4U, /**< Has a URI scheme (http:, mailto:).  */
} reflow_href_kind_t;
...
/**
 * @enum reflow_face_pad_t
 * @brief Padding geometry for ::reflow_face_t.
 *
 * @details Names the trailing-pad byte count that rounds ::reflow_face_t up
 * to an 8-byte stride (one pointer, one `size_t`, one `uint8_t` index, then
 * `k_reflow_face_pad8` bytes of padding).
 *
 * @see reflow_face_t
 */
typedef enum : uint8_t {
  k_reflow_face_pad8 = 7, /**< Pad bytes to reach an 8-byte struct stride. */
} reflow_face_pad_t;
 ...
 * The engine holds up to ::k_reflow_max_faces of these; the render pass
 * builds one `stbtt_fontinfo` per registered face plus the default at index 0.
 *
 * @see reflow_register_face()
 */
typedef struct {
  ...
  uint8_t        pad8[k_reflow_face_pad8]; /**< Padding to an 8-byte stride.                  */
} reflow_face_t;
 ...
 * and bound via `reflow_init()`. Treat all fields as read-only;
 * mutate only through the `reflow_*` API.
 *
 * @invariant `in_use == 1` while initialized; cleared by `reflow_close()`.
 *
 * @see reflow_init()
 * @see reflow_close()
 */
typedef struct {
  ...
  reflow_face_t  faces[k_reflow_max_faces]; /**< Embedded `@font-face` set.             */
  ...
  /* --- token stream --------------------------------------------------- */
  reflow_token_t tokens[k_reflow_max_tokens];         /**< Parsed tokens.               */
  uint32_t       token_count;                         /**< Tokens used.                 */
  uint8_t        text_pool[k_reflow_text_pool_bytes]; /**< Text bytes.                  */
  uint32_t       text_pool_used;                      /**< Bytes consumed in text_pool. */

  /* --- laid-out glyphs ------------------------------------------------ */
  reflow_glyph_t glyphs[k_reflow_max_glyphs]; /**< Positioned glyphs. */
  ...
  reflow_css_loader_fn   css_loader;     /**< `<link>` CSS loader (NULL = off). */
