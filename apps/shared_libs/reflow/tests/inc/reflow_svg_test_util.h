 ...
 * @brief Shared framebuffer fixture for the test_reflow_svg_*_mcdc.c siblings.
 *
 * @details
 ...
 * wrapper shared by test_reflow_svg_scan_mcdc.c,
 * test_reflow_svg_shape_mcdc.c, and test_reflow_svg_paint_mcdc.c.
