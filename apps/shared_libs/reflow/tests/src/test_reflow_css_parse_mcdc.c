/**
 * @file test_reflow_css_parse_mcdc.c
 * @brief MC/DC tests for the content-CSS parser / value-scanner decisions.
 *
 * @details
 * Split sibling of test_reflow_css_select_mcdc.c covering the parse-side
 * decision families of reflow_css: the whitespace class, the
...
/**
 * @test internal_test_whitespace_variants
 ...
 * @details Exercises the whitespace variants path and preserves each documented result and bound.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_whitespace_variants(void)
{
  ...
  TEST_ASSERT_EQ(k_reflow_align_center, s_sheet.rules[0].decl.align);
  TEST_END("css whitespace variants (priv_is_ws 5-OR)");
}

/**
 * @test internal_test_ci_eq_length_tiebreak
 * @brief A value longer than the keyword does NOT match (length tie-break).
 *
 * @par MC/DC:
 * Decision: `internal_ci_eq` return `(k == len) && (lit[k] == '\0')` (2-cond AND;
 ...
 * @details Exercises the ci eq length tiebreak path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_ci_eq_length_tiebreak(void)
{
...
/**
 * @test internal_test_ci_contains_short_span
 * @brief text-decoration shorter than "underline" hits the sub-too-long guard.
 *
 * @par MC/DC:
 * Decision: `internal_ci_contains` early-out `(s==NULL) || (sl==0) || (sl > len)`
 ...
 * @details Exercises the ci contains short span path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_ci_contains_short_span(void)
{
  TEST_BEGIN("css priv_ci_contains short-span guard (sl > len)");
  const uint8_t   ubit = (uint8_t)k_reflow_style_underline;
...
/**
 * @test internal_test_hex_val_ranges
 * @brief Hex colours exercise the digit, lower a-f, and not-a-digit arms.
 *
 * @par MC/DC:
 * internal_hex_val classifies each colour byte through two ranges:
 *   `(c>='0') && (c<='9')`  -> digit arm,
 ...
 * @details Exercises the hex val ranges path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_hex_val_ranges(void)
{
...
/**
 * @test internal_test_parse_color_grey_and_bad_hex
 * @brief gray/grey both resolve via the keyword OR; a digitless `#` is invalid.
 *
 * @par MC/DC:
 * Two decisions in internal_parse_color / internal_parse_hex_color:
 ...
 *  (B) internal_parse_hex_color length dispatch `len == 6` / `len == 3`:
 ...
 * @details Exercises the parse color grey and bad hex path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_parse_color_grey_and_bad_hex(void)
{
...
/**
 * @test internal_test_fontsize_fractional_loops
 * @brief Fractional font-size digits beyond the cap are kept-then-skipped.
 *
 * @par MC/DC:
 * Two loops in internal_scan_hundredths:
 ...
 * @details Exercises the fontsize fractional loops path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_fontsize_fractional_loops(void)
{
...
/**
 * @test internal_test_font_weight_keywords
 * @brief All six bold-selecting font-weight keywords flip the bold value bit.
 *
 * @par MC/DC:
 * Decision (internal_apply_emphasis): `bold || bolder || 600 || 700 || 800 || 900`
 ...
 * @details Exercises the font weight keywords path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_font_weight_keywords(void)
{
  TEST_BEGIN("css font-weight bold keyword 6-OR");
  const uint8_t      bbit               = (uint8_t)k_reflow_style_bold;
  ...
  for (size_t w = 0U; w < (sizeof(s_bold_kw) / sizeof(s_bold_kw[0])); ++w) {
    size_t pos = css_test_append(buf, sizeof buf, 0U, "font-weight: ");
    (void)css_test_append(buf, sizeof buf, pos, s_bold_kw[w]);
...
/**
 * @test internal_test_font_style_oblique
 * @brief font-style accepts both `italic` and `oblique`; `normal` clears it.
 *
 * @par MC/DC:
 * Decision (internal_apply_emphasis): `ci_eq("italic") || ci_eq("oblique")`
 * (2-cond OR; N+1 = 3):
 ...
 * @details Exercises the font style oblique path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_font_style_oblique(void)
{
  TEST_BEGIN("css font-style italic/oblique OR");
  const uint8_t   ibit = (uint8_t)k_reflow_style_italic;
 ...
 * @par MC/DC:
 * Decision identity:
 * `apps/shared_libs/reflow/src/reflow_css.c@internal_apply_emphasis`.
...
RA8_INTERNAL static void internal_test_mcdc_emphasis_property_names(void)
{
  ...
  const uint8_t         underline_bit = (uint8_t)k_reflow_style_underline;
 ...
 *
 * @par MC/DC:
 * Decision (priv_parse_decls / internal_for_each_decl): `(plen > 0) && (vlen > 0)`
 ...
 * @details Exercises the empty decl guard path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_empty_decl_guard(void)
{
...
/**
 * @test internal_test_name_overflow_rejected
 * @brief A class name longer than k_ra8_css_name_max drops the whole rule.
 *
 * @par MC/DC:
 * Decision (internal_intern_name): `(len == 0) || (len > k_ra8_css_name_max)`
 ...
 *    internal_parse_sel_part returns false -> the rule is dropped).
 ...
 * @details Exercises the name overflow rejected path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_name_overflow_rejected(void)
{
  ...
  size_t pos = css_test_append(buf, sizeof buf, 0U, ".note { color: red; } .");
  pos        = css_test_append(buf, sizeof buf, pos, longname);
  (void)css_test_append(buf, sizeof buf, pos, " { color: blue; }");
  load(buf);
...
/**
 * @test internal_test_at_rule_split
 ...
 * @details Exercises the at rule split path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_at_rule_split(void)
{
...
/**
 * @test internal_test_unterminated_block
 * @brief A rule whose `{` has no closing `}` still parses to end-of-input.
 *
 * @par MC/DC:
 * internal_find_block's close-brace scan `(close < len) && (css[close] != '}')`:
 ...
 * @details Exercises the unterminated block path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_unterminated_block(void)
{
...
/**
 * @test internal_test_comment_open_scan
 ...
 * @details Exercises the comment open scan path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_comment_open_scan(void)
{
  ...
  TEST_ASSERT_EQ(2, s_sheet.rule_count);
  TEST_ASSERT_EQ(k_reflow_tag_p, s_sheet.rules[0].sel_tag);
  TEST_ASSERT_EQ(k_reflow_tag_h1, s_sheet.rules[1].sel_tag);
  TEST_ASSERT_EQ(k_css_color_red, s_sheet.rules[0].decl.color);
  TEST_ASSERT_EQ(k_css_color_blue, s_sheet.rules[1].decl.color);
...
/**
 * @test internal_test_hex_val_below_ranges
 * @brief A hex byte below '0' and below 'a' isolates the lower-range conditions.
 *
 * @par MC/DC:
 * internal_hex_val has two range tests:
 *   `(c >= '0') && (c <= '9')`  (digit arm)
 ...
 * @details Exercises the hex val below ranges path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_hex_val_below_ranges(void)
{
...
/**
 * @test internal_test_fontsize_frac_end_of_input
 * @brief Fractional digits that run to end-of-input exit the loops via `*i<len`.
 *
 * @par MC/DC:
 * Two loops in internal_scan_hundredths exit when the span ends mid-fraction
 ...
 * Neither span carries a unit suffix, so internal_parse_fontsize returns false and
 * `font-size` is NOT set; the point is that the scan terminated on `*i < len`.
 * @details Exercises the fontsize frac end of input path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_fontsize_frac_end_of_input(void)
{
...
/**
 * @test internal_test_strip_quotes_short_and_unclosed
 * @brief A 1-byte family and an unmatched closing quote are NOT quote-stripped.
 *
 * @par MC/DC:
 * Decision (internal_strip_quotes): `(*len >= 2) && ((s[0]=='"') || (s[0]=='\'')) &&
 ...
 * @details Exercises the strip quotes short and unclosed path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_strip_quotes_short_and_unclosed(void)
{
  ...
  TEST_ASSERT(css_test_bytes_equal(&s_sheet.names[s_sheet.faces[1].family_off], "\"AB'", 4U));
  TEST_END("css strip_quotes short / unmatched-close arms");
}

/**
 * @test internal_test_extract_url_unterminated
 * @brief A `url(` with no closing `)` is scanned to end-of-value.
 *
 * @par MC/DC:
 * Loop (internal_extract_url): `while ((b < vlen) && (val[b] != ')'))`. The existing
 ...
 * @details Exercises the extract url unterminated path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_extract_url_unterminated(void)
{
...
/**
 * @test internal_test_for_each_decl_empty_pairs
 * @brief Empty @font-face descriptor pairs are skipped by the iterator guard.
 *
 * @par MC/DC:
 * Decision (internal_for_each_decl): `(plen > 0U) && (vlen > 0U)` (2-cond AND),
 ...
 * @details Exercises the for each decl empty pairs path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_for_each_decl_empty_pairs(void)
{
...
/**
 * @test internal_test_block_empty_selector
 ...
 *    the style-rule path, but internal_parse_selector rejects an empty selector so
 *    no rule is added.
 *  - the following `p { ... }` proves parsing continues normally afterwards.
 * @details Exercises the block empty selector path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_block_empty_selector(void)
{
...
/**
 * @test internal_test_comment_scan_slash_not_star
 ...
 * the parser.
 * @details Exercises the comment scan slash not star path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_comment_scan_slash_not_star(void)
{
...
/**
 * @test internal_test_fontsize_dot_nondigit_mcdc
 *
 * @par MC/DC:
 * Decisions: the two fractional-digit scan loops in internal_scan_hundredths
 * (apps/shared_libs/reflow/src/reflow_css.c) --
 ...
 * @brief Verify fontsize dot nondigit mcdc behavior against the reflow contract.
 * @details Exercises the fontsize dot nondigit mcdc path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_fontsize_dot_nondigit_mcdc(void)
{
...
/**
 * @test internal_test_intern_name_too_long_arms_mcdc
 *
 * @par MC/DC:
 * Decisions: the three `intern-succeeds` gates whose second condition
 * (internal_intern_name result) only takes its false side when a name overruns
 * k_ra8_css_name_max (apps/shared_libs/reflow/src/reflow_css_rules.c):
 *   - internal_face_apply font-family: `(n > 0U) && internal_intern_name(...)`.
 *   - internal_face_apply src:         `internal_extract_url(...) && internal_intern_name(...)`.
 *   - internal_family_cb:              `(n > 0U) && internal_intern_name(...)`.
 * Each existing vector drives the true side (short name interns). A name longer
 * than k_ra8_css_name_max makes internal_intern_name return false with the first
 ...
 * @brief Verify intern name too long arms mcdc behavior against the reflow contract.
 * @details Exercises the intern name too long arms mcdc path and preserves each documented result and bound.
 * @pre The referenced fixture inputs are valid for this scenario.
 * @pre Fixed-capacity output buffers are initialized before the operation.
 * @post All assertions for the scenario have passed before this function returns.
 * @post Caller-owned fixture storage remains valid for subsequent vectors.
 ...
 * @since 0.1.0
 */
RA8_INTERNAL static void internal_test_intern_name_too_long_arms_mcdc(void)
{
  ...
  size_t pos = css_test_append(css,
                               sizeof css,
                               0U,
                               "@font-face{font-family:Ok;src:url(o.ttf)}@font-face{font-family:");
  pos        = css_test_append(css, sizeof css, pos, k_long);
  pos = css_test_append(css, sizeof css, pos, ";src:url(g.ttf)}@font-face{font-family:Nm;src:url(");
  pos = css_test_append(css, sizeof css, pos, k_long);
  pos = css_test_append(css, sizeof css, pos, ".ttf)}p{font-family:");
  pos = css_test_append(css, sizeof css, pos, k_long);
  (void)css_test_append(css, sizeof css, pos, "}");
  load(css);
 ...
 *
 * @details Walks a function-local, fixed-order roster of every parser case so
 * adding a case remains a one-line edit. Cases run from top to bottom.
 *
...
int main(void)
{
  static void (*const s_test_roster[])(void) = {
    internal_test_whitespace_variants,
    internal_test_ci_eq_length_tiebreak,
    internal_test_ci_contains_short_span,
    internal_test_hex_val_ranges,
    internal_test_parse_color_grey_and_bad_hex,
    ...
    internal_test_unterminated_block,
    internal_test_comment_open_scan,
    internal_test_hex_val_below_ranges,
    internal_test_fontsize_frac_end_of_input,
    internal_test_strip_quotes_short_and_unclosed,
    internal_test_extract_url_unterminated,
    internal_test_for_each_decl_empty_pairs,
    internal_test_block_empty_selector,
    internal_test_comment_scan_slash_not_star,
    internal_test_fontsize_dot_nondigit_mcdc,
    internal_test_intern_name_too_long_arms_mcdc,
  };
