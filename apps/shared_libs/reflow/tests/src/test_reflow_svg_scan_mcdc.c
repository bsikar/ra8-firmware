/**
 * @file test_reflow_svg_scan_mcdc.c
 * @brief MC/DC tests for the SVG scanner primitives in apps/shared_libs/reflow.
 *
 * @details
 * Split sibling of test_reflow_svg_shape_mcdc.c and
 * test_reflow_svg_paint_mcdc.c covering the byte-level scanner decision
 ...
 * apps/shared_libs/reflow/src/reflow_svg.c@priv_ra8_svgp_ws). Driven through the real number
 ...
 * `(l>='a')&&(l<='f')` (apps/shared_libs/reflow/src/reflow_svg.c@internal_hex). A
 ...
 * `internal_hex_color` (apps/shared_libs/reflow/src/reflow_svg.c) -- combined with
 ...
 * (apps/shared_libs/reflow/src/reflow_svg.c@priv_ra8_svgp_num). A `viewBox` whose numbers
 ...
 * whitespace-after-`=` skip loop (apps/shared_libs/reflow/src/reflow_svg.c@priv_ra8_svgp_attr).
 ...
 * (1 condition, per character; apps/shared_libs/reflow/src/reflow_svg.c@internal_ci_eq).
 ...
 * (apps/shared_libs/reflow/src/reflow_svg_xform.c@priv_ra8_svgp_numf), reached through the float
 ...
 * apps/shared_libs/reflow/src/reflow_svg_xform.c@internal_is_num_start), reached from the
 ...
 * `(l>='a')&&(l<='f')` (L246; apps/shared_libs/reflow/src/reflow_svg.c@internal_hex).
 ...
 * fraction-digit loop (L274; apps/shared_libs/reflow/src/reflow_svg.c@priv_ra8_svgp_num). The
 ...
 * loop (L575; apps/shared_libs/reflow/src/reflow_svg_xform.c@priv_ra8_svgp_numf), reached through a
 ...
 * value-scan-to-close-quote (L329; apps/shared_libs/reflow/src/reflow_svg.c).
 *
 * Vectors:
 ...
 * apps/shared_libs/reflow/src/reflow_svg.c@internal_ci_eq). A colour name that is a strict
 ...
 * OR (L611; apps/shared_libs/reflow/src/reflow_svg_xform.c@internal_is_num_start). The existing
