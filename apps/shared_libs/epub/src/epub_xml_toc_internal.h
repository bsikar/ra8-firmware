 ...
 * `epub_xml_toc.c`; the helpers both it and the container/OPF pass call
 * stay in `epub_xml_consumer_internal.h`, which this header includes.
...
typedef struct {
  ...
  epub_book_t*   book;       /**< TOC output being populated.             */
  xml_reader_t*  reader;     /**< Reader whose live frames carry markers. */
  xml_event_t    selected;   /**< Selected navigation element.            */
...
typedef struct {
  ...
  epub_book_t*   book;       /**< TOC output being populated.             */
  xml_reader_t*  reader;     /**< Reader whose live frames carry markers. */
  xml_event_t    selected;   /**< Selected navigation-map element.        */
  bool           active;     /**< Selected subtree has begun.             */
} priv_ncx_ctx_t;
