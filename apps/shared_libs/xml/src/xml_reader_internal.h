/**
 * @file xml_reader_internal.h
 * @brief Private contracts for the bounded XML reader implementation.
 * @details Declares the file-local lexical and event helpers of `xml.c` so
 ...
 * `xml_decode.c` and documents its helpers at their definitions.
 * [Ring 3 / LIB] {World: NS}
