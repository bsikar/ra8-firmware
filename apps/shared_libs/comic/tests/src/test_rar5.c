 ...
 * guards, and
 *   2. through the `comic` facade -- covered by the split sibling
 ...
 *
 * The writer (tests/support/inc/rar5_enc_fixture.h) is first-party test
 ...
 * - apps/shared_libs/comic/src/ra8_rar5.c@priv_rar5_copy_match `dist == 0 || dist >
 ...
 * - apps/shared_libs/comic/src/ra8_rar5.c@internal_decode_stream `out_pos < unp &&
...
RA8_INTERNAL static void internal_test_rar5_match_legs(void)
{
  ...
  (void)memset(s_body_buffer, 0, sizeof(s_body_buffer));
 ...
 *
 * @par MC/DC:
 * Decision apps/shared_libs/comic/src/ra8_rar5.c@internal_x86_is_op:
 ...
 * apps/shared_libs/comic/src/ra8_rar5.c@priv_rar5_filter_delta `len >
 ...
 * apps/shared_libs/comic/src/ra8_rar5_tables.c@priv_rar5_apply_run:
 ...
 *
 * @par MC/DC:
 * Drives apps/shared_libs/comic/src/ra8_rar5_tables.c@priv_rar5_fill_zeros
...
RA8_INTERNAL static void internal_test_rar5_malformed(void)
{
  ...
  (void)memcpy(s_bad, s_packed, pklen);
  ...
  (void)memset(s_packed_match, 0, sizeof(s_packed_match));
