...
typedef enum : uint32_t {
  ...
  k_mcdc_codec_bytes      = 1024U * 1024U, /**< Decoder arena bytes.     */
...
{
  static book_chapter_t      s_chapters[k_mcdc_chapters];
  static book_node_t         s_nodes[k_mcdc_nodes];
  static book_attr_t         s_attrs[k_mcdc_attrs];
  static book_stylesheet_t   s_styles[1];
  static book_image_t        s_images[k_mcdc_images];
 ...
 * @par MC/DC:
 * `apps/shared_libs/rabook_compile/src/ra8_rabook_comic.c@ra8_rabook_comic_init`
 ...
 * @par MC/DC:
 * `apps/shared_libs/rabook_compile/src/ra8_rabook_comic.c@ra8_rabook_comic_add_page`
 * receives `(F,F,F)->F` and each one-true input vector.
 * `apps/shared_libs/rabook_compile/src/ra8_rabook_comic.c@internal_append_chapter`
 ...
 * @par MC/DC:
 * `apps/shared_libs/rabook_compile/src/ra8_rabook_comic.c@ra8_rabook_comic_finish`
 ...
 * @par MC/DC:
 * `apps/shared_libs/rabook_compile/src/ra8_rabook_comic.c@internal_set_metadata`
 * receives `(F,F,F,F)->F`, `(T,-,-,-)->T`, `(F,T,-,-)->T`,
