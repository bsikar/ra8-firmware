 ...
 *
 * @details
 * This library-domain engine reads through ::jof_pread_fn and borrows
 ...
 * @since 0.1.0
 */
typedef struct jof_audit_record_t {
 ...
 * @since 0.1.0
 */
typedef struct jof_audit_requirements_t {
 ...
 * @since 0.1.0
 */
typedef struct jof_audit_workspace_t {
  jof_audit_record_t* records;     /**< Tile record array.            */
 ...
 * @since 0.1.0
 */
typedef struct jof_audit_result_t {
 ...
 * capacities needed by ::jof_audit.
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra8_err_t jof_audit_requirements(jof_pread_fn              pread,
                                               void*                     pread_ctx,
                                               uint64_t                  total_size,
 ...
 * @pre Capacities satisfy ::jof_audit_requirements for the same backing.
 ...
 *       ::jof_audit_result_t::duplicate_candidates for diagnostics,
 ...
 * @since 0.1.0
 */
[[nodiscard]] ra8_err_t jof_audit(jof_pread_fn           pread,
                                  void*                  pread_ctx,
                                  uint64_t               total_size,
