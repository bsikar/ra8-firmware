 ...
 * fuzz input to the exact firmware import path -- `jof_produce()`
...
enum : uint32_t {
  k_fuzz_ta_max_input = 1024U * 1024U,      /**< Cap fuzz input at 1 MiB. */
...
/** @brief ::jof_pull_fn over the fuzz input. */
