 ...
 * translate) drives them from `jof_png.c` through the prototypes
 * in `jof_png_internal.h`. All structural anomalies fail closed:
...
{
  static const uint8_t s_png_sig[k_ra8_png_sig_bytes] = {k_ra8_png_sig_high,
                                                         'P',
                                                         'N',
                                                         'G',
                                                         k_ra8_png_sig_cr,
