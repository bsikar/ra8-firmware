 ...
 */
RA8_INTERNAL
RA8_INTERNAL static ra8_err_t internal_png_bind_geometry(ra8_png_state_t* st, jof_bump_t* bump)
{
  if (st->color_type == (uint8_t)k_ra8_png_color_pal) {
    if (st->has_plte == 0U) {
      return k_ra8_err_validation_failed;
...
RA8_INTERNAL
RA8_INTERNAL static ra8_err_t
internal_png_run_idat(ra8_png_state_t* st, jof_bump_t* bump, uint32_t len)
{
...
RA8_INTERNAL
RA8_INTERNAL static ra8_err_t
internal_png_walk_chunks(ra8_png_state_t* st, jof_bump_t* bump, uint16_t max_w, uint16_t max_h)
{
...
RA8_PRIV ra8_err_t priv_jof_png_rows(jof_pull_fn pull,
                                     ...
                                     void*       cb_ctx)
{
  static const char* const s_tag = "jof_png";
