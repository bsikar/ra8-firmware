...
/** @brief Fixed non-zero bytes in the RFC 1952 header. */
typedef enum : uint8_t {
  k_gzip_id1        = 0x1FU, /**< Gzip identification byte one. */
  k_gzip_id2        = 0x8BU, /**< Gzip identification byte two. */
  k_gzip_deflate    = 0x08U, /**< DEFLATE compression method.   */
  k_gzip_os_unknown = 0xFFU, /**< Unknown originating OS.       */
} mdl_gzip_header_t;
                                            ...
                                            mdl_export_workspace_t*  ws)
{
  ...
  static const uint8_t header[k_gzip_header_bytes] =
    {k_gzip_id1, k_gzip_id2, k_gzip_deflate, 0U, 0U, 0U, 0U, 0U, 0U, k_gzip_os_unknown};
