 ...
 * @return The matching kind, or ::k_mdl_format_invalid.
 * @retval k_mdl_format_loose @p s is NULL or names loose output.
 * @retval k_mdl_format_rabook @p s names the strict reader-native container.
 * @retval k_mdl_format_invalid @p s is an unknown or reserved format name.
 ...
 * @retval true  @p fmt is ::k_mdl_format_jof (per-page `.jof` siblings).
