 ...
 * writers.
 * @invariant ::k_mdl_format_rabook selects the strict RBKC/RABOOK1 writer.
 * @since 0.1.0
 */
typedef enum : uint8_t {
  k_mdl_format_loose   = 0U,   /**< Leave loose page images.                 */
  k_mdl_format_cbz     = 1U,   /**< ZIP of images (`.cbz`).                  */
  k_mdl_format_cbt     = 2U,   /**< Tar of images (`.cbt`).                  */
  k_mdl_format_cbr     = 3U,   /**< Reserved RAR output.                     */
  k_mdl_format_cbt_xz  = 4U,   /**< Reserved xz-compressed tar output.       */
  k_mdl_format_cbt_gz  = 5U,   /**< Gzip-compressed tar (`.cbt.gz`).         */
  k_mdl_format_epub    = 6U,   /**< Fixed-layout EPUB (`.epub`).             */
  k_mdl_format_jof     = 7U,   /**< Native JOF tile atlas per page (`.jof`). */
  k_mdl_format_rabook  = 8U,   /**< Chunked reader-native book (`.rabook`).  */
  k_mdl_format_invalid = 255U, /**< Unrecognized or unsupported selection.   */
} mdl_format_t;
