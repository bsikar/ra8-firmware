...
typedef struct {
  book_header_t     hdr;                       /**< Flat header.      */
  book_chapter_t    chapters[1];               /**< One chapter.      */
  book_node_t       nodes[2];                  /**< Element + text.   */
  book_attr_t       attrs[1];                  /**< One class attr.   */
  book_stylesheet_t styles[1];                 /**< One global style. */
  book_image_t      images[2];                 /**< Raster + SVG.     */
...
typedef struct {
  ...
  book_chunked_t reader;                  /**< Open reader under test.     */
 ...
 * bounded scratch, to book_validate_stream_strict().
