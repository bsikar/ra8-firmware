                                                      ...
                                                      uint32_t            page_id_off)
{
  ...
  const book_attr_t source = {.name_off = src_off, .value_off = page_id_off};
  const uint32_t    body   = (result == k_ra8_ok)
                               ? ra8_rabook_add_element(&comic->builder, body_off, nullptr, 0U)
                               : (uint32_t)k_book_nil;
  const uint32_t    image  = (body != (uint32_t)k_book_nil)
                               ? ra8_rabook_add_element(&comic->builder, img_off, &source, 1U)
                               : (uint32_t)k_book_nil;
  if ((body == (uint32_t)k_book_nil) || (image == (uint32_t)k_book_nil)) {
                                ...
                                uint8_t                             pixel_format)
{
  ...
  *comic = (ra8_rabook_comic_t){};
  ...
  ra8_err_t result = rabook_compile_init(&comic->builder, &workspace->builder);
  if (result == k_ra8_ok) {
