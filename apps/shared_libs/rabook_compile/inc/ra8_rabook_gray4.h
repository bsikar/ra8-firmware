 ...
 * the panel-native 4-bpp nibble format used by @ref book_image_t.
 ...
 *     matching the byte layout of `tools/epub_compile/src/epub_compile.py`.
 *
 ...
 * @see rabook_compile.h  Builder back-end this feeds into.
 * @see book_image_t      On-disk descriptor stored in the RABOOK1 blob.
 ...
 *          @ref k_book_pixfmt_gray8 pool bytes ARE the decoded (and possibly
