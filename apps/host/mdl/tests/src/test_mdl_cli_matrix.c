...
static const cli_mode_case_t s_matrix_modes[k_matrix_mode_count] = {
  [k_matrix_series]     = {"series",
                           ...
                           {"mdl", "--config", "site.conf", "--series", "https://x/book"},
                           5U},
  [k_matrix_search]     = {"search",
                           k_mdl_cli_mode_search,
                           {"mdl", "--config", "site.conf", "--search", "title"},
                           5U},
  [k_matrix_browse]     = {"browse",
                           k_mdl_cli_mode_browse,
                           {"mdl", "--config", "site.conf", "--browse"},
                           4U},
  [k_matrix_list]       = {"list", k_mdl_cli_mode_list, {"mdl", "--list"}, 2U},
  [k_matrix_update_all] = {"update-all",
                           k_mdl_cli_mode_update_all,
                           {"mdl", "--update-all", "--config", "site.conf"},
                           4U},
  [k_matrix_remove]     = {"remove", k_mdl_cli_mode_remove, {"mdl", "--remove", "slug"}, 3U},
  [k_matrix_verify]     = {"verify", k_mdl_cli_mode_verify, {"mdl", "--verify"}, 2U},
  [k_matrix_init]       = {"init-site",
                           k_mdl_cli_mode_init_site,
                           {"mdl", "--init-site", "https://x/book"},
                           3U},
  [k_matrix_pack]       = {"pack",
                           k_mdl_cli_mode_pack,
                           {"mdl", "--pack", "pages", "--format", "cbz"},
                           5U},
  [k_matrix_artifact]   = {"artifact", k_mdl_cli_mode_artifact, {"mdl", "https://x/book.cbz"}, 2U},
  [k_matrix_page]       = {"page", k_mdl_cli_mode_page, {"mdl", "https://x/page"}, 2U},
  [k_matrix_help]       = {"help", k_mdl_cli_mode_help, {"mdl", "--help"}, 2U},
  [k_matrix_version]    = {"version", k_mdl_cli_mode_version, {"mdl", "--version"}, 2U},
};
...
RA8_INTERNAL static bool internal_capture_usage(char* out, size_t cap)
{
  ...
  if (mdl_cli_usage(&stream, "mdl") != k_ra8_ok) {
    return false;
  }
  uint32_t used = 0U;
