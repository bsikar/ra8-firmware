 ...
 * k_ra8_fail)` (3 conditions). Cited as apps/shared/media_dl/src/mdl_fetch.c@priv_mdl_fetch_is_retryable.
 ...
 * conditions). Cited as apps/shared/media_dl/src/mdl_fetch.c@priv_mdl_fetch_run_incomplete.
