...
Maintain manufacturer, exact ordering MPN, DigiKey and/or Mouser part number/link, procurement status, and dated supplier-specific stock/price snapshots in the schematic fields as each section is designed. Both distributors are in scope. Compare sources before flagging a part for replacement; one distributor's discontinuation is not manufacturer EOL. Export the CSV after changes using Tools > Generate Bill of Materials, entire project, with the procurement fields included. Output is `../exports/ereader_rev1_bom.csv` relative to the schematic directory. Do not hand-edit quantities in the generated CSV.
...
- **U1 retain exact #UC0; sourcing HOLD removed:** The user's open Mouser search results were inspected directly in Edge on 2026-09-05. [Mouser's exact #UC0 part](https://www.mouser.com/en/ProductDetail/Renesas-Electronics/R7KA8P1KFLCACUC0?qs=2FehpBK1j97Anbj%252BfZIC1A%3D%3D), `968-R7KA8P1KFLCACUC0`, showed 317 in stock, minimum/multiple 1, and USD unit prices 29.47 / 23.82 / 22.75 / 21.71 / 21.70 at quantities 1 / 10 / 25 / 100 / 189. Circuit qualification remains ongoing. [DigiKey's #UC0 listing](https://www.digikey.com/en/products/detail/renesas-electronics-corporation/R7KA8P1KFLCAC-UC0/26738126) still reports discontinued there, one in stock, and no backorders; retain that supplier-specific risk, not a design-wide unavailability claim. No suffix substitution is justified by that listing alone.
- **R1-R5 selected:** [Yageo RC0603FR-0710KL](https://www.yageogroup.com/component-documentation/download/specsheet/RC0603FR-0710KL), 10 kohm 1%, 0603, 100 mW at 70 C. At 3.6 V and the 9.9 kohm tolerance minimum, pull-down current is 0.364 mA and dissipation is 1.31 mW. [DigiKey `311-10.0KHRCT-ND`](https://www.digikey.com/en/products/detail/yageo/RC0603FR-0710KL/729827) indexed stock 2,922,248; active; cut-tape USD unit prices 0.10 / 0.025 / 0.01220 / 0.00661 at quantities 1 / 10 / 100 / 1000. Footprint qualification remains deferred.
...
- **Main clock selected for schematic:** Y1 is Murata `XRCGB24M000F3M19R0`, replacing the imported FL2400022 instance. C35/C36 are TDK `C1005NP01H080D050BA`. Exact specifications, initial load calculation, and remaining board-level oscillator matching requirements are in [boot and debug](design/boot_and_debug.md). The BOM carries dated stock/pricing and links for both parts. Do not purchase the old FL2400022 for Y1.
...
- **Urgent gaps:** power-chain and oscillator qualification, and the display subsystem's exact panel/controller requirements. MCU sourcing is available through Mouser; monitor replenishment for production quantities.
