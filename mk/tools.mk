...
media_dl:
	...
	@echo "  run:  make dl ARGS='--config apps/shared/media_dl/sites/manhwaus.conf --series <url> --chapters 2 --format cbz'"
...
dl:
	@test -n "$(ARGS)" || { echo "usage: make dl ARGS='--config apps/shared/media_dl/sites/<site>.conf --series <url> --chapters N --format cbz'"; exit 2; }
	$(MAKE) media_dl
