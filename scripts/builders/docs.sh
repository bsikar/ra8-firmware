...
echo "build_docs.sh: regenerating navigation (scripts/gen/gen_doxygen_nav.py)."
python3 "${SCRIPT_DIR}/../gen/gen_doxygen_nav.py"
...
python3 "${SCRIPT_DIR}/../checks/check_doc_diagrams.py" --write-stamp --html "${OUTPUT_HTML}"
