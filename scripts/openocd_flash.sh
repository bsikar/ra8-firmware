...
#
# Usage:
#   ./scripts/openocd_flash.sh path/to/firmware.hex
#   ./scripts/openocd_flash.sh                          # default: blink.hex
#
# Requires:
...
#   - EK-RA8D2 plugged in
#
# See scripts/openocd/ek-ra8d2.cfg for the chip / board config and TODOs
...
HEX="${1:-$FW_DIR/examples/blink/build/blink.hex}"
