...
Emits examples/ek_ra8d2/hw_pending/ereader_manga/inc/mg_page_fixture.h: one large
...
is the source jof_produce() transcodes into a JOF atlas at boot;
...
def emit_header(png: bytes) -> tuple[Path, int]:
    ...
    lines = [
        ...
        " * @brief Baked demo manga page for the ereader_manga viewer.",
        ...
        " * page is the source jof_produce() transcodes into a JOF atlas",
