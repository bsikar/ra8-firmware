...
PY_TOOL_DIRS = ["scripts", "tools", "apps", "libs", "examples"]
...
def main() -> int:
    """Write all three generated navigation files into docs/generated/.

    build_docs.sh runs this immediately before doxygen, so the three files are
    ...
    print(f"gen_doxygen_nav: wrote {OUT_DIR}/nav_examples.dox, nav_docs.dox, nav_config.doxy")
    return 0
