...
"""Generate the ra_rabook_compile byte-identity parity fixture headers.
...
ra_rabook_gray4_downscale/_encode). The firmware kernel run over the same source
...
def _render_downscale(src: bytes, out_w: int, out_h: int, golden: bytes, sha_hex: str) -> str:
    return (
        ...
        " * @brief Downscale-kernel byte-identity fixture for ra_rabook_gray4 (#213).\n"
        " *\n"
        " * @generated by scripts/utils/rabook_parity_gen.py --downscale\n"
        ...
        " *            .py, a mirror of ra_rabook_gray4_downscale/_encode).\n"
        " *            test_ra_rabook_downscale_parity.c runs the firmware kernel over\n"
