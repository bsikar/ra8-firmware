#!/usr/bin/env python3
"""
Per-app size visualizer for ra8d2-firmware.
...
Usage:
    ...
    python3 scripts/utils/app_sizes.py
    python3 scripts/utils/app_sizes.py --write
    python3 scripts/utils/app_sizes.py --verbose
...
def render_full(rows: list[AppSizes]) -> str:
    ...
    head = (
        ...
        "Auto-generated by `scripts/utils/app_sizes.py`. Re-run via\n"
