#!/usr/bin/env bash
#
# scripts/utils/osv_scan.sh -- OSV CVE scan of the vendored SOUP.
#
...
#
# Usage:
#   bash scripts/utils/osv_scan.sh --scanner <osv-scanner-binary> \
#                                  [--output-dir <dir>]
#
# Exit codes:
...
done < <(python3 "${REPO_ROOT}/scripts/utils/gen_sbom.py" --commits)
