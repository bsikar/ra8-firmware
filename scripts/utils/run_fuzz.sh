#!/usr/bin/env bash
#
# scripts/utils/run_fuzz.sh -- run libFuzzer harnesses for an arbitrary
...
#   bash scripts/utils/run_fuzz.sh --all [seconds]     # every harness
#   bash scripts/utils/run_fuzz.sh --list              # print the registry
#
# Examples:
#
#   bash scripts/utils/run_fuzz.sh fuzz_ra8_jpeg_sw 600
#   bash scripts/utils/run_fuzz.sh --all 300           # nightly-style sweep
#
