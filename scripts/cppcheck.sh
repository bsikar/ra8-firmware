...
#
# Usage:
#   ./scripts/cppcheck.sh             # Report findings (exit 0)
#   ./scripts/cppcheck.sh --check     # Treat regressions vs baseline as error
#   ./scripts/cppcheck.sh --verbose   # Verbose cppcheck output
#   ./scripts/cppcheck.sh --help      # Show this help
#
# Prerequisites:
