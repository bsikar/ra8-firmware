...
#   bash scripts/hil_recover.sh uart_hello
#   bash scripts/hil_recover.sh uart_hello --expect "hello, ra8d2!"
#   bash scripts/hil_recover.sh uart_hello --uart /dev/cu.usbmodem001... --expect "hello"
#
# Exit codes:
