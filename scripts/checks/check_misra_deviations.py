...
from misra_deviations_fixtures import fixture_files, selftest_cases
...
def _fixture_files() -> dict[str, str]:
    """Build the mutually consistent self-test fixture."""
    return fixture_files()


def _selftest_cases() -> list[tuple[str, str, str, str, int]]:
    """Enumerate every self-test mutation and the quiet control."""
    return selftest_cases(EXIT_OK, EXIT_DRIFT, EXIT_MALFORMED)
