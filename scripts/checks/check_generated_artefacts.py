...
"""Gate: versioned generated artefacts must match a fresh regenerate.

The MC/DC gap reports and driver-status inventory under ``docs/`` are
GENERATED, yet they are also COMMITTED, and nothing compared the committed copy against what the
