...
PROVIDERS: tuple[Provider, ...] = (
    ...
    Provider("zig", (LINT,), ("zig",), "check_zig.py", ("--list-files",)),
    Provider("zig-fmt", (FORMAT,), ("zig",), "format_tree.sh", ("--list-files", "zig"), "bash"),
    Provider("clippy", (LINT,), ("rust",), "check_rust.py", ("--list-files",)),
    Provider("rustfmt", (FORMAT,), ("rust",), "format_tree.sh", ("--list-files", "rust"), "bash"),
