...
_BASE_SHELL_POLICIES: dict[str, ShellPolicy] = {
    ...
    "scripts/builders/check_c6_integration.sh": ShellPolicy(
        ShellSecurity.PORTABLE,
        ShellUsage.ENTRY,
        ShellDialect.BASH,
        executable=True,
    ...
    "scripts/builders/check_no_legacy_make.sh": ShellPolicy(
        ShellSecurity.PORTABLE,
        ShellUsage.ENTRY,
        ShellDialect.BASH,
        executable=True,
    ...
    "scripts/builders/check_obsolete_standards.sh": ShellPolicy(
        ShellSecurity.PORTABLE,
        ShellUsage.ENTRY,
        ShellDialect.BASH,
        executable=True,
