...
import hil_convergence_safety_selftest_environment as environment
...
def _base_cases(inputs: dict[str, str], scan: Scan) -> list[tuple[str, bool]]:
    ...
    return (
        ...
        + environment.cases(inputs, scan, _mutate, _remove_manifest_member, _remove_loop_member)
...
def run(scan: Scan, runner_scan: Scan) -> int:
    ...
    cases.extend(environment.runner_runtime_directory_cases(inputs, runner_scan, _mutate))
