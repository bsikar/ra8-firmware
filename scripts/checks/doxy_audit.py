...
def run_selftest() -> int:
    ...
    switches it off. Both directions are asserted here.
    ...
    global REPO_ROOT  # noqa: PLW0603  # audit_file() reports paths relative to it
    failures: list[str] = []
    real_root = REPO_ROOT
...
def main() -> int:  # noqa: PLR0912 PLR0915  # report-generation dispatch, splitting hurts readability
    ...
    lines.append("")
    lines.append("Audit-only report generated by `scripts/checks/doxy_audit.py` against the")
