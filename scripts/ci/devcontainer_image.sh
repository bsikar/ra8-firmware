...
if [[ "$-" == *p* ]]; then
  ...
  export SELFTEST_SUPERVISOR_RAW_SHA256="381a7f8c835fea59d1dafd3f06700131b8aad985af524e7d950e80106d87764f"
  ...
  export IMAGE_LOCK_SELFTEST_RAW_SHA256="841890a177f349d1076c1370ec6882a3e9e215e6f7e5930cd9e5657dda86a9cd"
