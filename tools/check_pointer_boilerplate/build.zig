...
pub fn build(b: *std.Build) void {
    ...
    const executable = b.addExecutable(.{
        .name = "check_pointer_boilerplate",
    ...
    const run_step = b.step("run", "Scan app and example sources for the generated pointer-only comment");
    ...
    const test_step = b.step("test", "Run check_pointer_boilerplate tests");
