...
//!
//! Build graph for the `check_obsolete_standards` host gate (#858). One
...
//! `scripts/builders/check_obsolete_standards.sh` passes through.
...
pub fn build(b: *std.Build) void {
    ...
    const run_step = b.step("run", "Reject references to obsolete safety standards");
    ...
    const test_step = b.step("test", "Run check_obsolete_standards tests");
