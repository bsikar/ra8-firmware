...
/** @brief Implementation of `sim_div0_clear_fault()` -- plain flag clear. */
void sim_div0_clear_fault(void)
{
  s_div0_fault = false;
}

/** @brief Implementation of `sim_div0_fault_pc()` -- plain state read. */
uint32_t sim_div0_fault_pc(void)
{
  return s_div0_fault_pc;
}

/** @brief Implementation of `sim_div0_count_trap()` -- run-end telemetry bump. */
void sim_div0_count_trap(void)
{
  s_div0_traps++;
}

/** @brief Implementation of `sim_div0_disarm()` -- warm reboot un-patches sites. */
void sim_div0_disarm(void)
{
  s_div0_armed = false;
}
