/**
 * @file sim_usbh_seam.c
 * @brief Virtual USB host-mode device seams (see sim_usbh_seam.h)
 *
 * @details
 ...
 * variant) -- moved verbatim out of the board_sim main translation unit.
 *
...
/** @brief Implementation of `sim_usbh_done()` -- the USBH early-stop predicate. */
bool sim_usbh_done(void)
{
