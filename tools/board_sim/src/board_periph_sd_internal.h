 ...
 * that type is built from, and the blank-card (--sd-new) FAT16/FAT32 in-memory
 * formatters. board_periph_sd.c models the SPI protocol, board_periph_sd_image.c
