/**
 * @file sim_run_report.c
 * @brief Run-end report + finalize (see sim_run_internal.h)
 *
 * @details
 ...
 * + engine and mapping the #67 exit code). Split out of sim_run.c so each TU
 ...
 * run_cleanup contracts live on their declarations in sim_run_internal.h.
 *
