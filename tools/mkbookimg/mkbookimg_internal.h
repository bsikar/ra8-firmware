 ...
 *
 *  - `mkbookimg.c`       -- the host container: descriptor-level diagnostics,
 ...
 *  - `mkbookimg_books.c` -- the population pass: opening and identifying each
