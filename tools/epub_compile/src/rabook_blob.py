...
exact layout apps/shared_libs/book/inc/book.h reads back.
...
class BlobBuilder:
    ...
    def __init__(self) -> None:
        ...
        self.flags = 0  # book_flag_t bits (e.g. FLAG_RTL); 0 for EPUB text
    ...
    def add_element(self, elem: DomNode) -> int:
        ...
        if kids:
            ...
            for cur, nxt in itertools.pairwise(kids):
