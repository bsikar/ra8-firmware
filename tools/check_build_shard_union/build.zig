...
//!
//! Build graph for the `check_build_shard_union` host tool (#858, #1159). One
...
//! `scripts/builders/check_build_shard_union.sh` passes through.
...
pub fn build(b: *std.Build) void {
    ...
    const run_step = b.step("run", "Check that the cross-build shards covered the tree exactly once");
    ...
    const test_step = b.step("test", "Run check_build_shard_union tests");
