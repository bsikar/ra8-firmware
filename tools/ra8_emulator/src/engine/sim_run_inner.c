/**
 * @file sim_run_inner.c
 * @brief Inner per-chunk exception-resolve loop (see sim_run_internal.h)
 *
 * @details
 ...
 * synthesis, tick / PendSV take). Split out of sim_run.c so each TU stays under
