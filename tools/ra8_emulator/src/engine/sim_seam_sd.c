 ...
 * the real firmware). Moved verbatim out of the board_sim main translation
...
/** @brief Implementation of `sim_fast_sd_enable()` -- CLI opt-in latch. */
void sim_fast_sd_enable(void)
{
  s_fast_sd = true;
}
