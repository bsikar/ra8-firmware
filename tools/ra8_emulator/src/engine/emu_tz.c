/**
 * @file emu_tz.c
 * @brief TrustZone S/NS seam implementation (see emu_tz.h)
 *
 * @details
 ...
 * BX-LR patch -- moved verbatim out of the ra8_emulator main translation unit.
 *
...
/** @brief Implementation of `emu_tz_set_ns_vector_base()` -- --ns override. */
void emu_tz_set_ns_vector_base(uint32_t base)
{
  s_ns_vector_base = base;
}

/** @brief Implementation of `emu_tz_ns_vector_base()` -- plain state read. */
