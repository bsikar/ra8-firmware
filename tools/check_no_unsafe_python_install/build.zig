...
pub fn build(b: *std.Build) void {
    ...
    const executable = b.addExecutable(.{
        .name = "check_no_unsafe_python_install",
    ...
    const run_step = b.step("run", "Scan the authored tree for the system-pip override");
    ...
    const test_step = b.step("test", "Run check_no_unsafe_python_install tests");
