...
pub fn build(b: *std.Build) void {
    ...
    const executable = b.addExecutable(.{
        .name = "check_host_build_entrypoints",
    ...
    const run_step = b.step("run", "Audit the host build entry points");
    ...
    const test_step = b.step("test", "Run check_host_build_entrypoints tests");
