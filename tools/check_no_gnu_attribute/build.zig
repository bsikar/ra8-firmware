...
//! the exit-status contract `scripts/builders/check_no_gnu_attribute.sh`
//! passes through in the CLI module.
...
pub fn build(b: *std.Build) void {
    ...
    const run_step = b.step("run", "Enforce the C23 [[...]] attribute form over GNU __attribute__");
    ...
    const test_step = b.step("test", "Run check_no_gnu_attribute tests");
