/**
 * @file cache_bench_report.c
 * @brief #147 benchmark front end: swept-capacity report, mode dispatch, main.
 *
 * @details
 * Drives the replay engine in cache_bench.c across the RAM-budget axis and
 ...
 * through the public cache_bench.h surface, which is why the contract test
