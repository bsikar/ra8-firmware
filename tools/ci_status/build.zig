...
//!
//! Build graph for the `ci_status` host tool (#858, #1144). One executable,
...
pub fn build(b: *std.Build) void {
    ...
    const run_step = b.step("run", "Read one field or view of the ci-monitor status file");
    ...
    const test_step = b.step("test", "Run ci_status tests");
