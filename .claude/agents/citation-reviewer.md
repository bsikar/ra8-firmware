...
- **Strict Verification**: You can run `python3 scripts/utils/cite_check.py --strict` using the Bash tool to ensure all citations in the codebase are valid and compile with rules.
...
3. Use the Bash tool to run the validation script: `python3 scripts/utils/cite_check.py --strict` to check for violations globally or on targeted paths.
