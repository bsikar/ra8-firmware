# ra8d2-firmware Conventions & Reference <!-- AI-OK: reference to CLAUDE.md -->

This file provides comprehensive guidelines for development in this repository. It is imported by the root CLAUDE.md configuration. <!-- AI-OK: reference to CLAUDE.md -->
...
**Zero AI attribution anywhere in the codebase.** No file in `libs/`, `src/`, `tests/`, `examples/`, `port/`, `scripts/`, or `docs/` may reference any AI-tool attribution as the author, reviewer, or contributor of code, tests, docs, or any artifact.
...
The next `make` from the repo root re-discovers it -- no changes needed to the top-level `CMakeLists.txt` or top-level `Makefile`.
